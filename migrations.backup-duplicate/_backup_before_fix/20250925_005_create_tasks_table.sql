-- DEPRECATED: Old tasks table replaced by new task system (Feature 028)
-- This file is kept for reference but all statements are commented out
-- The new task system is created by migrations 20251009_000 through 20251009_008
--
-- Migration 20251009_000 drops the old hr_public.tasks table
-- Migration 20251009_004 creates the new UUID-based tasks table in public schema
-- with enhanced features: task types, hierarchies, dependencies, audit trails
--
-- DO NOT UNCOMMENT - This would conflict with the October 2025 task system
