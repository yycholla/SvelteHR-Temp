...
pub use document::{
    CreateDocumentInput, Model as Document, UpdateDocumentInput, UploadDocumentInput,
};
pub use document_access_log::{
    CreateDocumentAccessLogInput, DocumentAccessType, Model as DocumentAccessLog,
};
