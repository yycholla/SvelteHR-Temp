...
pub use models::*;
pub use oauth::{
    exchange_code_for_tokens, get_authorization_url, refresh_access_token, revoke_token,
};
...
pub fn init() -> Result<()> {
    ...
    std::env::var("INTUIT_CLIENT_ID").map_err(|_| anyhow::anyhow!("INTUIT_CLIENT_ID not set"))?;
