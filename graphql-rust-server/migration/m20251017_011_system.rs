...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, ActivityLogs::Table))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new(ActivityLogs::IsRollback)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from((S::HrPublic, ActivityLogs::Table), ActivityLogs::UserId)
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::SetNull),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_activity_logs_employee_id")
                            .from((S::HrPublic, ActivityLogs::Table), ActivityLogs::EmployeeId)
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::SetNull),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, Notifications::Table))
                    .if_not_exists()
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from((S::HrPublic, Notifications::Table), Notifications::UserId)
                            .to((S::HrPublic, Users::Table), Users::Id)
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, LinkedResources::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(LinkedResources::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(LinkedResources::ResourceType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(LinkedResources::ResourceId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(LinkedResources::LinkedType)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(LinkedResources::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_linked_resources_created_by")
                            .from(
                                (S::HrPublic, LinkedResources::Table),
                                LinkedResources::CreatedBy,
                            )
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, RollbackRequests::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(RollbackRequests::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(RollbackRequests::EntityType)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(RollbackRequests::EntityId).uuid().not_null())
                    .col(
                        ColumnDef::new(RollbackRequests::RequestedBy)
                            .uuid()
                            .not_null(),
                    )
                    .col(ColumnDef::new(RollbackRequests::Reason).text().not_null())
                    .col(
                        ColumnDef::new(RollbackRequests::Status)
                            .string()
                            .not_null()
                            .default("pending"),
                    )
                    ...
                    .col(
                        ColumnDef::new(RollbackRequests::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_rollback_requests_requested_by")
                            .from(
                                (S::HrPublic, RollbackRequests::Table),
                                RollbackRequests::RequestedBy,
                            )
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_rollback_requests_approved_by")
                            .from(
                                (S::HrPublic, RollbackRequests::Table),
                                RollbackRequests::ApprovedBy,
                            )
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::SetNull),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, BulkRollbackBatches::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(BulkRollbackBatches::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(BulkRollbackBatches::RequestedBy)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackBatches::TotalItems)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackBatches::ProcessedItems)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackBatches::Status)
                            .string()
                            .not_null()
                            .default("pending"),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackBatches::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackBatches::CompletedAt).timestamp_with_time_zone(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_bulk_rollback_batches_requested_by")
                            .from(
                                (S::HrPublic, BulkRollbackBatches::Table),
                                BulkRollbackBatches::RequestedBy,
                            )
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, BulkRollbackItems::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(BulkRollbackItems::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(BulkRollbackItems::EntityType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackItems::EntityId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(BulkRollbackItems::Status)
                            .string()
                            .not_null()
                            .default("pending"),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_bulk_rollback_items_batch_id")
                            .from(
                                (S::HrPublic, BulkRollbackItems::Table),
                                BulkRollbackItems::BatchId,
                            )
                            .to(
                                (S::HrPublic, BulkRollbackBatches::Table),
                                BulkRollbackBatches::Id,
                            )
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, PayrollRecords::Table))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new(PayrollRecords::GrossPay)
                            .decimal()
                            .not_null(),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_payroll_records_employee_id")
                            .from(
                                (S::HrPublic, PayrollRecords::Table),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, CompensationBands::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(CompensationBands::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(CompensationBands::MinSalary)
                            .decimal()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CompensationBands::MaxSalary)
                            .decimal()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CompensationBands::Currency)
                            .string()
                            .not_null()
                            .default("USD"),
                    )
                    .col(
                        ColumnDef::new(CompensationBands::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(CompensationBands::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, HrReports::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(HrReports::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(HrReports::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_hr_reports_generated_by")
                            .from((S::HrPublic, HrReports::Table), HrReports::GeneratedBy)
                            .to((S::HrPublic, Users::Table), Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EncryptionKeys::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(EncryptionKeys::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(EncryptionKeys::KeyName)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(EncryptionKeys::EncryptedKey)
                            .binary()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(EncryptionKeys::IsActive)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, SystemSettings::Table))
                    .if_not_exists()
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                (S::HrPublic, SystemSettings::Table),
