...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EmergencyContacts::Table))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new(EmergencyContacts::EmployeeId)
                            .uuid()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(EmergencyContacts::PhoneNumber)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(EmergencyContacts::Email).string())
                    .col(
                        ColumnDef::new(EmergencyContacts::IsPrimary)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_emergency_contacts_employee_id")
                            .from(
                                (S::HrPublic, EmergencyContacts::Table),
                                EmergencyContacts::EmployeeId,
                            )
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EmployeeSkills::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(EmployeeSkills::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(EmployeeSkills::SkillName)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(EmployeeSkills::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(EmployeeSkills::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                (S::HrPublic, EmployeeSkills::Table),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EmployeeCertifications::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(EmployeeCertifications::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(EmployeeCertifications::EmployeeId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(EmployeeCertifications::Name)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(EmployeeCertifications::IssuingOrganization).string())
                    .col(
                        ColumnDef::new(EmployeeCertifications::IssueDate)
                            .timestamp_with_time_zone(),
                    )
                    .col(
                        ColumnDef::new(EmployeeCertifications::ExpiryDate)
                            .timestamp_with_time_zone(),
                    )
                    .col(ColumnDef::new(EmployeeCertifications::CredentialId).string())
                    .col(
                        ColumnDef::new(EmployeeCertifications::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(EmployeeCertifications::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(EmployeeCertifications::DeletedAt)
                            .timestamp_with_time_zone(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_employee_certifications_employee_id")
                            .from(
                                (S::HrPublic, EmployeeCertifications::Table),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EmployeeVehicles::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(EmployeeVehicles::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(EmployeeVehicles::EmployeeId)
                            .uuid()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(EmployeeVehicles::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(EmployeeVehicles::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_employee_vehicles_employee_id")
                            .from(
                                (S::HrPublic, EmployeeVehicles::Table),
        ...
        manager
            .create_table(
                Table::create()
                    .table((S::HrPublic, EmployeeGoals::Table))
                    .if_not_exists()
                    .col(
                        ColumnDef::new(EmployeeGoals::Id)
                            .uuid()
                            .not_null()
                            .primary_key()
                            .extra("DEFAULT gen_random_uuid()"),
                    ...
                    .col(
                        ColumnDef::new(EmployeeGoals::Status)
                            .string()
                            .not_null()
                            .default("pending"),
                    )
                    .col(
                        ColumnDef::new(EmployeeGoals::Progress)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(EmployeeGoals::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(EmployeeGoals::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_employee_goals_employee_id")
                            .from(
                                (S::HrPublic, EmployeeGoals::Table),
