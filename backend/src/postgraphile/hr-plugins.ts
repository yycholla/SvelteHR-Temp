...
import { PluginHookFn, Build, Context } from 'graphile-build';
import { GraphileBuild } from 'postgraphile';
          ...
          switch (field.fieldName) {
            ...
            case 'fullName':
              return {
                ...
                resolve: async (employee: any, args: any, context: Context, info: any) => {
            ...
            case 'statusIndicator':
              return {
                ...
                resolve: async (employee: any, args: any, context: Context, info: any) => {
                  ...
                  if (employee.onLeaveUntil && new Date(employee.onLeaveUntil) > new Date()) {
                    return 'On Leave';
                  }
                  return 'Active';
                }
            ...
            case 'daysOfService':
              return {
                ...
                resolve: (employee: any, args: any, context: Context, info: any) => {
          ...
          switch (field.fieldName) {
            ...
            case 'employeeCount':
              return {
                ...
                resolve: async (department: any, args: any, context: Context, info: any) => {
                  ...
                  if (this.redis) {
                    try {
                      ...
                      logger.warn('Department count cache read failed', { error: error.message });
                    }
                  }
                  ...
                  try {
                    ...
                    if (this.redis) {
                      try {
                        ...
                        logger.warn('Department count cache write failed', { error: error.message });
                      }
                    }
              ...
              return {
                ...
                type: new build.graphql.GraphQLObjectType({
                  ...
                  fields: {
                    ...
                    emergencyLeaveAvailable: { type: build.graphql.GraphQLInt },
                ...
                resolve: async (employee: any, args: any, context: Context, info: any) => {
                  try {
                    ...
                    return {
                      ...
                      vacationDaysAvailable: Math.max(0, row.vacation_days - row.vacation_used) || 20,
  ...
  createPlugin(): PluginHookFn {
    return (build: Build) => {
      ...
      build.hook('GraphQLObjectType:fields:field', (field, build, context: any) => {
        ...
        if (originalResolve) {
          field.resolve = async (root, args, context: Context, info) => {
...
export const hrComputedFieldsPlugin = (redis?: Redis) => new HRComputedFieldsPlugin(redis).createPlugin();
export const hrBusinessLogicPlugin = () => new HRBusinessLogicPlugin().createPlugin();
export const hrPerformanceOptimizationPlugin = (redis?: Redis) => new HRPerformanceOptimizationPlugin(redis).createPlugin();

// Default plugin set for PostGraphile
export const hrPlugins = (redis?: Redis) => [
