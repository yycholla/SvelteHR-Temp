...
export declare class CacheService {
     ...
     */
    set<T>(key: CacheKey | string, value: T, identifier?: string, ttl?: number): Promise<void>;
    /**
     * Delete cached value
     */
...
export declare class GraphQLQueryCache {
     ...
     */
    cacheQueryResult(query: string, variables: Record<string, any>, result: any, userContext?: any): Promise<void>;
    /**
     * Get cached GraphQL query result
     */
    getCachedQueryResult(query: string, variables: Record<string, any>, userContext?: any): Promise<any | null>;
    /**
