 ...
 */
export declare function createJWTAuthMiddleware(redis: Redis, logger: winston.Logger): any;
/**
...
export declare class SessionManager {
     ...
     */
    trackActiveSession(userId: number, sessionId: string, deviceInfo?: any): Promise<void>;
    /**
