...
export declare class GraphQLClientLib extends EventEmitter {
     ...
     */
    query<T = any>(query: string, variables?: Record<string, any>, options?: QueryOptions): Promise<GraphQLResponse<T>>;
    /**
     * Execute GraphQL mutation (never cached)
     */
    mutate<T = any>(mutation: string, variables?: Record<string, any>, options?: QueryOptions): Promise<GraphQLResponse<T>>;
    /**
     * Subscribe to GraphQL subscription with auto-reconnect
     */
    subscribe(subscription: string, variables?: Record<string, any>, options?: SubscriptionOptions): {
        id: string;
        unsubscribe: () => void;
    };
    /**
