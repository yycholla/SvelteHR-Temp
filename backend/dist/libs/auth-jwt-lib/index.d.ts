...
export declare class AuthJWTLib {
     ...
     */
    authenticate(credentials: LoginCredentials, clientInfo: {
        ip: string;
        userAgent: string;
     ...
     */
    generateTokens(user: User, clientInfo: {
        ip: string;
        userAgent: string;
    }): Promise<AuthTokens>;
    /**
     ...
     */
    refreshToken(refreshToken: string, clientInfo: {
        ip: string;
        userAgent: string;
     ...
     * Revoke token (logout)
     */
    revokeToken(token: string, clientInfo?: {
        ip: string;
        userAgent: string;
    }): Promise<boolean>;
    /**
