...
export class HasuraMigrationLib {
     ...
     * Apply performance optimizations
     */
    async applyPerformanceOptimizations(client, config) {
        // Create indexes
        if (config.indexes) {
     ...
     */
    async applyHasuraMetadata(metadata) {
     ...
     * Verify performance requirements
     */
    async verifyPerformanceRequirements(migration) {
     ...
     */
    async acquireMigrationLock(client, migrationId) {
     ...
     */
    async releaseMigrationLock(client, migrationId) {
        await client.query(`
