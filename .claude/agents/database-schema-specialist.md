...
export const employeeSchema = z.object({
  ...
  manager: z.lazy(() => employeeSchema.pick({
    id: true,
    firstName: true,
    lastName: true
  })).optional(),
...
export const taskSchema = z.object({
  ...
  assignedTo: employeeSchema.pick({
    id: true,
    firstName: true,
    lastName: true,
    email: true
...
export const leaveRequestSchema = z.object({
  ...
  leaveType: z.enum(['Annual', 'Sick', 'Personal', 'Maternity', 'Paternity', 'Bereavement', 'Emergency']),
  ...
  coveringEmployee: employeeSchema.pick({
    id: true,
    firstName: true,
    lastName: true
  }).optional(),
...
export const employeeSchemaV2 = z.object({
  ...
  name: z.string().optional().transform((name, ctx) => {
