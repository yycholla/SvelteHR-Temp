...
A comprehensive HR management system built with **SvelteKit 2.22.0**, **Svelte 5.0**, **TypeScript 5.0**, and **Tailwind CSS 4.0**, integrated with the MountainHR Go backend.
