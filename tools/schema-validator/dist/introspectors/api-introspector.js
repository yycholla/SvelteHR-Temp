        ...
        try {
            ...
            if (schema.mutationType) {
                ...
                if (mutationType?.fields) {
                    mutationFields.push(...mutationType.fields.map((f) => this.convertField(f, mutationTypeName)));
                }
            }
            ...
            throw new Error(`Failed to introspect API at ${this.apiUrl}: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
     * Get fields for a specific type
     */
    async getFields(typeName) {
...
//# sourceMappingURL=api-introspector.js.map