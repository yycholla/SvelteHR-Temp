...
export class SchemaValidator {
     ...
     * @private
     */
    async validateAlignments(operationsMap, dbColumns, apiFields) {
        const alignments = [];
        ...
        for (const [filePath, operations] of operationsMap.entries()) {
            for (const operation of operations) {
                ...
                for (const fieldPath of fieldPaths) {
                    const alignment = await this.validateField(fieldPath, operation, filePath, dbMap, apiFields);
     ...
     * @private
     */
    async validateField(fieldPath, operation, filePath, dbMap, apiFields) {
        ...
        if (!dbColumn) {
            ...
            // Type comparison
            const comparison = this.typeComparator.compareTypes('String', // Would extract from operation
            dbColumn.pgType, apiField.graphqlType);
