 ...
 */
export async function verifyDashboardRedirect(page: Page, expectedPath: string, timeoutMs: number = 10000) {
 ...
 */
export async function verifyAuthState(page: Page, expectedState: {
