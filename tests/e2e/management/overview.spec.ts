...
test.describe('Management Overview Dashboard Page', () => {
	...
	test('should display recent activity feed', async ({ page }) => {
		...
		await expect(page.locator('[data-testid="activities-title"]')).toContainText(
	...
	test('should display team performance charts', async ({ page }) => {
		...
		await expect(page.locator('[data-testid="chart-title-attendance"]')).toContainText(
		...
		await expect(page.locator('[data-testid="chart-title-performance"]')).toContainText(
			'Performance Ratings Distribution'
		);

		// Should have goals progress chart
		await expect(page.locator('[data-testid="goals-progress-chart"]')).toBeVisible();
		await expect(page.locator('[data-testid="chart-title-goals"]')).toContainText(
			'Team Goals Progress'
		);
	...
	test('should refresh dashboard data automatically', async ({ page }) => {
		...
		await expect(page.locator('[data-testid="last-updated"]')).toContainText(
	...
	test('should display department comparison metrics', async ({ page }) => {
		...
		await expect(page.locator('[data-testid="comparison-title"]')).toContainText(
	...
	test('should customize dashboard layout and widgets', async ({ page }) => {
		...
		await expect(page.locator('[data-testid="success-notification"]')).toContainText(
			'Dashboard customized successfully'
		);
