...
const createMockMetrics = (
	overrides: Partial<GraphQLPerformanceMetrics> = {}
): GraphQLPerformanceMetrics => ({
...
describe('GraphQLPerformanceMonitor', () => {
	...
	describe('Performance Reports', () => {
		...
		test('should provide cache performance analysis in reports', () => {
			monitor.recordMetrics(
				createMockMetrics({ operationName: 'CachedQuery', cacheHitRatio: 0.9 })
			);
			monitor.recordMetrics(
				createMockMetrics({ operationName: 'UncachedQuery', cacheHitRatio: 0.1 })
			);
			...
			expect(report.summary.cachePerformance.cacheOptimizationOpportunities.length).toBeGreaterThan(
				0
			);
		});
		...
		test('should provide performance recommendations', () => {
			...
			monitor.recordMetrics(createMockMetrics({ operationName: 'ComplexQuery', complexity: 800 }));
			monitor.recordMetrics(
				createMockMetrics({ operationName: 'LowCacheQuery', cacheHitRatio: 0.3 })
			);
	...
	describe('Current Metrics Summary', () => {
		test('should provide current metrics summary', () => {
			monitor.recordMetrics(
				createMockMetrics({ executionTime: 100, cacheHitRatio: 0.8, errorCount: 0 })
			);
			monitor.recordMetrics(
				createMockMetrics({ executionTime: 200, cacheHitRatio: 0.6, errorCount: 1 })
			);
			monitor.recordMetrics(
				createMockMetrics({ executionTime: 300, cacheHitRatio: 0.9, errorCount: 0 })
			);
		...
		test('should identify slow and complex queries in summary', () => {
			...
			monitor.recordMetrics(
				createMockMetrics({ operationName: 'NormalQuery', executionTime: 50, complexity: 100 })
			);
	...
	describe('Query Profile Sorting', () => {
		test('should sort profiles by execution time', () => {
			...
			monitor.recordMetrics(createMockMetrics({ operationName: 'SlowQuery', executionTime: 300 }));
			monitor.recordMetrics(
				createMockMetrics({ operationName: 'MediumQuery', executionTime: 150 })
			);
