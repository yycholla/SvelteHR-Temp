...
describe('canUserViewTask', () => {
	...
	it('should allow employee to view department-assigned tasks', () => {
		const task = createMockTask({ assigneeId: null, assignedToDepartmentId: 'dept-1' });
...
describe('Filter Functions', () => {
	const tasks: Task[] = [
		createMockTask({ id: '1', assigneeId: 'user-1', status: 'todo', priority: 'high', assignedToDepartmentId: null }),
		createMockTask({ id: '2', assigneeId: 'user-2', status: 'in_progress', priority: 'medium', assignedToDepartmentId: 'dept-1' }),
		createMockTask({ id: '3', assigneeId: 'user-1', status: 'completed', priority: 'low', assignedToDepartmentId: null }),
	...
	describe('filterTasksByDepartment', () => {
		...
		it('should return tasks with no department when null passed', () => {
			const result = filterTasksByDepartment(tasks, null);
