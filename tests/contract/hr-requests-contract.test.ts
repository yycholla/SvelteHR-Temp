  ...
  test('should submit various types of HR requests', async () => {
    ...
    `, {
      input: {
        ...
        description: 'Requesting salary adjustment based on performance review and market analysis',
        priority: 'MEDIUM',
        requestData: {
          currentSalary: 75000,
  ...
  test('should handle request rejection with detailed reasons', async () => {
    ...
    `, {
      ...
      input: {
        ...
        detailedFeedback: 'Salary review requests must be submitted during performance review period (January-March). Please resubmit during the next review cycle.',
        allowAppeal: true,
        suggestedActions: [
