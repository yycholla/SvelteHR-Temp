 ...
 */
export async function generatePersonalActivity(userId: string, limit: number = 10): Promise<ActivityItem[]> {
 ...
 */
export async function generatePersonalTasks(userId: string, limit: number = 5): Promise<Array<{
  id: string;
  title: string;
  description?: string;
  dueDate?: string;
 ...
 */
export async function generateUpcomingEvents(userId: string, daysAhead: number = 7): Promise<UpcomingEvent[]> {
