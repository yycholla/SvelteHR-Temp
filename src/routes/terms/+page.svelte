...
<div class="min-h-screen bg-background">
	...
	<main class="mx-auto max-w-4xl px-4 py-12">
		<article class="prose prose-slate dark:prose-invert max-w-none">
			...
			<ul>
				...
				<li>Ensuring accurate and up-to-date account information</li>
			</ul>

			<h3>3.2 User Roles and Permissions</h3>
			<p>The Service provides role-based access control with different permission levels:</p>
			<ul>
				<li><strong>Admin:</strong> Full system access and configuration</li>
				<li><strong>HR Manager:</strong> Employee management and reporting</li>
				<li><strong>Manager:</strong> Team management and approvals</li>
				<li><strong>Employee:</strong> Self-service access to personal information</li>
			</ul>
			...
			<h3>4.2 Data Synchronization</h3>
			<p>The integration provides bidirectional synchronization, including:</p>
			<ul>
				<li>Employee records and contact information</li>
				<li>Compensation and payroll data</li>
				<li>Department and organizational structure</li>
			...
			<ul>
				...
				<li>Violate any laws, regulations, or employment standards</li>
				<li>Attempt to gain unauthorized access to the Service or related systems</li>
				<li>Interfere with or disrupt the Service or servers</li>
				<li>Upload malicious code, viruses, or harmful content</li>
				<li>Misuse employee data or violate privacy regulations</li>
			...
			<p>
				We may perform scheduled maintenance with advance notice. Emergency maintenance may be
				performed without prior notice.
			</p>

			<h2>8. Fees and Payment</h2>
			<p>
				Service fees, if applicable, will be communicated separately through a service agreement.
			...
			<ul>
				...
				<li>Integration issues with QuickBooks or other third-party services</li>
			</ul>
			...
			<p>
				...
				employment laws, data protection regulations (including GDPR, CCPA), and industry standards.
				We provide tools to assist with compliance but do not provide legal advice.
			</p>
			...
			<p>
				...
				Website: <a href="https://hr.mtncarerx.com">https://hr.mtncarerx.com</a>
			</p>
	...
	<footer class="border-t bg-card py-6">
		<div class="mx-auto max-w-4xl px-4 text-center text-sm text-muted-foreground">
			<p>&copy; 2026 Mountain Care Rx. All rights reserved.</p>
			<p class="mt-2">
