...
<div class="my-tasks-page">
	...
	<div class="page-header">
		<div class="page-header__content">
			...
			<p class="page-header__subtitle">Track and manage your assigned tasks.</p>
		</div>

		<div class="page-header__actions">
			<Button variant="tertiary" leftIcon="list" href="/tasks">All Tasks</Button>
		</div>
	</div>
				...
				{#if column.key === 'progress'}
					<div class="progress-cell">
						<div class="progress-bar">
							<div class="progress-bar__fill" style="width: {row.progress || 0}%"></div>
						</div>
...
<style lang="postcss">
	...
	.stat-card__icon {
		@apply flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg;
	}
	...
	.progress-text {
		@apply min-w-0 flex-shrink-0 text-sm text-gray-600;
	}

	.progress-actions {
		@apply flex items-center space-x-1 opacity-0 transition-opacity group-hover:opacity-100;
	}
