...
<div class="new-onboarding-page">
	<div class="page-header">
		<div class="breadcrumb">
			<Button variant="ghost" size="sm" leftIcon="arrow-left" on:click={() => goto('/onboarding')}>
				Back to Onboarding
			</Button>
		</div>
	</div>
	...
	<Card padding="lg" class="onboarding-wizard">
		<div class="wizard-header">
			...
			<p class="mt-1 text-sm text-gray-600">Create a new onboarding workflow for an employee</p>
		...
		<div class="wizard-content">
				...
				<div class="step-content">
					...
					<div class="form-grid">
						...
						<div class="form-group">
							...
							{#if selectedTemplate}
								<p class="form-help">
									{selectedTemplate.description} - Estimated duration: {selectedTemplate.estimated_duration_days}
									days
								</p>
							{/if}
						</div>
			...
			{:else if selectedStep === 2}
				...
				<div class="step-content">
					...
					<p class="step-description">Assign team members to help with the onboarding process</p>
			...
			{:else if selectedStep === 3}
				...
				<div class="step-content">
					...
					<p class="step-description">Review the onboarding details and create the workflow</p>
							...
							<div class="review-details">
								...
								<div class="review-item">
									...
									<span class="review-value"
										>{new Date(formData.start_date).toLocaleDateString()}</span
									>
								</div>
								<div class="review-item">
								...
								<div class="review-item">
									...
									<span class="review-value">
										{formData.assigned_buddy_id
											? $users.find((u) => u.id === formData.assigned_buddy_id)?.display_name ||
												'Unknown'
											: 'Not assigned'}
									</span>
								</div>
								<div class="review-item">
									...
									<span class="review-value">
										{formData.hr_contact_id
											? $users.find((u) => u.id === formData.hr_contact_id)?.display_name ||
												'Unknown'
											: 'Not assigned'}
									</span>
								</div>
		...
		<div class="wizard-footer">
			<div class="footer-actions">
				...
				{#if selectedStep < 3}
					<Button variant="primary" on:click={nextStep} disabled={isSubmitting}>Next</Button>
				{:else}
					<Button variant="primary" leftIcon="check" on:click={handleSubmit} loading={isSubmitting}>
						Create Onboarding
					</Button>
				{/if}
			</div>
...
<style lang="postcss">
	...
	.step-number {
		@apply flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 text-sm font-semibold text-gray-600 transition-colors;
	}
	...
	.step-label {
		@apply mt-2 text-center text-xs font-medium text-gray-500;
	}
	...
	.step-connector {
		@apply mx-4 h-px flex-1 bg-gray-200;
	}
