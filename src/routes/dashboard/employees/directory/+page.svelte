		...
		<Tabs.Content value="directory" class="space-y-6">
			...
			<Card.Root>
				<Card.Content class="p-6">
					<div
						class="flex flex-col space-y-4 md:flex-row md:items-center md:space-x-4 md:space-y-0"
					>
						<!-- Search -->
		...
		<Tabs.Content value="orgmap" class="space-y-6">
			<Card.Root>
				<Card.Header>
					...
					<Card.Description>Visual representation of the organizational structure</Card.Description>
				</Card.Header>
				<Card.Content class="py-12">
