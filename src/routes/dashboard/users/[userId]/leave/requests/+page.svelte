			...
			<div>
				...
				<p class="text-muted-foreground">
					{isOwnRequests
						...
						: 'View user leave request history'}
					{#if userInfo}
		...
		<Card.Root>
			<Card.Content class="py-8">
				<div class="text-center">
					...
					<Button class="mt-4" onclick={loadLeaveRequests}>Try Again</Button>
				</div>
			</Card.Content>
		</Card.Root>
	{:else}
			...
			<Card.Content class="p-4">
				<div class="flex flex-col space-y-4 md:flex-row md:items-center md:space-x-4 md:space-y-0">
					...
					<div class="relative flex-1">
						...
						<Input placeholder="Search requests..." bind:value={searchTerm} class="pl-10" />
					</div>
										...
										<div class="flex items-center gap-3">
											<div class="flex h-8 w-8 items-center justify-center rounded-full bg-muted">
												<svelte:component
													...
													class="h-4 w-4 {request.status?.toLowerCase() === 'approved'
														? 'text-green-500'
											...
											<div>
												...
												<p class="text-sm text-muted-foreground">
													{calculateDays(request.startDate, request.endDate)} day{calculateDays(
														request.startDate,
														request.endDate
													) !== 1
														? 's'
