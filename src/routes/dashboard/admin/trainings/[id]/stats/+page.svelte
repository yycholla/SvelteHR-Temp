...
<div class="container mx-auto p-6 md:p-10 max-w-7xl space-y-8">
	...
	<div class="flex items-center justify-between">
		<div class="flex items-center gap-4">
			<Button variant="ghost" size="icon" href="/dashboard/admin/trainings">
		...
		<div class="flex gap-2">
			<Button variant="outline" href="/dashboard/admin/trainings/{training.id}">
				Edit Training
			</Button>
			<Button variant="outline" href="/dashboard/admin/trainings/{training.id}/content">
				Manage Content
			</Button>
		</div>
	</div>
