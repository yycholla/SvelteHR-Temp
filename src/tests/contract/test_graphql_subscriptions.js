...
const HASURA_WS_ENDPOINT =
	process.env.HASURA_GRAPHQL_WS_ENDPOINT || 'ws://localhost:8080/v1/graphql';
...
describe('GraphQL Subscriptions Contract Tests', () => {
    ...
    `;
      ...
      `;
			...
			await httpGraphQLQuery(updateMutation, { id: deptId, budget: 750000.0 });
    ...
    `;
		...
		try {
			...
			expect(subscriptionError.message || subscriptionError[0].message).toMatch(
