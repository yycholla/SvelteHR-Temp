...
const DATABASE_URL =
	process.env.DATABASE_URL || 'postgresql://hasura:hasura123@localhost:5432/svelteHR';
...
describe('Data Security Contract Tests', () => {
    ...
    `;
		...
		const rateLimited = results.some(
			(result) => result.errors && result.errors[0].extensions.code === 'rate-limited'
		);
