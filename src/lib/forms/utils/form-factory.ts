 ...
 */
function createDefaultData(formSchema: FormSchema, initialData?: Record<string, any>): Record<string, any> {
 ...
 */
export function createEmployeeForm(initialData?: Record<string, any>, options: FormFactoryOptions = {}) {
...
export interface TypedFormFactory {
  employee: (initialData?: Record<string, any>, options?: FormFactoryOptions) => ReturnType<typeof createEmployeeForm>;
