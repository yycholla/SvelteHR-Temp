  ...
  <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <span class={`inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium ${statusColor}`}>
    ...
    <div class="px-6 py-4 max-h-[calc(90vh-120px)] overflow-y-auto">
      ...
      <div class="mb-8">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center">
            <div class="flex-shrink-0 w-2 h-2 bg-gray-400 rounded-full"></div>
            <div class="ml-4">
      ...
      {#if instance.userByTriggeredByUserId}
        <div class="mb-8">
          <h4 class="text-md font-semibold text-gray-900 mb-4">Triggered By</h4>
          <div class="bg-gray-50 rounded-lg p-4">
            <div class="flex items-center">
      ...
      {#if instance.triggerData}
        <div class="mb-8">
          <h4 class="text-md font-semibold text-gray-900 mb-4">Trigger Data</h4>
          <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
            <pre class="text-sm text-green-400 whitespace-pre-wrap">{JSON.stringify(instance.triggerData, null, 2)}</pre>
          </div>
        </div>
      {/if}
      ...
      {#if instance.contextData}
        <div class="mb-8">
          <h4 class="text-md font-semibold text-gray-900 mb-4">Context Data</h4>
          <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
            <pre class="text-sm text-blue-400 whitespace-pre-wrap">{JSON.stringify(instance.contextData, null, 2)}</pre>
          </div>
        </div>
      {/if}
      ...
      {#if instance.status === 'running'}
        <div class="mb-8">
          <h4 class="text-md font-semibold text-gray-900 mb-4">Progress</h4>
      ...
      {#if instance.status === 'failed'}
        <div class="mb-8">
          <h4 class="text-md font-semibold text-gray-900 mb-4">Error Information</h4>
            ...
            <div class="flex">
              ...
              <div>
                ...
                <p class="text-sm text-red-700 mt-1">
                  The workflow instance failed to complete successfully. Check the logs for more details.
                </p>
              </div>
            </div>
          </div>
