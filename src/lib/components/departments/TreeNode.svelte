...
<style lang="postcss">
	...
	.tree-node-content {
		@apply flex cursor-pointer items-center rounded-lg px-3 py-2 transition-colors hover:bg-gray-50;
	}
	...
	.toggle-button {
		@apply rounded p-1 transition-colors hover:bg-gray-200;
	}
	...
	.node-icon {
		@apply mr-3 flex h-6 w-6 items-center justify-center;
	}
	...
	.action-button {
		@apply rounded p-1.5 text-gray-600 transition-colors hover:bg-gray-200 hover:text-gray-900;
	}
