      ...
      <div class="form-section">
        ...
        <div class="input-group">
          <label class="checkbox-group">
            <input
              type="checkbox"
              bind:checked={formData.isRemoteEnabled}
              class="checkbox"
            />
...
<style lang="postcss">
  ...
  .checkbox {
    @apply mt-0.5 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500;
  }
  ...
  .form-actions {
    @apply flex items-center justify-end space-x-3 pt-6 border-t;
  }
