<script lang="ts">
  ...
  import { departmentService, departmentHierarchy, isLoadingDepartments, departmentError } from '$lib/services/departmentService';
      ...
      {:else if rootNodes.length === 0}
        <Card padding="lg" class="hierarchy-empty">
          <div class="empty-content">
            <i class="icon-folder text-gray-400 w-12 h-12 mx-auto"></i>
...
<style lang="postcss">
  ...
  .hierarchy-error .error-content {
    @apply flex items-start space-x-3;
  }

  .hierarchy-empty .empty-content {
