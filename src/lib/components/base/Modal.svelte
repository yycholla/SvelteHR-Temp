...
<style lang="postcss">
  ...
  /* Modal Container */
  .modal {
    @apply bg-white rounded-lg shadow-xl max-h-full overflow-hidden flex flex-col relative;
  }
  ...
  .modal__close {
    @apply text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md p-2;
  }
  ...
  /* Footer */
  .modal__footer {
    @apply px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end space-x-3;
  }
