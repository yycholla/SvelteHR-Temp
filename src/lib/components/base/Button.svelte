...
<style lang="postcss">
	...
	.btn--primary:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-blue-700 shadow-md;
	}

	.btn--secondary:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-gray-700 shadow-md;
	}

	.btn--tertiary:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-gray-50 shadow-md;
	}

	.btn--danger:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-red-700 shadow-md;
	}

	.btn--success:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-green-700 shadow-md;
	}

	.btn--warning:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-yellow-700 shadow-md;
	}

	.btn--ghost:hover:not(.btn--disabled):not(.btn--loading) {
		@apply -translate-y-0.5 transform bg-gray-100;
	}
