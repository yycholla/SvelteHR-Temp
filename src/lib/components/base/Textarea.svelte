...
<div class={containerClasses}>
  {#if label}
    <label 
      ...
      class:textarea-label--required={required}
    >
      {label}
      {#if required}
  ...
  <div class="textarea-footer">
    ...
    {#if maxlength}
      <div class="textarea-character-count" class:textarea-character-count--over-limit={isOverLimit}>
...
<style lang="postcss">
  ...
  .textarea-character-count {
    @apply text-sm text-gray-500 ml-2 flex-shrink-0;
  }
