...
<Story name="Basic">
	<div class="w-80">
		<InputGroup label="Full Name" placeholder="Enter your full name" required />
	</div>
</Story>
...
<Story name="With Prefix and Suffix">
	<div class="w-80 space-y-4">
		...
		<InputGroup label="Price" prefix="$" suffix="USD" placeholder="0.00" type="number" />
	</div>
</Story>
...
<Story name="Sizes">
	<div class="w-80 space-y-4">
		<InputGroup label="Extra Small" size="xs" placeholder="Extra small input" prefixIcon={User} />

		<InputGroup label="Small" size="sm" placeholder="Small input" prefixIcon={User} />

		<InputGroup label="Medium (Default)" size="md" placeholder="Medium input" prefixIcon={User} />

		<InputGroup label="Large" size="lg" placeholder="Large input" prefixIcon={User} />

		<InputGroup label="Extra Large" size="xl" placeholder="Extra large input" prefixIcon={User} />
	</div>
</Story>
...
<Story name="Form Example">
	<div class="w-96 space-y-4">
		...
		<div class="grid grid-cols-2 gap-4">
			<InputGroup label="First Name" placeholder="John" prefixIcon={User} required />

			<InputGroup label="Last Name" placeholder="Doe" prefixIcon={User} required />
		</div>
		...
		<InputGroup label="Address" placeholder="123 Main St, City, State 12345" prefixIcon={MapPin} />

		<InputGroup label="Date of Birth" type="date" prefixIcon={Calendar} />

		<div class="flex gap-2">
			<button class="rounded bg-primary px-4 py-2 text-primary-foreground">Submit</button>
