<script lang="ts" module>
	...
	export interface InputGroupProps
		extends WithElementRef<
				Omit<HTMLInputAttributes, 'disabled' | 'size' | 'id' | 'loading' | 'placeholder'>
			>,
			Omit<EnhancedInputProps, 'className'> {
		prefix?: string;
		suffix?: string;
		prefixIcon?: any;
		suffixIcon?: any;
...
<div class="form-group">
	<!-- Label -->
	{#if label}
		<label for={inputId} class={cn('form-label', required && 'required')}>
			{label}
		</label>
	{/if}
