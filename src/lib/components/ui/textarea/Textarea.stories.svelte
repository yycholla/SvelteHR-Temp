...
<Story name="Notes with Character Count">
	<div class="w-[32rem] space-y-4">
		<div class="space-y-2">
			...
			<Textarea id="notes" bind:value={notes} class="resize-y" rows="12" />
			<div class="flex justify-between text-xs text-muted-foreground">
...
<Story name="Auto-resize">
	<div class="w-80 space-y-2">
		...
		/>
		<p class="text-xs text-muted-foreground">Textarea height adjusts automatically</p>
	</div>
</Story>
...
*Note: Assembly required*`}
		...
		<div class="rounded-lg border p-4">
			<h4 class="mb-2 font-medium">Formatted Preview</h4>
			<div class="prose prose-sm max-w-none text-sm">
				...
				<p>
					This premium widget is designed for professional use. Made from high-quality materials, it
					offers exceptional performance and reliability.
				</p>
