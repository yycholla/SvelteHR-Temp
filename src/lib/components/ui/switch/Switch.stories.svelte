		...
		<CardContent class="space-y-4">
			...
			<div class="flex items-center justify-between">
				<Label for="dark-mode" class="flex flex-col space-y-1">
					<span>Dark Mode</span>
					<span class="text-sm font-normal text-muted-foreground"> Enable dark theme </span>
				</Label>
			...
			{#if emailNotifications || pushNotifications || darkMode || autoSave || publicProfile}
				<div class="rounded bg-muted p-3 text-sm">
					<p class="mb-1 font-medium">Current Settings:</p>
...
<Story name="Toggle States">
	<div class="max-w-sm space-y-4">
		...
		<div class="flex items-center justify-between rounded-lg border p-3 opacity-50">
			<div>
