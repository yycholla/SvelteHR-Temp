  ...
  <div class="w-80 space-y-2">
    ...
    <Select>
      ...
      <SelectContent>
        ...
        <div class="px-2 py-1 text-xs font-medium text-muted-foreground border-t mt-1 pt-2">Backend</div>
        <SelectItem value="nodejs">Node.js</SelectItem>
        <SelectItem value="python">Python</SelectItem>
        <SelectItem value="java">Java</SelectItem>
        <SelectItem value="go">Go</SelectItem>
        
        <div class="px-2 py-1 text-xs font-medium text-muted-foreground border-t mt-1 pt-2">Database</div>
