		...
		<DialogContent>
			<DialogHeader>
				...
				<DialogDescription>
					...
					permanently remove the item from your account.
				</DialogDescription>
			</DialogHeader>
	...
	<Dialog>
		...
		<DialogContent class="sm:max-w-md">
			<DialogHeader>
				...
				<DialogDescription>Configure your application settings below.</DialogDescription>
			</DialogHeader>
			<div class="space-y-4">
				<div class="space-y-2">
		...
		<Dialog bind:open={open1}>
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						This dialog's open state is controlled externally. Current state: {open1
							? 'Open'
							: 'Closed'}
					</DialogDescription>
				</DialogHeader>
	...
	<Dialog>
		...
		<DialogContent class="sm:max-w-md">
			<div class="p-6 text-center">
				<h3 class="mb-2 text-lg font-semibold">Are you sure?</h3>
				<p class="mb-4 text-sm text-muted-foreground">This will perform the action immediately.</p>
