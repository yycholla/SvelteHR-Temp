...
<Story name="Variants">
  <div class="w-80 space-y-4">
    <div>
      <p class="text-sm font-medium mb-2">Default (60%)</p>
      <Progress variant="default" value={60} />
    </div>
    <div>
      <p class="text-sm font-medium mb-2">Success (80%)</p>
      <Progress variant="success" value={80} />
    </div>
    <div>
      <p class="text-sm font-medium mb-2">Warning (40%)</p>
      <Progress variant="warning" value={40} />
    </div>
    <div>
      <p class="text-sm font-medium mb-2">Destructive (25%)</p>
