	...
	<RadioGroup value="comfortable" class="max-w-md">
		<div class="flex items-start space-x-3">
			...
			<div class="space-y-1">
				...
				<p class="text-sm text-muted-foreground">Use the default spacing for lists and content.</p>
			</div>
		</div>
		<div class="flex items-start space-x-3">
			...
			<div class="space-y-1">
				...
				<p class="text-sm text-muted-foreground">Increase spacing for better readability.</p>
			</div>
		</div>
		<div class="flex items-start space-x-3">
			...
			<div class="space-y-1">
				...
				<p class="text-sm text-muted-foreground">Reduce spacing to fit more content.</p>
			</div>
		</div>
	</RadioGroup>
</Story>
		...
		<CardContent>
			<RadioGroup bind:value={paymentMethod}>
				<div class="flex items-center space-x-2 rounded-lg border p-3">
					...
					<Label for="payment-card" class="flex cursor-pointer items-center space-x-2">
						<svg
							class="h-5 w-5"
							viewBox="0 0 24 24"
							fill="none"
				...
				<div class="flex items-center space-x-2 rounded-lg border p-3">
					...
					<Label for="payment-paypal" class="flex cursor-pointer items-center space-x-2">
						<svg
							class="h-5 w-5"
							viewBox="0 0 24 24"
							fill="none"
				...
				<div class="flex items-center space-x-2 rounded-lg border p-3">
					...
					<Label for="payment-apple" class="flex cursor-pointer items-center space-x-2">
						<svg
							class="h-5 w-5"
							viewBox="0 0 24 24"
							fill="none"
			...
			{#if paymentMethod}
				<div class="mt-4 rounded bg-muted p-3 text-sm">
