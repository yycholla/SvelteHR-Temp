		...
		<div class="h-full space-y-3">
			...
			<div class="min-h-0 flex-1 overflow-hidden">
				{#if tasks.length === 0}
					<div class="flex h-full items-center justify-center text-center">
						<div class="space-y-2">
							<CheckSquare class="mx-auto h-6 w-6 text-muted-foreground" />
				...
				{:else}
					<div class="max-h-full space-y-2 overflow-hidden">
						{#each tasks as task}
							...
							<div
								class="flex items-center space-x-2 rounded border border-border/50 p-2 hover:bg-muted/30"
							>
								<div
									class="h-6 w-6 {statusInfo.bg} flex flex-shrink-0 items-center justify-center rounded-full"
								>
