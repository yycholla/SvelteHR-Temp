...
import type { PageLayoutProps, BreadcrumbItem, HeaderAction, NotificationItem, UserInfo } from '../../../../contracts/component-interface';
...
test.describe('PageLayout Component Contract', () => {
  ...
  test('should render page title and subtitle', async ({ page }) => {
    ...
    await expect(page.locator('.page-subtitle')).toContainText('Manage system users and permissions');
  });
