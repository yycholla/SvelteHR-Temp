  ...
  const primaryNavigation = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'employees-directory', label: 'Directory', href: '/employees/directory', active: false }
      ]
    },
    {
      id: 'departments',
      ...
      children: [
        ...
        { id: 'departments-add', label: 'Create Department', href: '/departments/new', active: false }
      ]
    },
    {
      id: 'tasks',
