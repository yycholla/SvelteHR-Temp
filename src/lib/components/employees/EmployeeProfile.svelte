            ...
            {#if employee.address}
              <div class="detail-item detail-item--full">
                ...
                <span class="detail-value">
                  ...
                  {/if}
                  {employee.address.city || ''}{employee.address.city && employee.address.state ? ', ' : ''}{employee.address.state || ''} {employee.address.zipCode || ''}
                </span>
              </div>
            {/if}
          </div>
...
>
  <div class="deactivate-modal">
    <p class="modal-description">
      Are you sure you want to deactivate <strong>{employee?.displayName}</strong>? 
...
<style lang="postcss">
  ...
  .profile-avatar {
    @apply flex-shrink-0 w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center overflow-hidden;
  }
  ...
  .detail-label {
    @apply block text-sm font-medium text-gray-500 uppercase tracking-wide;
  }
  ...
  .modal-textarea {
    @apply w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm;
  }
