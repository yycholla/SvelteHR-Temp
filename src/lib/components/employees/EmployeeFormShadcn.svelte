<script lang="ts">
  ...
  // Props
  let { employee = null, isEditing = false, loading = false }: {
    employee: User | null;
    isEditing?: boolean;
    loading?: boolean;
  } = $props();
  ...
  // Computed values
  const departmentOptions = $derived($departments.map(dept => ({
    value: dept.id,
    label: dept.name
  })));
...
<form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }} class="space-y-6">
  ...
  <Card.Root>
    <Card.Header>
      ...
      <Card.Description>
        Job details, department, and work arrangement
      </Card.Description>
    </Card.Header>
    <Card.Content class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="space-y-2">
          ...
          <Select.Root
            selected={{ value: formData.departmentId, label: departmentOptions.find(d => d.value === formData.departmentId)?.label || '' }}
        ...
        <div class="space-y-2">
          ...
          <Select.Root
            selected={{ value: formData.employmentType, label: employmentTypeOptions.find(o => o.value === formData.employmentType)?.label || '' }}
        ...
        <div class="space-y-2">
          ...
          <Select.Root
            selected={{ value: formData.managerId, label: managerOptions.find(m => m.value === formData.managerId)?.label || '' }}
      ...
      {#if !isEditing}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <Select.Root
              selected={{ value: formData.payType, label: payTypeOptions.find(p => p.value === formData.payType)?.label || '' }}
    ...
    <Card.Content class="space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="space-y-2 md:col-span-2">
          ...
          <Select.Root
            selected={{ value: formData.emergencyContactRelationship, label: relationshipOptions.find(r => r.value === formData.emergencyContactRelationship)?.label || '' }}
