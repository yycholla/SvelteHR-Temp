            ...
            <Table.Row>
              <Table.Head class="w-12">
                <input
                  ...
                  onchange={() => selectedEmployees.length === employees.length ? clearSelection() : selectAll()}
              ...
              <Table.Row>
                ...
                <Table.Cell>
                  <div class="flex items-center space-x-3">
                    <div class="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground font-medium text-sm">
            ...
            <Card.Content class="p-6">
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1 min-w-0">
                  <h4 class="font-semibold truncate">{employee.displayName}</h4>
                  <p class="text-sm text-muted-foreground truncate">{employee.email}</p>
                  {#if employee.jobTitle}
                    <p class="text-sm text-muted-foreground truncate">{employee.jobTitle}</p>
                  {/if}
                  {#if employee.department}
                    <p class="text-sm text-muted-foreground truncate">{employee.department.name}</p>
                  {/if}
                  <div class="mt-2">
