...
<style lang="postcss">
	...
	/* Task Item */
	.task-item {
		@apply rounded-lg border-l-4 border-gray-200 bg-white p-4 transition-all hover:shadow-sm;
	}
	...
	/* Instructions */
	.task-instructions {
		@apply mt-3 border-t border-gray-100 pt-3;
	}

	.instructions-toggle {
		@apply flex cursor-pointer items-center space-x-2 text-sm font-medium text-gray-700 hover:text-gray-900;
	}

	.instructions-content {
		@apply mt-2 rounded bg-gray-50 p-3 text-sm text-gray-600;
	}
	...
	.modal-content {
		@apply mx-4 w-full max-w-md rounded-lg bg-white shadow-lg;
	}
