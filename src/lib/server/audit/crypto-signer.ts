 ...
 */
export function signAuditLog(logEntry: any, privateKey: KeyObject | string): string {
	// Create canonical JSON representation for deterministic signing
 ...
 */
export function loadPublicKey(pemString: string): KeyObject {
 ...
 */
export function loadPrivateKey(pemString: string): KeyObject {
 ...
 */
export function generatePublicKeyId(publicKey: KeyObject): string {
