 ...
 */
export function normalizeApiResponse<T>(data: any, fieldMapping: FieldMapper<T>): Partial<T> {
 ...
 */
export function transformPaginatedResponse<T>(response: any, dataTransformer?: (item: any) => T) {
	return {
 ...
 */
export function validateRequiredFields<T>(data: any, requiredFields: (keyof T)[]): data is T {
