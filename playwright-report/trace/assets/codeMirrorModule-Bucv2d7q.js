import { q as _u } from './defaultSettingsView-BEpdCv1S.js';
var vi = { exports: {} },
	Ru = vi.exports,
	ha;
function Nt() {
			...
			(function (At, Ot) {
				(function (C, De) {
					...
					var C = navigator.userAgent,
						...
						P = /gecko\/\d/i.test(C),
						fe = /MSIE \d/.test(C),
						Se = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(C),
						le = /Edge\/(\d+)/.exec(C),
						b = fe || Se || le,
						W = b && (fe ? document.documentMode || 6 : +(le || Se)[1]),
						j = !le && /WebKit\//.test(C),
						oe = j && /Qt\/\d+\.\d+/.test(C),
						w = !le && /Chrome\/(\d+)/.exec(C),
						B = w && +w[1],
						A = /Opera\//.test(C),
						K = /Apple Computer/.test(navigator.vendor),
						ae = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(C),
						F = /PhantomJS/.test(C),
						N = K && (/Mobile\/\w+/.test(C) || navigator.maxTouchPoints > 2),
						R = /Android/.test(C),
						_ = N || R || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(C),
						Y = N || /Mac/.test(De),
						ce = /\bCrOS\b/.test(C),
						$ = /win/i.test(De),
						ee = A && C.match(/Version\/(\d*\.\d*)/);
					(ee && (ee = Number(ee[1])), ee && ee >= 15 && ((A = !1), (j = !0)));
					var Ae = Y && (oe || (A && (ee == null || ee < 12.11))),
						se = P || (b && W >= 9);
					function q(e) {
					...
					function z(e, t) {
						var n = e.className;
						q(t).test(n) || (e.className += (n ? ' ' : '') + t);
					}
					function ne(e, t) {
						for (var n = e.split(' '), r = 0; r < n.length; r++)
							n[r] && !q(n[r]).test(t) && (t += ' ' + n[r]);
						return t;
					}
					var p = function (e) {
						e.select();
					...
					var we = function () {
						((this.id = null),
							(this.f = null),
							(this.time = 0),
							(this.handler = pe(this.onTimeout, this)));
					};
					((we.prototype.onTimeout = function (e) {
						((e.id = 0),
					...
					function O(e, t) {
						var n;
						return (
							Object.create ? (n = Object.create(e)) : ((U.prototype = e), (n = new U())),
							t && Te(t, n),
							n
						);
					}
					var ze =
						/[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
					function he(e) {
						return /\w/.test(e) || (e > '' && (e.toUpperCase() != e.toLowerCase() || ze.test(e)));
					}
					function Le(e, t) {
						return t ? (t.source.indexOf('\\w') > -1 && he(e) ? !0 : t.test(e)) : he(e);
					}
					function ve(e) {
					...
					function Tt(e, t, n) {
						for (; (n < 0 ? t > 0 : t < e.length) && Ee(e.charAt(t)); ) t += n;
						return t;
					}
					function Pt(e, t, n) {
						for (var r = t > n ? -1 : 1; ; ) {
					...
					var mi = (function () {
						...
						return function (u, h) {
							...
							for (var k = u.length, y = [], E = 0; E < k; ++E) y.push(n(u.charCodeAt(E)));
							for (var H = 0, Z = v; H < k; ++H) {
								var Q = y[H];
								Q == 'm' ? (y[H] = Z) : (Z = Q);
							}
							for (var ie = 0, V = v; ie < k; ++ie) {
								var ue = y[ie];
								ue == '1' && V == 'r'
									? (y[ie] = 'n')
									: o.test(ue) && ((V = ue), ue == 'r' && (y[ie] = 'R'));
							}
							for (var be = 1, me = y[0]; be < k - 1; ++be) {
								var Ne = y[be];
								(Ne == '+' && me == '1' && y[be + 1] == '1'
									? (y[be] = '1')
									: Ne == ',' && me == y[be + 1] && (me == '1' || me == 'n') && (y[be] = me),
									(me = Ne));
							}
							for (var Ke = 0; Ke < k; ++Ke) {
								...
								if (st == ',') y[Ke] = 'N';
									...
									var Xe = void 0;
									for (Xe = Ke + 1; Xe < k && y[Xe] == '%'; ++Xe);
									for (
										var Mt = (Ke && y[Ke - 1] == '!') || (Xe < k && y[Xe] == '1') ? '1' : 'N',
											wt = Ke;
										wt < Xe;
										++wt
									)
							...
							for (var tt = 0, St = v; tt < k; ++tt) {
								var ft = y[tt];
								St == 'L' && ft == '1' ? (y[tt] = 'L') : o.test(ft) && (St = ft);
							}
							for (var nt = 0; nt < k; ++nt)
								if (i.test(y[nt])) {
									var rt = void 0;
									for (rt = nt + 1; rt < k && i.test(y[rt]); ++rt);
									for (
										var Qe = (nt ? y[nt - 1] : v) == 'L',
											Lt = (rt < k ? y[rt] : v) == 'L',
											nn = Qe == Lt ? (Qe ? 'L' : 'R') : v,
											yr = nt;
										yr < rt;
							...
							for (var gt = [], Jt, ut = 0; ut < k; )
								if (l.test(y[ut])) {
									var co = ut;
									for (++ut; ut < k && l.test(y[ut]); ++ut);
									gt.push(new s(0, co, ut));
								} else {
									var ir = ut,
										Fr = gt.length,
										Er = h == 'rtl' ? 1 : 0;
									for (++ut; ut < k && y[ut] != 'L'; ++ut);
									for (var mt = ir; mt < ut; )
										if (a.test(y[mt])) {
											ir < mt && (gt.splice(Fr, 0, new s(1, ir, mt)), (Fr += Er));
											var on = mt;
											for (++mt; mt < ut && a.test(y[mt]); ++mt);
											(gt.splice(Fr, 0, new s(2, on, mt)), (Fr += Er), (ir = mt));
										} else ++mt;
									ir < ut && gt.splice(Fr, 0, new s(1, ir, ut));
								}
							return (
								h == 'ltr' &&
									(gt[0].level == 1 &&
									...
									xe(gt).level == 1 &&
										(Jt = u.match(/\s+$/)) &&
										((xe(gt).to -= Jt[0].length), gt.push(new s(0, k - Jt[0].length, k)))),
								h == 'rtl' ? gt.reverse() : gt
							);
						};
					})();
					...
					function Wn(e) {
						if (Or == null) {
							var t = d('span', '​');
							(G(e, d('span', [t, document.createTextNode('x')])),
								e.firstChild.offsetHeight != 0 &&
									(Or = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && W < 8)));
						}
						var n = Or
							? d('span', '​')
					...
					function sr(e) {
						...
						return (M(e), !n || n.left == n.right ? !1 : (an = r.right - n.right < 3));
					}
					var zt =
							`
...
`,
					...
					function Ir(e) {
						if (typeof e == 'string' && _t.hasOwnProperty(e)) e = _t[e];
						else if (e && typeof e.name == 'string' && _t.hasOwnProperty(e.name)) {
							var t = _t[e.name];
						...
						(Je.prototype.column = function () {
							return (
								this.lastColumnPos < this.start &&
									...
									(this.lastColumnPos = this.start)),
								this.lastColumnValue -
									(this.lineStart ? Ce(this.string, this.lineStart, this.tabSize) : 0)
							);
						}),
					...
					function D(e, t, n) {
						if ((n === void 0 && (n = null), !(this instanceof D))) return new D(e, t, n);
					...
					function He(e, t) {
						return e.sticky == t.sticky && re(e, t) == 0;
					}
					function it(e) {
					...
					function Me(e, t) {
						...
						return t.line > n ? D(n, ge(e, n).text.length) : Ra(t, ge(e, t.line).text.length);
					}
					function Ra(e, t) {
						var n = e.ch;
					...
					((Xt.prototype.lookAhead = function (e) {
						...
						(Xt.prototype.save = function (e) {
							...
							return this.maxLookAhead > 0 ? new _n(t, this.maxLookAhead) : t;
						}));
					function vo(e, t, n, r) {
									...
									((n.state = !0),
										wo(
											...
											function (y, E) {
												for (var H = v; k < y; ) {
													var Z = i[v];
													(Z > y && i.splice(v, 1, y, i[v + 1], Z), (v += 2), (k = Math.min(y, Z)));
												}
												if (E)
													if (h.opaque) (i.splice(H, v - H, y, 'overlay ' + E), (v = H + 2));
													else
														for (; H < v; H += 2) {
															var Q = i[H + 1];
															i[H + 1] = (Q ? Q + ' ' : '') + 'overlay ' + E;
					...
					function fn(e, t, n) {
						...
						var o = qa(e, t, n),
							l = o > r.first && ge(r, o - 1).stateAfter,
					...
					function bi(e, t, n, r) {
						...
						for (o.start = o.pos = r || 0, t == '' && xo(i, n.state); !o.eol(); )
					...
					function bo(e, t, n, r) {
						...
						for (r && (h = []); (r || u.pos < t.ch) && !u.eol(); )
							((u.start = u.pos),
								(l = ki(o, u, s.state)),
								r && h.push(new yo(u, l, Gt(i.mode, s.state))));
					...
					function qa(e, t, n) {
						for (
							...
							var s = ge(o, a - 1),
								u = s.stateAfter;
							if (u && (!n || a + (u instanceof _n ? u.lookAhead : 0) <= o.modeFrontier)) return a;
					...
					function ja(e, t) {
						if (((e.modeFrontier = Math.min(e.modeFrontier, t)), !(e.highlightFrontier < t - 10))) {
							for (var n = e.first, r = t - 1; r > n; r--) {
								...
								if (i && (!(i instanceof _n) || r + i.lookAhead < t)) {
									n = r + 1;
									break;
								}
							}
					...
					function wi(e, t) {
						...
						var n = I(e, t.from.line) && ge(e, t.from.line).markedSpans,
							r = I(e, t.to.line) && ge(e, t.to.line).markedSpans;
						if (!n && !r) return null;
						var i = t.from.ch,
							o = t.to.ch,
							l = re(t.from, t.to) == 0,
							...
							s = Za(r, o, l),
							u = t.text.length == 1,
							h = xe(t.text).length + (u ? i : 0);
						if (a)
							for (var v = 0; v < a.length; ++v) {
								var k = a[v];
								if (k.to == null) {
									var y = cn(s, k.marker);
									y ? u && (k.to = y.to == null ? null : y.to + h) : (k.to = i);
								}
							}
						if (s)
							for (var E = 0; E < s.length; ++E) {
								var H = s[E];
								if ((H.to != null && (H.to += h), H.from == null)) {
									var Z = cn(a, H.marker);
									Z || ((H.from = h), u && (a || (a = [])).push(H));
								} else ((H.from += h), u && (a || (a = [])).push(H));
							}
						(a && (a = Lo(a)), s && s != a && (s = Lo(s)));
						var Q = [a];
						if (!u) {
							var ie = t.text.length - 2,
								V;
							if (ie > 0 && a)
								for (var ue = 0; ue < a.length; ++ue)
									a[ue].to == null && (V || (V = [])).push(new Rn(a[ue].marker, null, null));
							for (var be = 0; be < ie; ++be) Q.push(V);
							Q.push(s);
						}
						return Q;
					}
					...
					function Ja(e, t, n) {
						...
						if (
							(e.iter(t.line, n.line + 1, function (y) {
								if (y.markedSpans)
									for (var E = 0; E < y.markedSpans.length; ++E) {
										var H = y.markedSpans[E].marker;
										H.readOnly && (!r || de(r, H) == -1) && (r || (r = [])).push(H);
									}
							}),
							!r)
						)
						...
						for (var i = [{ from: t, to: n }], o = 0; o < r.length; ++o)
							for (var l = r[o], a = l.find(0), s = 0; s < i.length; ++s) {
								var u = i[s];
								if (!(re(u.to, a.from) < 0 || re(u.from, a.to) > 0)) {
									var h = [s, 1],
										v = re(u.from, a.from),
										k = re(u.to, a.to);
					...
					function Si(e, t) {
						...
						var r = e.find(),
							i = t.find(),
							o = re(r.from, i.from) || qn(e) - qn(t);
						if (o) return -o;
						var l = re(r.to, i.to) || jn(e) - jn(t);
						return l || t.id - e.id;
					}
					function Do(e, t) {
							...
							for (var a = 0; a < l.length; ++a) {
								...
								if (s.marker.collapsed) {
									var u = s.marker.find(0),
										h = re(u.from, n) || qn(s.marker) - qn(i),
										v = re(u.to, r) || jn(s.marker) - jn(i);
									if (
										!((h >= 0 && v <= 0) || (h <= 0 && v >= 0)) &&
										((h <= 0 &&
						...
						if (n) {
							for (var r = void 0, i = 0; i < n.length; ++i)
								if (((r = n[i]), !!r.marker.collapsed)) {
									...
									if (!r.marker.widgetNode && r.from == 0 && r.marker.inclusiveLeft && Ti(e, t, r))
										return !0;
								}
						}
					}
					...
					function Eo(e, t) {
						...
						var n = t.addModeClass ? ns : rs;
						return n[e] || (n[e] = e.replace(/\S+/g, 'cm-$&'));
					}
					function No(e, t) {
						var n = S('span', null, null, j ? 'padding-right: .1px' : null),
							r = {
						...
						for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
							...
							((r.pos = 0),
								...
								sr(e.display.measure) &&
									...
									(r.addToken = as(r.addToken, l)),
								(r.map = []));
							var a = t != e.display.externalMeasured && f(o);
							(ss(o, r, mo(e, o, a)),
								o.styleClasses &&
									(o.styleClasses.bgClass &&
										(r.bgClass = ne(o.styleClasses.bgClass, r.bgClass || '')),
									o.styleClasses.textClass &&
										(r.textClass = ne(o.styleClasses.textClass, r.textClass || ''))),
						...
						return (
							...
							r.pre.className && (r.textClass = ne(r.pre.className, r.textClass || '')),
							r
						);
					}
					function is(e) {
					...
					function os(e, t, n, r, i, o, l) {
						if (t) {
							var a = e.splitSpaces ? ls(t, e.trailingSpace) : t,
							...
							if (!s.test(t))
								...
								for (var v = 0; ; ) {
									s.lastIndex = v;
									var k = s.exec(t),
										y = k ? k.index - v : t.length - v;
									if (y) {
										var E = document.createTextNode(a.slice(v, v + y));
										(b && W < 9 ? h.appendChild(d('span', [E])) : h.appendChild(E),
											e.map.push(e.pos, e.pos + y, E),
											(e.col += y),
											(e.pos += y));
									}
									if (!k) break;
									...
									if (k[0] == '	') {
										var Z = e.cm.options.tabSize,
											Q = Z - (e.col % Z);
										((H = h.appendChild(d('span', et(Q), 'cm-tab'))),
										...
										k[0] ==
											`
`
											? ((H = h.appendChild(d('span', k[0] == '\r' ? '␍' : '␤', 'cm-invalidchar'))),
												H.setAttribute('cm-text', k[0]),
												(e.col += 1))
											: ((H = e.cm.options.specialCharPlaceholder(k[0])),
												H.setAttribute('cm-text', k[0]),
												b && W < 9 ? h.appendChild(d('span', [H])) : h.appendChild(H),
												(e.col += 1));
					...
					function ss(e, t, n) {
						...
						for (var a = i.length, s = 0, u = 1, h = '', v, k, y = 0, E, H, Z, Q, ie; ; ) {
							if (y == s) {
								((E = H = Z = k = ''), (ie = null), (Q = null), (y = 1 / 0));
								for (var V = [], ue = void 0, be = 0; be < r.length; ++be) {
									var me = r[be],
										Ne = me.marker;
									if (Ne.type == 'bookmark' && me.from == s && Ne.widgetNode) V.push(Ne);
									else if (
										me.from <= s &&
										(me.to == null || me.to > s || (Ne.collapsed && me.to == s && me.from == s))
									) {
										if (
											(me.to != null && me.to != s && y > me.to && ((y = me.to), (H = '')),
											Ne.className && (E += ' ' + Ne.className),
											Ne.css && (k = (k ? k + ';' : '') + Ne.css),
											Ne.startStyle && me.from == s && (Z += ' ' + Ne.startStyle),
											Ne.endStyle && me.to == y && (ue || (ue = [])).push(Ne.endStyle, me.to),
											Ne.title && ((ie || (ie = {})).title = Ne.title),
											Ne.attributes)
										)
											for (var Ke in Ne.attributes) (ie || (ie = {}))[Ke] = Ne.attributes[Ke];
										Ne.collapsed && (!Q || Si(Q.marker, Ne) < 0) && (Q = me);
									} else me.from > s && y > me.from && (y = me.from);
								}
								if (ue)
									for (var st = 0; st < ue.length; st += 2) ue[st + 1] == y && (H += ' ' + ue[st]);
								if (!Q || Q.from == s) for (var Xe = 0; Xe < V.length; ++Xe) Oo(t, 0, V[Xe]);
								if (Q && (Q.from || 0) == s) {
									if (
										(Oo(t, (Q.to == null ? a + 1 : Q.to) - s, Q.marker, Q.from == null),
										Q.to == null)
									)
										return;
									Q.to == s && (Q = !1);
							...
							if (s >= a) break;
							for (var Mt = Math.min(a, y); ; ) {
								if (h) {
									var wt = s + h.length;
									if (!Q) {
										var tt = wt > Mt ? h.slice(0, Mt - s) : h;
										t.addToken(t, tt, v ? v + E : E, Z, s + tt.length == y ? H : '', k, ie);
									}
									if (wt >= Mt) {
										((h = h.slice(Mt - s)), (s = Mt));
										break;
					...
					function Po(e, t, n) {
						((this.line = t),
							(this.rest = $a(t)),
							(this.size = this.rest ? f(xe(this.rest)) - n + 1 : 1),
							(this.node = this.text = null),
							(this.hidden = cr(e, t)));
					}
					function Gn(e, t, n) {
						for (var r = [], i, o = t; o < n; o = i) {
							var l = new Po(e.doc, ge(e.doc, o), o);
							((i = o + l.size), r.push(l));
						}
						return r;
					}
					...
					function ot(e, t) {
						...
						if (n.length) {
							var r = Array.prototype.slice.call(arguments, 2),
								i;
							Rr ? (i = Rr.delayedCallbacks) : dn ? (i = dn) : ((i = dn = []), setTimeout(ds, 0));
							for (
								var o = function (a) {
										i.push(function () {
					...
					function gs(e, t, n) {
						...
						for (var r = q('CodeMirror-linewidget'), i = t.node.firstChild, o = void 0; i; i = o)
					...
					function Wo(e, t, n) {
						if ((Ho(e, t.line, t, n, !0), t.rest))
							for (var r = 0; r < t.rest.length; r++) Ho(e, t.rest[r], t, n, !1);
					}
					...
					function pn(e) {
						...
						if (!m(document.body, e.node)) {
							...
							(e.coverGutter && (n += 'margin-left: -' + t.display.gutters.offsetWidth + 'px;'),
								...
								G(t.display.measure, d('div', [e.node], null, n)));
						}
					...
					function ys(e, t) {
						...
						return ((r.text = i.pre), G(e.display.lineMeasure, i.pre), r);
					}
					function qo(e, t, n, r) {
						...
						return (
							t.cache.hasOwnProperty(o)
								...
								: (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
									t.hasHeights || (xs(e, t.view, t.rect), (t.hasHeights = !0)),
									(l = ks(e, t, n, r)),
									l.bogus || (t.cache[o] = l)),
							{
								left: l.left,
					...
					function ks(e, t, n, r) {
						...
						if (o.nodeType == 3) {
							for (var h = 0; h < 4; h++) {
								for (; l && Ee(t.line.text.charAt(i.coverStart + l)); ) --l;
								for (; i.coverStart + a < i.coverEnd && Ee(t.line.text.charAt(i.coverStart + a)); )
									++a;
								if (
									(b && W < 9 && l == 0 && a == i.coverEnd - i.coverStart
										? (u = o.parentNode.getBoundingClientRect())
										: (u = bs(L(o, l, a).getClientRects(), r)),
									u.left || u.right || l == 0)
								)
									break;
								((a = l), (l = l - 1), (s = 'right'));
							}
							b && W < 11 && (u = ws(e.display.measure, u));
						} else {
							l > 0 && (s = r = 'right');
							var v;
						...
						return (
							!u.left && !u.right && (ue.bogus = !0),
							e.options.singleCursorHeightPerLine || ((ue.rtop = y), (ue.rbottom = E)),
							ue
						);
					}
					function ws(e, t) {
					...
					function Zn(e, t, n, r, i) {
						return (r || (r = ge(e.doc, t.line)), Yn(e, r, qo(e, r, t.ch, i), n));
					}
					function jt(e, t, n, r, i, o) {
						((r = r || ge(e.doc, t.line)), i || (i = qr(e, r)));
						function l(E, H) {
							var Z = Zt(e, i, E, H ? 'right' : 'left', o);
							return (H ? (Z.left = Z.right) : (Z.right = Z.left), Yn(e, r, Z, n));
						}
						...
						function h(E, H, Z) {
							var Q = a[H],
								ie = Q.level == 1;
							return l(Z ? E - 1 : E, ie != Z);
						}
						var v = lr(a, s, u),
							k = br,
							y = h(s, v, u == 'before');
						return (k != null && (y.other = h(s, k, u != 'before')), y);
					}
					function Jo(e, t) {
						var n = 0;
						((t = Me(e.doc, t)), e.options.lineWrapping || (n = Kr(e.display) * t.ch));
					...
					function Oi(e, t, n) {
						...
						var i = g(r, n),
							o = r.first + r.size - 1;
						if (i > o) return Ni(r.first + r.size - 1, ge(r, o).text.length, null, 1, 1);
						t < 0 && (t = 0);
						for (var l = ge(r, i); ; ) {
							var a = Ss(e, l, i, t, n),
								s = Qa(l, a.ch + (a.xRel > 0 || a.outside > 0 ? 1 : 0));
							if (!s) return a;
							var u = s.find(1);
					...
					function Ss(e, t, n, r, i) {
						...
						if (h) {
							var v = (e.options.lineWrapping ? Ts : Ls)(e, t, n, o, h, r, i);
						...
						var k = null,
							...
							E = Pt(
								function (be) {
									...
									return (
										...
										(me.bottom += l),
										Pi(me, r, i, !1)
											? (me.top <= i && me.left <= r && ((k = be), (y = me)), !0)
											: !1
									);
								},
								a,
							...
							Q = !1;
						if (y) {
							var ie = r - y.left < y.right - r,
								V = ie == u;
							((E = k + (V ? 0 : 1)), (Z = V ? 'after' : 'before'), (H = ie ? y.left : y.right));
						} else {
							(!u && (E == s || E == a) && E++,
								(Z =
									E == 0
										...
										: E == t.text.length
											? 'before'
											: Zt(e, o, E - (u ? 1 : 0)).bottom + l <= i == u
												? 'after'
												: 'before'));
							var ue = jt(e, D(n, E, Z), 'line', t, o);
							((H = ue.left), (Q = i < ue.top ? -1 : i >= ue.bottom ? 1 : 0));
						}
						return ((E = Tt(t.text, E, 1)), Ni(n, E, Z, Q, r - H));
					}
					function Ls(e, t, n, r, i, o, l) {
						var a = Pt(
								function (v) {
									var k = i[v],
										y = k.level != 1;
									return Pi(
										jt(e, D(n, y ? k.to : k.from, y ? 'before' : 'after'), 'line', t, r),
										o,
										l,
										!0
									);
						...
						if (a > 0) {
							var u = s.level != 1,
								h = jt(e, D(n, u ? s.from : s.to, u ? 'after' : 'before'), 'line', t, r);
					...
					function Ts(e, t, n, r, i, o, l) {
						...
						for (var h = null, v = null, k = 0; k < i.length; k++) {
							...
							if (!(y.from >= u || y.to <= s)) {
								var E = y.level != 1,
									H = Zt(e, r, E ? Math.min(u, y.to) - 1 : Math.max(s, y.from)).right,
									Z = H < o ? o - H + 1e9 : H - o;
								(!h || v > Z) && ((h = y), (v = Z));
							}
						}
					...
					function Lr(e, t, n, r) {
						...
						var s = Oi(e, o, l),
							u;
						if (r && s.xRel > 0 && (u = ge(e.doc, s.line).text).length == s.ch) {
							var h = Ce(u, u.length, e.options.tabSize) - u.length;
							s = D(s.line, Math.max(0, Math.round((o - _o(e.display).left) / Kr(e.display)) - h));
						}
						return s;
					}
					function Tr(e, t) {
					...
					function bt(e, t, n, r) {
						...
						if (
							...
							$t && Li(e.doc, t) < i.viewTo && hr(e);
						else if (n <= i.viewFrom)
							$t && Fo(e.doc, n + r) > i.viewFrom ? hr(e) : ((i.viewFrom += r), (i.viewTo += r));
					...
					function Cs(e, t, n) {
						...
						(i.length == 0 || t >= r.viewTo || n <= r.viewFrom
							...
							: (r.viewFrom > t
									...
									: r.viewFrom < t && (r.view = r.view.slice(Tr(e, t))),
								(r.viewFrom = t),
								r.viewTo < n
									? (r.view = r.view.concat(Gn(e, r.viewTo, n)))
									: r.viewTo > n && (r.view = r.view.slice(0, Tr(e, n)))),
							(r.viewTo = n));
					}
					function el(e) {
					...
					function Ds(e, t, n) {
						...
						function v(V, ue, be) {
							var me = ge(i, V),
								...
								st;
							function Xe(tt, St) {
								return Zn(e, D(V, tt), 'div', me, St);
							}
							function Mt(tt, St, ft) {
								var nt = Vo(e, me, null, tt),
									rt = (St == 'ltr') == (ft == 'after') ? 'left' : 'right',
									Qe =
										ft == 'after'
											? nt.begin
											: nt.end - (/\s/.test(me.text.charAt(nt.end - 1)) ? 2 : 1);
								return Xe(Qe, rt)[rt];
							}
							var wt = We(me, i.direction);
							return (
								or(wt, ue || 0, be ?? Ne, function (tt, St, ft, nt) {
									var rt = ft == 'ltr',
										Qe = Xe(tt, rt ? 'left' : 'right'),
										Lt = Xe(St - 1, rt ? 'right' : 'left'),
										nn = ue == null && tt == 0,
										yr = be == null && St == Ne,
										gt = nt == 0,
									...
									if (Lt.top - Qe.top <= 3) {
										var ut = (u ? nn : yr) && gt,
											co = (u ? yr : nn) && Jt,
											ir = ut ? a : (rt ? Qe : Lt).left,
											Fr = co ? s : (rt ? Lt : Qe).right;
										h(ir, Qe.top, Fr - ir, Qe.bottom);
									} else {
										var Er, mt, on, ho;
										(rt
											? ((Er = u && nn && gt ? a : Qe.left),
												...
												(ho = u && yr && Jt ? s : Lt.right))
											: ((Er = u ? Mt(tt, ft, 'before') : a),
												(mt = !u && nn && gt ? s : Qe.right),
												(on = !u && yr && Jt ? a : Lt.left),
												(ho = u ? Mt(St, ft, 'after') : s)),
											h(Er, Qe.top, mt - Er, Qe.bottom),
											Qe.bottom < Lt.top && h(a, Qe.bottom, null, Lt.top),
											h(on, Lt.top, ho - on, Lt.bottom));
									}
									((!Ke || Qn(Qe, Ke) < 0) && (Ke = Qe),
										Qn(Lt, Ke) < 0 && (Ke = Lt),
										(!st || Qn(Qe, st) < 0) && (st = Qe),
						...
						var k = t.from(),
							y = t.to();
						if (k.line == y.line) v(k.line, k.ch, y.ch);
						else {
							var E = ge(i, k.line),
								H = ge(i, y.line),
								Z = qt(E) == qt(H),
								Q = v(k.line, k.ch, Z ? E.text.length + 1 : null).end,
								ie = v(y.line, Z ? 0 : null, y.ch).start;
							(Z &&
								(Q.top < ie.top - 2
									? (h(Q.right, Q.top, null, Q.bottom), h(a, ie.top, ie.left, ie.bottom))
									: h(Q.right, Q.top, ie.left - Q.right, Q.bottom)),
								Q.bottom < ie.top && h(a, Q.bottom, null, ie.top));
						}
						n.appendChild(o);
					}
					function Hi(e) {
					...
					function Ur(e, t) {
						e.state.delayingBlurEvent ||
							(e.state.focused &&
								(Ye(e, 'blur', e, t),
								(e.state.focused = !1),
								Fe(e.display.wrapper, 'CodeMirror-focused')),
					...
					function Vn(e) {
						for (
							...
							if (!a.hidden) {
								...
								if (
									(y > 0.005 || y < -0.005) &&
									(i < r && (o -= y), Ft(a.line, u), nl(a.line), a.rest)
								)
									for (var E = 0; E < a.rest.length; E++) nl(a.rest[E]);
								if (h > e.display.sizerWidth) {
									var H = Math.ceil(h / Kr(e.display));
					...
					function $n(e, t, n) {
						...
						if (n && n.ensure) {
							var a = n.ensure.from.line,
								s = n.ensure.to.line;
							a < o
								? ((o = a), (l = g(t, er(ge(t, a)) + e.wrapper.clientHeight)))
								: Math.min(s, t.lastLine()) >= l &&
									((o = g(t, er(ge(t, s)) - e.wrapper.clientHeight)), (l = s));
						}
					...
					function As(e, t, n, r) {
						...
						!e.options.lineWrapping &&
							t == n &&
							((n = t.sticky == 'before' ? D(t.line, t.ch + 1, 'before') : t),
							(t = t.ch ? D(t.line, t.sticky == 'before' ? t.ch - 1 : t.ch, 'after') : t));
						for (var o = 0; o < 5; o++) {
							var l = !1,
								a = jt(e, t),
								s = !n || n == t ? a : jt(e, n);
							...
							if (
								(u.scrollTop != null &&
									(xn(e, u.scrollTop), Math.abs(e.doc.scrollTop - h) > 1 && (l = !0)),
								u.scrollLeft != null &&
					...
					function Fs(e, t) {
						var n = qi(e, t);
						(n.scrollTop != null && xn(e, n.scrollTop),
					...
					function qi(e, t) {
						...
						return (
							...
							t.left < 10
								? (l.scrollLeft = 0)
								: t.left < k
									? (l.scrollLeft = Math.max(0, t.left + v - (E ? 0 : 10)))
									: t.right > y + k - 3 && (l.scrollLeft = t.right + (E ? 0 : 10) - y),
							l
						);
					}
					function ji(e, t) {
					...
					function xn(e, t) {
						Math.abs(e.doc.scrollTop - t) < 2 ||
							(P || Ui(e, { top: t }), ol(e, t, !0), P && Ui(e), kn(e, 100));
					}
					function ol(e, t, n) {
						((t = Math.max(
							0,
					...
					var Dr = function (e, t, n) {
						...
						((r.tabIndex = i.tabIndex = -1),
							...
							b && W < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = '18px'));
					};
					((Dr.prototype.update = function (e) {
						...
						(Dr.prototype.zeroWidthHack = function () {
							var e = Y && !ae ? '12px' : '18px';
							((this.horiz.style.height = this.vert.style.width = e),
								(this.horiz.style.visibility = this.vert.style.visibility = 'hidden'),
								(this.disableHoriz = new we()),
								(this.disableVert = new we()));
						}),
					...
					function sl(e) {
						(e.display.scrollbars &&
							...
							e.display.scrollbars.addClass &&
								Fe(e.display.wrapper, e.display.scrollbars.addClass)),
							(e.display.scrollbars = new al[e.options.scrollbarStyle](
								function (t) {
									(e.display.wrapper.insertBefore(t, e.display.scrollbarFiller),
										ye(t, 'mousedown', function () {
											e.state.focused &&
												setTimeout(function () {
								...
								function (t, n) {
									n == 'horizontal' ? Cr(e, t) : xn(e, t);
								},
								e
							)),
							e.display.scrollbars.addClass && z(e.display.wrapper, e.display.scrollbars.addClass));
					}
					var Ns = 0;
					function Mr(e) {
						((e.curOp = {
					...
					function Os(e) {
						...
						for (var l = 0; l < t.length; l++) Ws(t[l]);
					}
					function Ps(e) {
						var t = e.cm,
							n = t.display;
					...
					function kn(e, t) {
						e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, pe(Hs, e));
					}
					function Hs(e) {
						var t = e.doc;
					...
					function qs(e) {
						if (
							!(!e || !e.activeElt || e.activeElt == x(ke(e.activeElt))) &&
							(e.activeElt.focus(),
					...
					function Ki(e, t) {
						...
						(Cs(e, o, l),
							(n.viewOffset = er(ge(e.doc, n.viewFrom))),
						...
						return (
							...
							js(e, n.updateLineNumbers, t.dims),
						...
						for (var n = t.viewport, r = !0; ; r = !1) {
							if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
								if (
									(n &&
										n.top != null &&
										(n = { top: Math.min(e.doc.height + Mi(e.display) - Ai(e), n.top) }),
					...
					function js(e, t, n) {
						...
						function a(E) {
							var H = E.nextSibling;
							return (
								j && Y && e.display.currentWheelTarget == E
						...
						for (var s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
							...
							if (!v.hidden)
								if (!v.node || v.node.parentNode != o) {
									...
									for (; l != v.node; ) l = a(l);
									var y = i && t != null && t <= u && v.lineNumber;
									(v.changes && (de(v.changes, 'gutter') > -1 && (y = !1), Io(e, v, u, n)),
										y &&
											(M(v.lineNumber),
											v.lineNumber.appendChild(document.createTextNode(X(e.options, u)))),
					...
					function Ks(e, t, n, r) {
						...
						((i.mover = d('div', [o], null, 'position: relative')),
							...
							(i.heightForcer = d(
								...
								null,
								null,
								'position: absolute; height: ' + Oe + 'px; width: 1px;'
							)),
							...
							w && B >= 105 && (i.wrapper.style.clipPath = 'inset(0px)'),
							i.wrapper.setAttribute('translate', 'no'),
							b && W < 8 && ((i.gutters.style.zIndex = -1), (i.scroller.style.paddingRight = 0)),
							!j && !(P && _) && (i.scroller.draggable = !0),
					...
					var ri = 0,
						rr = null;
					b ? (rr = -0.53) : P ? (rr = 15) : w ? (rr = -0.7) : K && (rr = -1 / 3);
					function hl(e) {
						var t = e.wheelDeltaX,
							n = e.wheelDeltaY;
						return (
					...
					function pl(e, t) {
						...
						if ((r && s) || (i && u)) {
							...
							if (r && !P && !A && o != null) {
								(i && u && xn(e, Math.max(0, a.scrollTop + i * o)),
							...
							if (i && o != null) {
								var y = i * o,
									E = e.doc.scrollTop,
									H = E + l.wrapper.clientHeight;
								(y < 0 ? (E = Math.max(0, E + y - 50)) : (H = Math.min(e.doc.height, H + y + 50)),
									Ui(e, { top: E, bottom: H }));
							}
							ri < 20 &&
								t.deltaMode !== 0 &&
										...
										setTimeout(function () {
											if (l.wheelStartX != null) {
												var Z = a.scrollLeft - l.wheelStartX,
													...
													ie =
														(Q && l.wheelDY && Q / l.wheelDY) || (Z && l.wheelDX && Z / l.wheelDX);
												((l.wheelStartX = l.wheelStartY = null),
													ie && ((rr = (rr * ri + ie) / (ri + 1)), ++ri));
											}
										}, 200))
					...
					((Et.prototype.primary = function () {
						...
						(Et.prototype.equals = function (e) {
							...
							for (var t = 0; t < this.ranges.length; t++) {
								var n = this.ranges[t],
									r = e.ranges[t];
								if (!He(n.anchor, r.anchor) || !He(n.head, r.head)) return !1;
							}
							return !0;
						}),
						(Et.prototype.deepCopy = function () {
							for (var e = [], t = 0; t < this.ranges.length; t++)
								e[t] = new _e(it(this.ranges[t].anchor), it(this.ranges[t].head));
							return new Et(e, this.primIndex);
						}),
						(Et.prototype.somethingSelected = function () {
						...
						(Et.prototype.contains = function (e, t) {
							...
							for (var n = 0; n < this.ranges.length; n++) {
								var r = this.ranges[n];
								if (re(t, r.from()) >= 0 && re(e, r.to()) <= 0) return n;
							}
							return -1;
						}));
					var _e = function (e, t) {
					...
					function Kt(e, t, n) {
						...
						for (var o = 1; o < t.length; o++) {
							...
							if (r && !l.empty() ? s > 0 : s >= 0) {
								...
								(o <= n && --n, t.splice(--o, 2, new _e(v ? h : u, v ? u : h)));
							}
						}
						return new Et(t, n);
					}
					function pr(e, t) {
						return new Et([new _e(e, t || e)], 0);
					}
					function gr(e) {
						return e.text
							? D(
					...
					function gl(e, t) {
						if (re(e, t.from) < 0) return e;
						if (re(e, t.to) <= 0) return gr(t);
						var n = e.line + t.text.length - (t.to.line - t.from.line) - 1,
							r = e.ch;
						return (e.line == t.to.line && (r += gr(t).ch - t.to.ch), D(n, r));
					}
					function Zi(e, t) {
						for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
							var i = e.sel.ranges[r];
							n.push(new _e(gl(i.anchor, t), gl(i.head, t)));
						}
						return Kt(e.cm, n, e.sel.primIndex);
					}
					function vl(e, t, n) {
						return e.line == t.line
							? D(n.line, e.ch - t.ch + n.ch)
							: D(n.line + (e.line - t.line), e.ch);
					}
					function Gs(e, t, n) {
						for (var r = [], i = D(e.first, 0), o = i, l = 0; l < t.length; l++) {
							var a = t[l],
								s = vl(a.from, i, o),
								u = vl(gr(a), i, o);
							if (((i = a.to), (o = u), n == 'around')) {
								var h = e.sel.ranges[l],
									v = re(h.head, h.anchor) < 0;
								r[l] = new _e(v ? u : s, v ? s : u);
							} else r[l] = new _e(s, s);
						}
						return new Et(r, e.sel.primIndex);
					}
					function Ji(e) {
					...
					function Qi(e, t, n, r) {
						...
						function o(ie, V, ue) {
							(es(ie, V, ue, r), ot(ie, 'change', ie, t));
						}
						function l(ie, V) {
							for (var ue = [], be = ie; be < V; ++be) ue.push(new _r(u[be], i(be), r));
							return ue;
						}
						var a = t.from,
							s = t.to,
						...
						if (t.full) (e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length));
							...
							(o(v, v.text, y), E && e.remove(a.line, E), H.length && e.insert(a.line, H));
						} else if (h == v)
							if (u.length == 1) o(h, h.text.slice(0, a.ch) + k + h.text.slice(s.ch), y);
							else {
								var Z = l(1, u.length - 1);
								(Z.push(new _r(k + h.text.slice(s.ch), y, r)),
							...
							(o(h, h.text.slice(0, a.ch) + u[0], i(0)), o(v, k + v.text.slice(s.ch), y));
							var Q = l(1, u.length - 1);
							(E > 1 && e.remove(a.line + 1, E - 1), e.insert(a.line + 1, Q));
						}
						ot(e, 'change', e, t);
					}
					function vr(e, t, n) {
					...
					function yl(e) {
						(e.doc.direction == 'rtl' ? z : Fe)(e.display.lineDiv, 'CodeMirror-rtl');
					}
					function Xs(e) {
						Dt(e, function () {
							(yl(e), bt(e));
					...
					function Ys(e, t) {
						if (t) return (bl(e.done), xe(e.done));
					...
					function kl(e, t, n, r) {
						...
						if (
							...
							((a = xe(l.changes)),
								re(t.from, t.to) == 0 && re(t.from, a.to) == 0
									? (a.to = gr(t))
					...
					function Js(e, t, n, r) {
						...
						(o &&
							i.lastSelOrigin == o &&
							((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || Zs(e, o, xe(i.done), t)))
					...
					function Vs(e, t) {
						var n = t['spans_' + e.id];
						if (!n) return null;
						for (var r = [], i = 0; i < t.text.length; ++i) r.push(Qs(n[i]));
						return r;
					}
					function Sl(e, t) {
						var n = Vs(e, t),
					...
					function Yr(e, t, n) {
						for (var r = [], i = 0; i < e.length; ++i) {
							var o = e[i];
							if (o.ranges) {
								r.push(n ? Et.prototype.deepCopy.call(o) : o);
								continue;
							}
							var l = o.changes,
								a = [];
					...
					function $i(e, t, n, r) {
						if (r) {
							...
							if (n) {
								var o = re(t, i) < 0;
								o != re(n, i) < 0 ? ((i = t), (t = n)) : o != re(t, n) < 0 && (t = n);
							}
							return new _e(i, t);
						} else return new _e(n || t, t);
					}
					function oi(e, t, n, r, i) {
						(i == null && (i = e.cm && (e.cm.display.shift || e.extend)),
							pt(e, new Et([$i(e.sel.primary(), t, n, i)], 0), r));
					}
					function Ll(e, t, n) {
						for (
						...
						var r = {
							...
							update: function (i) {
								...
								for (var o = 0; o < i.length; o++)
									this.ranges[o] = new _e(Me(e, i[o].anchor), Me(e, i[o].head));
							},
							origin: n && n.origin
						};
						return (
					...
					function pt(e, t, n) {
						(li(e, t, n), Js(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n));
					}
					function li(e, t, n) {
						(Ct(e, 'beforeSelectionChange') || (e.cm && Ct(e.cm, 'beforeSelectionChange'))) &&
							(t = $s(e, t, n));
						var r = (n && n.bias) || (re(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
						(Dl(e, Al(e, t, r, !0)),
							!(n && n.scroll === !1) &&
								e.cm &&
					...
					function Dl(e, t) {
						t.equals(e.sel) ||
							((e.sel = t),
							e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), It(e.cm)),
							ot(e, 'cursorActivity', e));
					}
					function Ml(e) {
						Dl(e, Al(e, e.sel, null, !1));
					}
					function Al(e, t, n, r) {
						for (var i, o = 0; o < t.ranges.length; o++) {
							...
							(i || s != l.anchor || u != l.head) &&
								(i || (i = t.ranges.slice(0, o)), (i[o] = new _e(s, u)));
						}
								...
								if (
									...
									if (n) {
										var v = s.find(r < 0 ? 1 : -1),
											k = void 0;
										if (
											((r < 0 ? h : u) && (v = Fl(e, v, -r, v && v.line == t.line ? o : null)),
											v && v.line == t.line && (k = re(v, n)) && (r < 0 ? k < 0 : k > 0))
										)
											return Zr(e, v, t, r, i);
									}
									var y = s.find(r < 0 ? -1 : 1);
									return (
										(r < 0 ? u : h) && (y = Fl(e, y, r, y.line == t.line ? o : null)),
										y ? Zr(e, y, t, r, i) : null
									);
								}
							}
					...
					function El(e) {
						e.setSelection(D(e.firstLine(), 0), D(e.lastLine()), Ve);
					}
					function Nl(e, t, n) {
						var r = {
							canceled: !1,
					...
					function Ol(e, t) {
						if (!(t.text.length == 1 && t.text[0] == '' && re(t.from, t.to) == 0)) {
							var n = Zi(e, t);
							(kl(e, t, n, e.cm ? e.cm.curOp.id : NaN), Ln(e, t, n, wi(e, t)));
							var r = [];
							vr(e, function (i, o) {
								(!o && de(r, i.history) == -1 && (Bl(i.history, t), r.push(i.history)),
									Ln(i, t, null, wi(i, t)));
							});
						}
					}
							...
							if (u != a.length) {
								...
								for (
									var v = Ct(e, 'beforeChange') || (e.cm && Ct(e.cm, 'beforeChange')),
										k = function (H) {
											var Z = o.changes[H];
											if (((Z.origin = t), v && !Nl(e, Z, !1))) return ((a.length = 0), {});
											h.push(Vi(e, Z));
											var Q = H ? Zi(e, Z) : xe(a);
											(Ln(e, Z, Q, Sl(e, Z)),
												!H && e.cm && e.cm.scrollIntoView({ from: Z.from, to: gr(Z) }));
											var ie = [];
											vr(e, function (V, ue) {
												(!ue && de(ie, V.history) == -1 && (Bl(V.history, Z), ie.push(V.history)),
													Ln(V, Z, null, Sl(V, Z)));
											});
										},
					...
					function Pl(e, t) {
						if (
							...
							((e.first += t),
							(e.sel = new Et(
								Ie(e.sel.ranges, function (i) {
									return new _e(D(i.anchor.line + t, i.anchor.ch), D(i.head.line + t, i.head.ch));
								}),
								e.sel.primIndex
							)),
							e.cm)
					...
					function Ln(e, t, n, r) {
						if (e.cm && !e.cm.curOp) return lt(e.cm, Ln)(e, t, n, r);
						...
						if (!(t.from.line > e.lastLine())) {
							...
							(t.to.line > o &&
								(t = {
									from: t.from,
									to: D(o, ge(e, o).text.length),
									text: [t.text[0]],
									origin: t.origin
								}),
								(t.removed = Vt(e, t.from, t.to)),
								n || (n = Zi(e, t)),
								e.cm ? eu(e.cm, t, r) : Qi(e, t, r),
								li(e, n, Ve),
								e.cantEdit && ai(e, D(e.firstLine(), 0)) && (e.cantEdit = !1));
						}
					}
					function eu(e, t, n) {
						var r = e.doc,
						...
						(e.options.lineWrapping ||
							...
							r.sel.contains(t.from, t.to) > -1 && It(e),
							Qi(r, t, n, $o(e)),
							e.options.lineWrapping ||
								(r.iter(s, o.line + t.text.length, function (y) {
									var E = Un(y);
									E > i.maxLineLength &&
										((i.maxLine = y), (i.maxLineLength = E), (i.maxLineChanged = !0), (a = !1));
								}),
					...
					function zl(e, t, n, r) {
						for (var i = 0; i < e.length; ++i) {
							...
							for (var s = 0; s < o.changes.length; ++s) {
								var u = o.changes[s];
								if (n < u.from.line)
									((u.from = D(u.from.line + r, u.from.ch)), (u.to = D(u.to.line + r, u.to.ch)));
								else if (t <= u.to.line) {
									l = !1;
									break;
								}
					...
					function Tn(e, t, n, r) {
						var i = t,
							o = t;
						return (
							typeof t == 'number' ? (o = ge(e, po(e, t))) : (i = f(t)),
					...
					Cn.prototype = {
						...
						removeInner: function (e, t) {
							for (var n = e, r = e + t; n < r; ++n) {
								var i = this.lines[n];
								((this.height -= i.height), ts(i), ot(i, 'delete'));
							}
					...
					((mr.prototype.clear = function () {
						...
						(mr.prototype.find = function (e, t) {
							...
							for (var n, r, i = 0; i < this.lines.length; ++i) {
								...
								if (l.from != null && ((n = D(t ? o : f(o), l.from)), e == -1)) return n;
								if (l.to != null && ((r = D(t ? o : f(o), l.to)), e == 1)) return r;
							}
					...
					function Vr(e, t, n, r, i) {
						if (r && r.shared) return ru(e, t, n, r, i);
						...
						if (
							...
							o.readOnly &&
								(Ka(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
							o.collapsed && ((o.id = ++Hl), (o.atomic = !0)),
							s)
						) {
					...
					((An.prototype.clear = function () {
						...
						(An.prototype.find = function (e, t) {
					...
					function ru(e, t, n, r, i) {
						...
						return (
							vr(e, function (s) {
								(a && (r.widgetNode = a.cloneNode(!0)), o.push(Vr(s, Me(s, t), Me(s, n), r, i)));
						...
						for (
							var t = function (r) {
									...
									for (var l = 0; l < i.markers.length; l++) {
										var a = i.markers[l];
										de(o, a.doc) == -1 && ((a.parent = null), i.markers.splice(l--, 1));
									}
								},
								n = 0;
							n < e.length;
					...
					var ou = 0,
						kt = function (e, t, n, r, i) {
							...
							(n == null && (n = 0),
								Dn.call(this, [new Cn([new _r('', null)])]),
								(this.first = n),
					...
					((kt.prototype = O(Dn.prototype, {
						...
						replaceRange: function (e, t, n, r) {
							((t = Me(this, t)), (n = n ? Me(this, n) : t), Qr(this, e, t, n, r));
						},
						getRange: function (e, t, n) {
							var r = Vt(this, Me(this, e), Me(this, t));
						...
						getLineHandle: function (e) {
							if (I(this, e)) return ge(this, e);
						},
						getLineNumber: function (e) {
							return f(e);
						},
						getLineHandleVisualStart: function (e) {
							return (typeof e == 'number' && (e = ge(this, e)), qt(e));
						},
						lineCount: function () {
							return this.size;
						},
						...
						setCursor: at(function (e, t, n) {
							Tl(this, Me(this, typeof e == 'number' ? D(e, t || 0) : e), null, n);
						}),
						setSelection: at(function (e, t, n) {
							Tl(this, Me(this, e), Me(this, t || e), n);
						}),
						extendSelection: at(function (e, t, n) {
							oi(this, Me(this, e), t && Me(this, t), n);
						}),
						extendSelections: at(function (e, t) {
							Ll(this, go(this, e), t);
						}),
						extendSelectionsBy: at(function (e, t) {
							var n = Ie(this.sel.ranges, e);
							Ll(this, go(this, n), t);
						}),
						setSelections: at(function (e, t, n) {
							if (e.length) {
								for (var r = [], i = 0; i < e.length; i++)
									r[i] = new _e(Me(this, e[i].anchor), Me(this, e[i].head || e[i].anchor));
						...
						addSelection: at(function (e, t, n) {
							...
							(r.push(new _e(Me(this, e), Me(this, t || e))),
						...
						replaceSelections: at(function (e, t, n) {
							...
							for (var a = t && t != 'end' && Gs(this, r, t), s = r.length - 1; s >= 0; s--)
								Jr(this, r[s]);
						...
						setGutterMarker: at(function (e, t, n) {
							return Tn(this, e, 'gutter', function (r) {
								...
								return ((i[t] = n), !n && ve(i) && (r.gutterMarkers = null), !0);
							});
						}),
								...
								n.gutterMarkers &&
									...
									Tn(t, n, 'gutter', function () {
										return (
											...
											ve(n.gutterMarkers) && (n.gutterMarkers = null),
											!0
										);
									});
							});
						...
						lineInfo: function (e) {
							var t;
							if (typeof e == 'number') {
								if (!I(this, e) || ((t = e), (e = ge(this, e)), !e)) return null;
						...
						addLineWidget: at(function (e, t, n) {
							return tu(this, e, t, n);
						}),
						removeLineWidget: function (e) {
							e.clear();
						},
						markText: function (e, t, n) {
							return Vr(this, Me(this, e), Me(this, t), n, (n && n.type) || 'range');
						},
						setBookmark: function (e, t) {
							...
							return ((e = Me(this, e)), Vr(this, e, e, n, 'bookmark'));
						},
						findMarksAt: function (e) {
							e = Me(this, e);
							var t = [],
								n = ge(this, e.line).markedSpans;
							if (n)
								for (var r = 0; r < n.length; ++r) {
									var i = n[r];
						...
						unlinkDoc: function (e) {
							if ((e instanceof Ge && (e = e.doc), this.linked))
								for (var t = 0; t < this.linked.length; ++t) {
									var n = this.linked[t];
									if (n.doc == e) {
										(this.linked.splice(t, 1), e.unlinkDoc(this), iu(_l(this)));
										break;
									}
								}
						...
						splitLines: function (e) {
							return this.lineSep ? e.split(this.lineSep) : zt(e);
						},
...
`
											...
											a = function () {
												++l == i &&
													lt(t, function () {
														...
														(Jr(t.doc, y), Cl(t.doc, pr(Me(t.doc, n), Me(t.doc, gr(y)))));
													})();
											},
											s = function (y, E) {
												if (
													t.options.allowDropFileTypes &&
													de(t.options.allowDropFileTypes, y.type) == -1
												) {
													a();
													return;
												}
					...
					for (
						...
						xr[Fn + 48] = xr[Fn + 96] = String(Fn);
					for (var ui = 65; ui <= 90; ui++) xr[ui] = String.fromCharCode(ui);
					for (var En = 1; En <= 12; En++) xr[En + 111] = xr[En + 63235] = 'F' + En;
					var nr = {};
					((nr.basic = {
						Left: 'goCharLeft',
						Right: 'goCharRight',
						...
						(nr.default = Y ? nr.macDefault : nr.pcDefault));
					function du(e) {
						var t = e.split(/-(?!$)/);
						e = t[t.length - 1];
					...
					function hu(e) {
						...
						for (var n in e)
							if (e.hasOwnProperty(n)) {
								...
								for (var i = Ie(n.split(' '), du), o = 0; o < i.length; o++) {
									var l = void 0,
										a = void 0;
									o == i.length - 1
										? ((a = i.join(' ')), (l = r))
					...
					function Gl(e, t, n) {
						...
						return (
							...
							(Ae ? t.metaKey : t.ctrlKey) && r != 'Ctrl' && (e = 'Ctrl-' + e),
							(Ae ? t.ctrlKey : t.metaKey) && r != 'Mod' && (e = 'Cmd-' + e),
					...
					function en(e, t) {
						for (var n = e.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
							for (var o = t(n[i]); r.length && re(o.from, xe(r).to) <= 0; ) {
								var l = r.pop();
								if (re(l.from, o.from) < 0) {
									o.from = l.from;
									break;
								}
							}
					...
					function pu(e, t, n, r) {
						...
						if (
							...
							return ro(t, n, r);
						var a = function (Q, ie) {
								return to(t, Q instanceof D ? Q.ch : Q, ie);
							},
							s,
							u = function (Q) {
								return e.options.lineWrapping
									? ((s = s || qr(e, t)), Vo(e, t, s, Q))
						...
						if (e.doc.direction == 'rtl' || l.level == 1) {
							...
							if (k != null && (v ? k <= l.to && k <= h.end : k >= l.from && k >= h.begin)) {
								var y = v ? 'before' : 'after';
								return new D(n.line, k, y);
							}
						}
						var E = function (Q, ie, V) {
								for (
									var ue = function (Ke, st) {
										return st ? new D(n.line, a(Ke, 1), 'before') : new D(n.line, Ke, 'after');
									};
									Q >= 0 && Q < i.length;
									Q += ie
								) {
									var be = i[Q],
										me = ie > 0 == (be.level != 1),
										Ne = me ? V.begin : a(V.end, -1);
									if (
										(be.from <= Ne && Ne < be.to) ||
										((Ne = me ? be.from : a(be.to, -1)), V.begin <= Ne && Ne < V.end)
									)
										return ue(Ne, me);
								}
							},
							H = E(o + r, r, h);
						if (H) return H;
						var Z = r > 0 ? h.end : a(h.begin, -1);
						return Z != null &&
							!(r > 0 && Z == t.text.length) &&
							((H = E(r > 0 ? 0 : i.length - 1, r, u(Z))), H)
							? H
							: null;
					}
					var Nn = {
							...
							return en(e, function (t) {
								if (t.empty()) {
									...
									return t.head.ch == n && t.head.line < e.lastLine()
										...
										: { from: t.head, to: D(t.head.line, n) };
								} else return { from: t.from(), to: t.to() };
							});
						},
						deleteLine: function (e) {
							return en(e, function (t) {
								return { from: D(t.from().line, 0), to: Me(e.doc, D(t.to().line + 1, 0)) };
							});
						},
...
`,
					...
					function Zl(e, t) {
						...
						if (!i || i[0].level == 0) {
							...
							return D(n.line, l ? 0 : o, n.sticky);
						}
						return n;
					}
					function ci(e, t, n) {
					...
					function Vl(e) {
						...
						if (
							...
							((t.curOp.focus = x(te(t))), !Ze(t, e))
						) {
							b && W < 11 && e.keyCode == 27 && (e.returnValue = !1);
							var n = e.keyCode;
							...
							(A &&
								...
								n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && yu(t));
						}
					}
					function yu(e) {
						...
						function n(r) {
							(r.keyCode == 18 || !r.altKey) &&
								(Fe(t, 'CodeMirror-crosshair'),
								dt(document, 'keyup', n),
								dt(document, 'mouseover', n));
						}
						(ye(document, 'keyup', n), ye(document, 'mouseover', n));
					}
					function $l(e) {
					...
					function ea(e) {
						...
						if (
							!(e.target && e.target != t.display.input.getField()) &&
							!(tr(t.display, e) || Ze(t, e) || (e.ctrlKey && !e.altKey) || (Y && e.metaKey))
						) {
							var n = e.keyCode,
								r = e.charCode;
							if (A && n == io) {
							...
							if (!(A && (!e.which || e.which < 10) && Ql(t, e))) {
								var i = String.fromCharCode(r ?? n);
								i != '\b' && (xu(t, e, i) || t.display.input.onKeyPress(e));
							}
						}
					}
					var bu = 400,
					...
					oo.prototype.compare = function (e, t, n) {
						return this.time + bu > e && re(t, this.pos) == 0 && n == this.button;
					};
					var Pn, In;
					function ku(e, t) {
						var n = +new Date();
									...
									!(r && wu(t, i, r, o, e)) &&
										(i == 1
											...
											: i == 2
												...
												: i == 3 && (se ? t.display.input.onContextMenu(e) : _i(t))));
							}
						}
					}
					...
					function Su(e, t, n) {
						var r = e.getOption('configureMouse'),
							i = r ? r(e, t, n) : {};
						if (i.unit == null) {
							var o = ce ? n.shiftKey && n.metaKey : n.altKey;
							i.unit = o ? 'rectangle' : t == 'single' ? 'char' : t == 'double' ? 'word' : 'line';
						}
						return (
							(i.extend == null || e.doc.extend) && (i.extend = e.doc.extend || n.shiftKey),
							i.addNew == null && (i.addNew = Y ? n.metaKey : n.ctrlKey),
							i.moveOnDrag == null && (i.moveOnDrag = !(Y ? n.altKey : n.ctrlKey)),
							i
						);
					}
					function Lu(e, t, n, r) {
						b ? setTimeout(pe(rl, e), 0) : (e.curOp.focus = x(te(e)));
						var i = Su(e, n, r),
							o = e.doc.sel,
							l;
						e.options.dragDrop &&
						...
						n == 'single' &&
						(l = o.contains(t)) > -1 &&
						(re((l = o.ranges[l]).from(), t) < 0 || t.xRel > 0) &&
						(re(l.to(), t) > 0 || t.xRel < 0)
							? Tu(e, r, t, i)
							: Cu(e, r, t, i);
					}
					function Tu(e, t, n, r) {
						...
						(j && (i.scroller.draggable = !0),
							(e.state.draggingText = l),
							(l.copy = !r.moveOnDrag),
							ye(i.wrapper.ownerDocument, 'mouseup', l),
							ye(i.wrapper.ownerDocument, 'mousemove', a),
							ye(i.scroller, 'dragstart', s),
							ye(i.scroller, 'drop', l),
							(e.state.delayingBlurEvent = !0),
							setTimeout(function () {
					...
					function ra(e, t, n) {
						if (n == 'char') return new _e(t, t);
						if (n == 'word') return e.findWordAt(t);
						if (n == 'line') return new _e(D(t.line, 0), Me(e.doc, D(t.line + 1, 0)));
						var r = n(e, t);
						return new _e(r.from, r.to);
					}
					function Cu(e, t, n, r) {
						b && _i(e);
						var i = e.display,
						...
						if (
							(r.addNew && !r.extend
								? ((a = o.sel.contains(n)), a > -1 ? (l = u[a]) : (l = new _e(n, n)))
								: ((l = o.sel.primary()), (a = o.sel.primIndex)),
							r.unit == 'rectangle')
						)
							(r.addNew || (l = new _e(n, n)), (n = Lr(e, t, !0, !0)), (a = -1));
						else {
							var h = ra(e, n, r.unit);
							...
							? a == -1
								...
								: u.length > 1 && u[a].empty() && r.unit == 'char' && !r.extend
									? (pt(o, Kt(e, u.slice(0, a).concat(u.slice(a + 1)), 0), {
										...
										(s = o.sel))
									: eo(o, a, l, ct)
							: ((a = 0), pt(o, new Et([l], 0), ct), (s = o.sel));
						var v = n;
						function k(V) {
							if (re(v, V) != 0)
								if (((v = V), r.unit == 'rectangle')) {
									for (
										var ue = [],
											be = e.options.tabSize,
											me = Ce(ge(o, n.line).text, n.ch, be),
											Ne = Ce(ge(o, V.line).text, V.ch, be),
											Ke = Math.min(me, Ne),
											st = Math.max(me, Ne),
											Xe = Math.min(n.line, V.line),
											Mt = Math.min(e.lastLine(), Math.max(n.line, V.line));
										Xe <= Mt;
										Xe++
									) {
										var wt = ge(o, Xe).text,
											tt = Re(wt, Ke, be);
										Ke == st
											? ue.push(new _e(D(Xe, tt), D(Xe, tt)))
											: wt.length > tt && ue.push(new _e(D(Xe, tt), D(Xe, Re(wt, st, be))));
									}
									(ue.length || ue.push(new _e(n, n)),
										pt(o, Kt(e, s.ranges.slice(0, a).concat(ue), a), {
											origin: '*mouse',
											scroll: !1
										}),
										e.scrollIntoView(V));
									...
									var St = l,
										...
										rt;
									re(ft.anchor, nt) > 0
										? ((rt = ft.head), (nt = Hr(St.from(), ft.anchor)))
										: ((rt = ft.anchor), (nt = yt(St.to(), ft.head)));
									var Qe = s.ranges.slice(0);
									((Qe[a] = Du(e, new _e(Me(o, nt), rt))), pt(o, Kt(e, Qe, a), ct));
								}
						}
						...
						function H(V) {
							var ue = ++E,
								be = Lr(e, V, !0, r.unit == 'rectangle');
							if (be)
								if (re(be, v) != 0) {
									((e.curOp.focus = x(te(e))), k(be));
									var me = $n(i, o);
									(be.line >= me.to || be.line < me.from) &&
										setTimeout(
											lt(e, function () {
												E == ue && H(V);
											}),
									...
									var Ne = V.clientY < y.top ? -20 : V.clientY > y.bottom ? 20 : 0;
									Ne &&
										setTimeout(
											lt(e, function () {
												E == ue && ((i.scroller.scrollTop += Ne), H(V));
											}),
											50
										);
								}
						...
						function Z(V) {
							((e.state.selectingText = !1),
								(E = 1 / 0),
								V && (ht(V), i.input.focus()),
								dt(i.wrapper.ownerDocument, 'mousemove', Q),
								dt(i.wrapper.ownerDocument, 'mouseup', ie),
								(o.history.lastSelOrigin = null));
						}
						var Q = lt(e, function (V) {
								V.buttons === 0 || !Wt(V) ? Z(V) : H(V);
							}),
							ie = lt(e, Z);
						((e.state.selectingText = ie),
							ye(i.wrapper.ownerDocument, 'mousemove', Q),
							ye(i.wrapper.ownerDocument, 'mouseup', ie));
					}
					function Du(e, t) {
						var n = t.anchor,
							r = t.head,
							i = ge(e.doc, n.line);
						if (re(n, r) == 0 && n.sticky == r.sticky) return t;
						var o = We(i);
						if (!o) return t;
						...
						var k = o[s + (u ? -1 : 0)],
							...
							E = y ? k.from : k.to,
							H = y ? 'after' : 'before';
						return n.ch == E && n.sticky == H ? t : new _e(new D(n.line, E, H), r);
					}
					function na(e, t, n, r) {
						var i, o;
						...
						if (o > a.bottom || !Ct(e, n)) return xt(t);
						...
						for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
							...
							if (u && u.getBoundingClientRect().right >= i) {
								...
								return (Ye(e, n, e, h, v.className, t), xt(t));
							}
						}
					}
					function lo(e, t) {
								...
								if (((r.doc.lineSep = i), !!i)) {
									...
									r.doc.iter(function (s) {
										for (var u = 0; ; ) {
											...
											if (h == -1) break;
											((u = h + i.length), o.push(D(l, h)));
										}
										l++;
									});
									for (var a = o.length - 1; a >= 0; a--)
										Qr(r.doc, i, o[a], D(o[a].line, o[a].ch + i.length));
								}
							}),
							n(
								'specialChars',
					...
					function Eu(e) {
						(e.options.lineWrapping
							...
							: (Fe(e.display.wrapper, 'CodeMirror-wrap'), Ci(e)),
							Bi(e),
							bt(e),
							gn(e),
							setTimeout(function () {
					...
					function Nu(e) {
						var t = e.display;
						(ye(t.scroller, 'mousedown', lt(e, ta)),
							b && W < 11
								? ye(
										t.scroller,
										'dblclick',
								...
								: ye(t.scroller, 'dblclick', function (s) {
										return Ze(e, s) || ht(s);
									}),
							ye(t.scroller, 'contextmenu', function (s) {
								return ia(e, s);
							}),
							ye(t.input.getField(), 'contextmenu', function (s) {
						...
						(ye(t.scroller, 'touchstart', function (s) {
							...
							ye(t.scroller, 'touchmove', function () {
								t.activeTouch && (t.activeTouch.moved = !0);
							}),
							ye(t.scroller, 'touchend', function (s) {
								var u = t.activeTouch;
								if (u && !tr(t, s) && u.left != null && !u.moved && new Date() - u.start < 300) {
									...
									(!u.prev || l(u, u.prev)
										...
										: !u.prev.prev || l(u, u.prev.prev)
											? (v = e.findWordAt(h))
											: (v = new _e(D(h.line, 0), Me(e.doc, D(h.line + 1, 0)))),
							...
							ye(t.scroller, 'touchcancel', i),
							ye(t.scroller, 'scroll', function () {
								t.scroller.clientHeight &&
									(xn(e, t.scroller.scrollTop),
									Cr(e, t.scroller.scrollLeft, !0),
									Ye(e, 'scroll', e));
							}),
							ye(t.scroller, 'mousewheel', function (s) {
								return pl(e, s);
							}),
							ye(t.scroller, 'DOMMouseScroll', function (s) {
								return pl(e, s);
							}),
							ye(t.wrapper, 'scroll', function () {
						...
						(ye(a, 'keyup', function (s) {
							return $l.call(e, s);
						}),
							ye(a, 'keydown', lt(e, Vl)),
							ye(a, 'keypress', lt(e, ea)),
							ye(a, 'focus', function (s) {
								return Ri(e, s);
							}),
							ye(a, 'blur', function (s) {
								return Ur(e, s);
							}));
					}
					var ao = [];
					...
					function zn(e, t, n, r) {
						...
						if (e.options.indentWithTabs)
							for (var y = Math.floor(h / l); y; --y) ((k += l), (v += '	'));
						if ((k < h && (v += et(h - k)), v != u))
							return (Qr(i, v, D(t, 0), D(t, u.length), '+input'), (a.stateAfter = null), !0);
						for (var E = 0; E < i.sel.ranges.length; E++) {
							var H = i.sel.ranges[E];
						...
						for (var v = e.curOp.updateInput, k = r.ranges.length - 1; k >= 0; k--) {
							...
							y.empty() &&
								(n && n > 0
									? (E = D(E.line, E.ch - n))
									: e.state.overwrite && !a
										? (H = D(H.line, Math.min(ge(o, H.line).text.length, H.ch + xe(s).length)))
										: a &&
											Ut &&
											Ut.lineWise &&
											Ut.text.join(`
...
`) &&
							...
							for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
								...
								if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
									...
									if (o.electricChars) {
										...
										o.electricInput &&
											o.electricInput.test(ge(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
											(l = zn(e, i.head.line, 'smart'));
					...
					function fa() {
						...
						return (
							j ? (e.style.width = '1000px') : e.setAttribute('wrap', 'off'),
							N && (e.style.border = '1px solid black'),
							t
						);
					}
					function Ou(e) {
						...
						((e.prototype = {
								...
								for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
									...
									if (a.empty())
										...
										s.ch == 0 &&
											i.length == k.length &&
											k[l].from().ch > 0 &&
											eo(this.doc, l, new _e(s, k[l].to()), Ve);
									}
								}
							}),
							...
							getLineTokens: function (r, i) {
								return bo(this, D(r), i, !0);
							},
							getTokenTypeAt: function (r) {
								r = Me(this.doc, r);
								var i = mo(this, ge(this.doc, r.line)),
									o = 0,
									l = (i.length - 1) / 2,
									a = r.ch,
									s;
							...
							getHelpers: function (r, i) {
								...
								for (var h = 0; h < l._global.length; h++) {
									var v = l._global[h];
									v.pred(a, this) && de(o, v.val) == -1 && o.push(v.val);
								}
								return o;
							},
							...
							charCoords: function (r, i) {
								return Zn(this, Me(this.doc, r), i || 'page');
							},
							...
							findPosV: function (r, i, o, l) {
								var a = 1,
									s = l;
								i < 0 && ((a = -1), (i = -i));
								for (var u = Me(this.doc, r), h = 0; h < i; ++h) {
									var v = jt(this, u, 'div');
							...
							findWordAt: function (r) {
								...
								return new _e(D(r.line, l), D(r.line, a));
							},
							...
							hasFocus: function () {
								return this.display.input.getField() == x(te(this));
							},
							isReadOnly: function () {
							...
							scrollIntoView: vt(function (r, i) {
								(r == null
									...
									: typeof r == 'number'
										? (r = { from: D(r, 0), to: null })
										: r.from == null && (r = { from: r, to: null }),
									r.to || (r.to = r.from),
									(r.margin = i || 0),
									r.from.line != null ? Es(this, r) : il(this, r.from, r.to, r.margin));
							}),
					...
					function fo(e, t, n, r, i) {
						...
						function u() {
							var ie = t.line + s;
							return ie < e.first || ie >= e.first + e.size
								? !1
								: ((t = new D(ie, t.ch, t.sticky)), (a = ge(e, ie)));
						}
						function h(ie) {
							var V;
							if (r == 'codepoint') {
								var ue = a.text.charCodeAt(t.ch + (n > 0 ? 0 : -1));
								if (isNaN(ue)) V = null;
								else {
									var be = n > 0 ? ue >= 55296 && ue < 56320 : ue >= 56320 && ue < 57343;
									V = new D(
										t.line,
										Math.max(0, Math.min(a.text.length, t.ch + n * (be ? 2 : 1))),
										-n
									);
								}
							} else i ? (V = pu(e.cm, a, t, n)) : (V = ro(a, t, n));
							if (V == null)
								if (!ie && u()) t = no(i, e.cm, a, t.line, s);
								else return !1;
							else t = V;
							return !0;
						}
						if (r == 'char' || r == 'codepoint') h();
							...
							for (
								var v = null, k = r == 'group', y = e.cm && e.cm.getHelper(t, 'wordChars'), E = !0;
								!(n < 0 && !h(!E));
								E = !1
							) {
								var H =
...
`
								...
								if ((Z && (v = Z), n > 0 && !h(!E))) break;
							}
						var Q = ai(e, t, o, l, !0);
						return (He(o, Q) && (Q.hitSide = !0), Q);
					}
					function ca(e, t, n, r) {
						var i = e.doc,
							o = t.left,
...
`)));
						...
						(je.prototype.prepareSelection = function () {
							var e = tl(this.cm, !1);
							return ((e.focus = x(ke(this.div)) == this.div), e);
						}),
						...
						(je.prototype.showPrimarySelection = function () {
							...
							if (!(o && !o.bad && l && !l.bad && re(Hr(o, l), r) == 0 && re(yt(o, l), i) == 0)) {
								...
								var k = e.rangeCount && e.getRangeAt(0),
									y;
								try {
									y = L(s.node, s.offset, u.offset, u.node);
								} catch {}
								(y &&
									(!P && t.state.focused
									...
									k && e.anchorNode == null ? e.addRange(k) : P && this.startGracePeriod()),
						...
						(je.prototype.showMultipleSelections = function (e) {
							(G(this.cm.display.cursorDiv, e.cursors),
								G(this.cm.display.selectionDiv, e.selection));
						}),
						...
						(je.prototype.focus = function () {
							this.cm.options.readOnly != 'nocursor' &&
								((!this.selectionInEditor() || x(ke(this.div)) != this.div) &&
						...
						(je.prototype.pollSelection = function () {
							if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
								var e = this.getSelection(),
									t = this.cm;
								if (R && w && this.cm.display.gutterSpecs.length && Pu(e.anchorNode)) {
						...
						(je.prototype.pollContent = function () {
							...
							if (
								(r.ch == 0 &&
									r.line > e.firstLine() &&
									(r = D(r.line - 1, ge(e.doc, r.line - 1).length)),
								i.ch == ge(e.doc, i.line).text.length &&
									i.line < e.lastLine() &&
									(i = D(i.line + 1, 0)),
								...
								return !1;
							var o, l, a;
							r.line == t.viewFrom || (o = Tr(e, r.line)) == 0
							...
							if (
								...
								return !1;
							for (
								var v = e.doc.splitLines(Iu(e, a, h, l, u)),
									k = Vt(e.doc, D(l, 0), D(u, ge(e.doc, u).text.length));
								v.length > 1 && k.length > 1;
							)
								if (xe(v) == xe(k)) (v.pop(), k.pop(), u--);
								else if (v[0] == k[0]) (v.shift(), k.shift(), l++);
								else break;
							for (
								var y = 0, E = 0, H = v[0], Z = k[0], Q = Math.min(H.length, Z.length);
								y < Q && H.charCodeAt(y) == Z.charCodeAt(y);
							)
								++y;
							for (
								var ie = xe(v),
									V = xe(k),
									ue = Math.min(
										ie.length - (v.length == 1 ? y : 0),
										V.length - (k.length == 1 ? y : 0)
									);
								E < ue && ie.charCodeAt(ie.length - E - 1) == V.charCodeAt(V.length - E - 1);
							)
								++E;
							if (v.length == 1 && k.length == 1 && l == r.line)
								for (
									...
									y &&
									y > r.ch &&
									ie.charCodeAt(ie.length - E - 1) == V.charCodeAt(V.length - E - 1);
								)
									(y--, E++);
							((v[v.length - 1] = ie.slice(0, ie.length - E).replace(/^\u200b+/, '')),
								(v[0] = v[0].slice(y).replace(/\u200b+$/, '')));
							var be = D(l, y),
								me = D(u, k.length ? xe(k).length - E : 0);
							if (v.length > 1 || v[0] || re(be, me)) return (Qr(e.doc, v, be, me, '+input'), !0);
						}),
					...
					function Iu(e, t, n, r, i) {
						...
						function k(y) {
							if (y.nodeType == 1) {
								var E = y.getAttribute('cm-text');
								if (E) {
									v(E);
									return;
								}
								var H = y.getAttribute('cm-marker'),
									Z;
								if (H) {
									var Q = e.findMarks(D(r, 0), D(i + 1, 0), u(+H));
									Q.length && (Z = Q[0].find(0)) && v(Vt(e.doc, Z.from, Z.to).join(a));
									return;
								}
								if (y.getAttribute('contenteditable') == 'false') return;
								var ie = /^(pre|div|p|li|table|br)$/i.test(y.nodeName);
								if (!/^br$/i.test(y.nodeName) && y.textContent.length == 0) return;
								ie && h();
								for (var V = 0; V < y.childNodes.length; V++) k(y.childNodes[V]);
								(/^(pre|p)$/i.test(y.nodeName) && (s = !0), ie && (l = !0));
							} else
								y.nodeType == 3 && v(y.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
						}
					...
					function pi(e, t, n) {
						...
						if (t == e.display.lineDiv) {
							if (((r = e.display.lineDiv.childNodes[n]), !r))
								return rn(e.clipPos(D(e.display.viewTo - 1)), !0);
							((t = null), (n = 0));
						} else
					...
					function zu(e, t, n) {
						var r = e.text.firstChild,
							i = !1;
						if (!t || !m(r, t)) return rn(D(f(e.line), 0), !0);
						if (t == r && ((i = !0), (t = r.childNodes[n]), (n = 0), !t)) {
							var o = e.rest ? xe(e.rest) : e.line;
							return rn(D(f(o), o.text.length), i);
						}
						...
						var s = e.measure,
							u = s.maps;
						function h(Z, Q, ie) {
							for (var V = -1; V < (u ? u.length : 0); V++)
								for (var ue = V < 0 ? s.map : u[V], be = 0; be < ue.length; be += 3) {
									var me = ue[be + 2];
									if (me == Z || me == Q) {
										var Ne = f(V < 0 ? e.line : e.rest[V]),
											Ke = ue[be] + ie;
										return ((ie < 0 || me != Z) && (Ke = ue[be + (ie ? 1 : 0)]), D(Ne, Ke));
									}
								}
						}
						var v = h(l, a, n);
						if (v) return rn(v, i);
						for (var k = a.nextSibling, y = l ? l.nodeValue.length - n : 0; k; k = k.nextSibling) {
							if (((v = h(k, k.firstChild, 0)), v)) return rn(D(v.line, v.ch - y), i);
							y += k.textContent.length;
						}
						for (var E = a.previousSibling, H = n; E; E = E.previousSibling) {
							if (((v = h(E, E.firstChild, -1)), v)) return rn(D(v.line, v.ch + H), i);
					...
					(($e.prototype.init = function (e) {
						...
						(e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
							N && (i.style.width = '0px'),
							ye(i, 'input', function () {
								(b && W >= 9 && t.hasSelection && (t.hasSelection = null), n.poll());
							}),
							ye(i, 'paste', function (l) {
...
`)),
						...
						(ye(i, 'cut', o),
							ye(i, 'copy', o),
							ye(e.scroller, 'paste', function (l) {
								if (!(tr(e, l) || Ze(r, l))) {
									if (!i.dispatchEvent) {
							...
							ye(e.lineSpace, 'selectstart', function (l) {
								tr(e, l) || ht(l);
							}),
							ye(i, 'compositionstart', function () {
						...
						($e.prototype.showSelection = function (e) {
							var t = this.cm,
								n = t.display;
							(G(n.cursorDiv, e.cursors),
								G(n.selectionDiv, e.selection),
								e.teTop != null &&
							...
							if (!(this.contextMenuPending || (this.composing && e))) {
								...
								if (((this.resetting = !0), t.somethingSelected())) {
									...
									((this.textarea.value = n),
										...
										b && W >= 9 && (this.hasSelection = n));
								} else
									e ||
										((this.prevInput = this.textarea.value = ''),
										b && W >= 9 && (this.hasSelection = null));
								this.resetting = !1;
							}
						}),
						...
						($e.prototype.focus = function () {
							if (
								this.cm.options.readOnly != 'nocursor' &&
								(!_ || x(ke(this.textarea)) != this.textarea)
							)
								try {
									this.textarea.focus();
								} catch {}
						...
						($e.prototype.poll = function () {
							...
							if ((b && W >= 9 && this.hasSelection === i) || (Y && /[\uf700-\uf7ff]/.test(i)))
...
`) > -1
						...
						($e.prototype.onKeyPress = function () {
							(b && W >= 9 && (this.hasSelection = null), this.fastPoll());
						}),
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
							var v;
							(j && (v = i.ownerDocument.defaultView.scrollY),
								r.input.focus(),
								j && i.ownerDocument.defaultView.scrollTo(null, v),
								r.input.reset(),
							...
							function y() {
								if (
									...
									(i.style.cssText = s),
									b && W < 9 && r.scrollbars.setScrollTop((r.scroller.scrollTop = l)),
							...
							if ((b && W >= 9 && k(), se)) {
								ar(e);
								var E = function () {
									(dt(window, 'mouseup', E), setTimeout(y, 20));
								};
								ye(window, 'mouseup', E);
					...
					function Bu(e, t) {
						...
						var i;
						if (e.form && (ye(e.form, 'submit', r), !t.leaveSubmitMethodAlone)) {
							var o = e.form;
							i = o.submit;
							try {
					...
					function Wu(e) {
						((e.off = dt),
							...
							(e.isModifierKey = Ul),
							(e.lookupKey = $r),
							(e.normalizeKeyMap = hu),
							(e.StringStream = Je),
							(e.SharedTextMarker = An),
							(e.TextMarker = mr),
							(e.LineWidget = Mn),
					...
					(Au(Ge), Ou(Ge));
					var Hu = 'iter insert remove copy getEditor constructor'.split(' ');
		...
		ga ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					C.defineMode('css', function (se, q) {
						var Fe = q.inline;
						q.propertyKeywords || (q = C.resolveMode('text/css'));
						var M = se.indentUnit,
							G = q.tokenHooks,
							d = q.documentTypes || {},
							S = q.mediaTypes || {},
							L = q.mediaFeatures || {},
							m = q.mediaValueKeywords || {},
							x = q.propertyKeywords || {},
							z = q.nonStandardPropertyKeywords || {},
							ne = q.fontProperties || {},
							p = q.counterDescriptors || {},
							c = q.colorKeywords || {},
							te = q.valueKeywords || {},
							ke = q.allowNested,
							J = q.lineComment,
							pe = q.supportsAtComponent === !0,
							Te = se.highlightNonStandardPropertyKeywords !== !1,
							Ce,
							we;
						function de(T, U) {
							return ((Ce = U), T);
						...
						function Oe(T, U) {
							...
							if (O == '@') return (T.eatWhile(/[\w\\\-]/), de('def', T.current()));
							if (O == '=' || ((O == '~' || O == '|') && T.eat('='))) return de(null, 'compare');
							if (O == '"' || O == "'") return ((U.tokenize = qe(O)), U.tokenize(T, U));
							if (O == '#') return (T.eatWhile(/[\w\\\-]/), de('atom', 'hash'));
							if (O == '!') return (T.match(/^\s*\w*/), de('keyword', 'important'));
							if (/\d/.test(O) || (O == '.' && T.eat(/\d/)))
								return (T.eatWhile(/[\w.%]/), de('number', 'unit'));
							if (O === '-') {
								if (/[\d.]/.test(T.peek())) return (T.eatWhile(/[\w.%]/), de('number', 'unit'));
								if (T.match(/^-[\w\\\-]*/))
									return (
										T.eatWhile(/[\w\\\-]/),
										T.match(/^\s*:/, !1)
											? de('variable-2', 'variable-definition')
											: de('variable-2', 'variable')
									);
								if (T.match(/^\w+-/)) return de('meta', 'meta');
							} else
								return /[,+>*\/]/.test(O)
									? de(null, 'select-op')
									: O == '.' && T.match(/^-?[_a-z][_a-z0-9-]*/i)
										? de('qualifier', 'qualifier')
										: /[:;{}\[\]\(\)]/.test(O)
											? de(null, O)
											: T.match(/^[\w-.]+(?=\()/)
												? (/^(url(-prefix)?|domain|regexp)$/i.test(T.current()) &&
														(U.tokenize = Ve),
													de('variable callee', 'variable'))
												: /[\w\\\-]/.test(O)
													? (T.eatWhile(/[\w\\\-]/), de('property', 'word'))
													: de(null, null);
						}
						function qe(T) {
							return function (U, O) {
								for (var ze = !1, he; (he = U.next()) != null; ) {
									if (he == T && !ze) {
										T == ')' && U.backUp(1);
										break;
									}
						...
						function Ve(T, U) {
							return (
								T.next(),
								T.match(/^\s*[\"\')]/, !1) ? (U.tokenize = null) : (U.tokenize = qe(')')),
								de(null, '(')
							);
						}
						function ct(T, U, O) {
							((this.type = T), (this.indent = U), (this.prev = O));
						}
						function Pe(T, U, O, ze) {
							return ((T.context = new ct(O, U.indentation() + (ze === !1 ? 0 : M), T.context)), O);
						}
						function Re(T) {
							return (T.context.prev && (T.context = T.context.prev), T.context.type);
						}
						function Ue(T, U, O) {
							return Ie[O.context.type](T, U, O);
						}
						function et(T, U, O, ze) {
							for (var he = ze || 1; he > 0; he--) O.context = O.context.prev;
							return Ue(T, U, O);
						}
						function xe(T) {
						...
						var Ie = {};
						return (
							(Ie.top = function (T, U, O) {
								if (T == '{') return Pe(O, U, 'block');
								if (T == '}' && O.context.prev) return Re(O);
								if (pe && /@component/i.test(T)) return Pe(O, U, 'atComponentBlock');
								if (/^@(-moz-)?document$/i.test(T)) return Pe(O, U, 'documentTypes');
								if (/^@(media|supports|(-moz-)?document|import)$/i.test(T))
									return Pe(O, U, 'atBlock');
								if (/^@(font-face|counter-style)/i.test(T))
									return ((O.stateArg = T), 'restricted_atBlock_before');
								if (/^@(-(moz|ms|o|webkit)-)?keyframes$/i.test(T)) return 'keyframes';
								if (T && T.charAt(0) == '@') return Pe(O, U, 'at');
								if (T == 'hash') we = 'builtin';
								else if (T == 'word') we = 'tag';
								else {
									if (T == 'variable-definition') return 'maybeprop';
									if (T == 'interpolation') return Pe(O, U, 'interpolation');
									if (T == ':') return 'pseudo';
									if (ke && T == '(') return Pe(O, U, 'parens');
								}
								return O.context.type;
							}),
							(Ie.block = function (T, U, O) {
								if (T == 'word') {
									var ze = U.current().toLowerCase();
									return x.hasOwnProperty(ze)
										? ((we = 'property'), 'maybeprop')
										: z.hasOwnProperty(ze)
											? ((we = Te ? 'string-2' : 'property'), 'maybeprop')
											: ke
												? ((we = U.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'), 'block')
												: ((we += ' error'), 'maybeprop');
								} else
									return T == 'meta'
										? 'block'
										: !ke && (T == 'hash' || T == 'qualifier')
											? ((we = 'error'), 'block')
											: Ie.top(T, U, O);
							}),
							(Ie.maybeprop = function (T, U, O) {
								return T == ':' ? Pe(O, U, 'prop') : Ue(T, U, O);
							}),
							(Ie.prop = function (T, U, O) {
								if (T == ';') return Re(O);
								if (T == '{' && ke) return Pe(O, U, 'propBlock');
								if (T == '}' || T == '{') return et(T, U, O);
								if (T == '(') return Pe(O, U, 'parens');
								if (
									T == 'hash' &&
									!/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(U.current())
								)
									we += ' error';
								else if (T == 'word') xe(U);
								else if (T == 'interpolation') return Pe(O, U, 'interpolation');
								return 'prop';
							}),
							(Ie.propBlock = function (T, U, O) {
								return T == '}'
									? Re(O)
									: T == 'word'
										? ((we = 'property'), 'maybeprop')
								...
								return T == '{' || T == '}'
									...
									: T == ')'
										...
										: T == '('
											? Pe(O, U, 'parens')
											: T == 'interpolation'
												? Pe(O, U, 'interpolation')
												: (T == 'word' && xe(U), 'parens');
							}),
							(Ie.pseudo = function (T, U, O) {
								return T == 'meta'
									? 'pseudo'
									: T == 'word'
										? ((we = 'variable-3'), O.context.type)
										: Ue(T, U, O);
							}),
							(Ie.documentTypes = function (T, U, O) {
								return T == 'word' && d.hasOwnProperty(U.current())
									? ((we = 'tag'), O.context.type)
									: Ie.atBlock(T, U, O);
							}),
							(Ie.atBlock = function (T, U, O) {
								if (T == '(') return Pe(O, U, 'atBlock_parens');
								if (T == '}' || T == ';') return et(T, U, O);
								if (T == '{') return Re(O) && Pe(O, U, ke ? 'block' : 'top');
								if (T == 'interpolation') return Pe(O, U, 'interpolation');
								if (T == 'word') {
									var ze = U.current().toLowerCase();
									ze == 'only' || ze == 'not' || ze == 'and' || ze == 'or'
										? (we = 'keyword')
										: S.hasOwnProperty(ze)
											? (we = 'attribute')
											: L.hasOwnProperty(ze)
												...
												: m.hasOwnProperty(ze)
													...
													: x.hasOwnProperty(ze)
														? (we = 'property')
														: z.hasOwnProperty(ze)
															? (we = Te ? 'string-2' : 'property')
															: te.hasOwnProperty(ze)
																? (we = 'atom')
																: c.hasOwnProperty(ze)
																	? (we = 'keyword')
																	: (we = 'error');
							...
							(Ie.atComponentBlock = function (T, U, O) {
								return T == '}'
									? et(T, U, O)
									: T == '{'
										? Re(O) && Pe(O, U, ke ? 'block' : 'top', !1)
										: (T == 'word' && (we = 'error'), O.context.type);
							}),
							(Ie.atBlock_parens = function (T, U, O) {
								return T == ')'
									? Re(O)
									: T == '{' || T == '}'
										? et(T, U, O, 2)
							...
							(Ie.restricted_atBlock_before = function (T, U, O) {
								return T == '{'
									? Pe(O, U, 'restricted_atBlock')
									: T == 'word' && O.stateArg == '@counter-style'
										? ((we = 'variable'), 'restricted_atBlock_before')
										: Ue(T, U, O);
							}),
							(Ie.restricted_atBlock = function (T, U, O) {
								return T == '}'
									? ((O.stateArg = null), Re(O))
									: T == 'word'
										? ((O.stateArg == '@font-face' &&
												!ne.hasOwnProperty(U.current().toLowerCase())) ||
											(O.stateArg == '@counter-style' &&
												!p.hasOwnProperty(U.current().toLowerCase()))
												? (we = 'error')
												: (we = 'property'),
											'maybeprop')
										: 'restricted_atBlock';
							}),
							(Ie.keyframes = function (T, U, O) {
								return T == 'word'
									? ((we = 'variable'), 'keyframes')
									: T == '{'
										? Pe(O, U, 'top')
										: Ue(T, U, O);
							}),
							(Ie.at = function (T, U, O) {
								return T == ';'
									? Re(O)
									: T == '{' || T == '}'
										? et(T, U, O)
										: (T == 'word' ? (we = 'tag') : T == 'hash' && (we = 'builtin'), 'at');
							}),
							(Ie.interpolation = function (T, U, O) {
								return T == '}'
									? Re(O)
									: T == '{' || T == ';'
										? et(T, U, O)
							...
							}),
							{
								startState: function (T) {
									return {
										...
										state: Fe ? 'block' : 'top',
										stateArg: null,
										context: new ct(Fe ? 'block' : 'top', T || 0, null)
									};
								},
								token: function (T, U) {
									if (!U.tokenize && T.eatSpace()) return null;
									var O = (U.tokenize || Oe)(T, U);
									return (
										O && typeof O == 'object' && ((Ce = O[1]), (O = O[0])),
										(we = O),
										Ce != 'comment' && (U.state = Ie[U.state](Ce, T, U)),
										we
									);
								},
								indent: function (T, U) {
									var O = T.context,
										...
										he = O.indent;
									return (
										O.type == 'prop' && (ze == '}' || ze == ')') && (O = O.prev),
										O.prev &&
											(ze == '}' &&
											(O.type == 'block' ||
												O.type == 'top' ||
												O.type == 'interpolation' ||
												O.type == 'restricted_atBlock')
												? ((O = O.prev), (he = O.indent))
												: ((ze == ')' && (O.type == 'parens' || O.type == 'atBlock_parens')) ||
														(ze == '{' && (O.type == 'at' || O.type == 'atBlock'))) &&
													(he = Math.max(0, O.indent - M))),
										he
									);
								},
								electricChars: '}',
					...
					function De(se) {
						for (var q = {}, Fe = 0; Fe < se.length; ++Fe) q[se[Fe].toLowerCase()] = !0;
						return q;
					}
					var P = ['domain', 'regexp', 'url', 'url-prefix'],
						...
						$ = De(ce),
						ee = P.concat(Se).concat(b).concat(j).concat(w).concat(A).concat(_).concat(ce);
					C.registerHelper('hintWords', 'css', ee);
					function Ae(se, q) {
						for (var Fe = !1, M; (M = se.next()) != null; ) {
							if (Fe && M == '/') {
								q.tokenize = null;
								break;
							}
					...
					(C.defineMIME('text/css', {
						...
						tokenHooks: {
							'/': function (se, q) {
								return se.eat('*') ? ((q.tokenize = Ae), Ae(se, q)) : !1;
							}
						},
						name: 'css'
					}),
						C.defineMIME('text/x-scss', {
							...
							tokenHooks: {
								'/': function (se, q) {
									return se.eat('/')
										? (se.skipToEnd(), ['comment', 'comment'])
										: se.eat('*')
											? ((q.tokenize = Ae), Ae(se, q))
											: ['operator', 'operator'];
								},
								':': function (se) {
									return se.match(/^\s*\{/, !1) ? [null, null] : !1;
								},
								$: function (se) {
									return (
										se.match(/^[\w-]+/),
								...
								'#': function (se) {
									return se.eat('{') ? [null, 'interpolation'] : !1;
								}
							},
							name: 'css',
							helperType: 'scss'
		...
		xa ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					(C.defineMode('xml', function (fe, Se) {
						var le = fe.indentUnit,
							b = {},
							W = Se.htmlMode ? De : P;
						for (var j in W) b[j] = W[j];
						for (var j in Se) b[j] = Se[j];
						var oe, w;
						function B(d, S) {
							function L(z) {
								return ((S.tokenize = z), z(d, S));
							}
							var m = d.next();
							if (m == '<')
								return d.eat('!')
									? d.eat('[')
										...
										: d.match('--')
											? L(ae('comment', '-->'))
											: d.match('DOCTYPE', !0, !0)
												? (d.eatWhile(/[\w\._\-]/), L(F(1)))
												: null
									: d.eat('?')
										? (d.eatWhile(/[\w\._\-]/), (S.tokenize = ae('meta', '?>')), 'meta')
										: ((oe = d.eat('/') ? 'closeTag' : 'openTag'), (S.tokenize = A), 'tag bracket');
							if (m == '&') {
								var x;
								return (
									d.eat('#')
										? d.eat('x')
											? (x = d.eatWhile(/[a-fA-F\d]/) && d.eat(';'))
											: (x = d.eatWhile(/[\d]/) && d.eat(';'))
										: (x = d.eatWhile(/[\w\.\-:]/) && d.eat(';')),
									x ? 'atom' : 'error'
								);
						...
						function A(d, S) {
							...
							if (L == '>' || (L == '/' && d.eat('>')))
								return (
									(S.tokenize = B),
									(oe = L == '>' ? 'endTag' : 'selfcloseTag'),
									'tag bracket'
								);
							if (L == '=') return ((oe = 'equals'), null);
							if (L == '<') {
								((S.tokenize = B), (S.state = ce), (S.tagName = S.tagStart = null));
								var m = S.tokenize(d, S);
								return m ? m + ' tag error' : 'tag error';
							} else
								return /[\'\"]/.test(L)
									? ((S.tokenize = K(L)), (S.stringStartCol = d.column()), S.tokenize(d, S))
									: (d.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), 'word');
						}
						function K(d) {
							var S = function (L, m) {
						...
						function F(d) {
							return function (S, L) {
								for (var m; (m = S.next()) != null; ) {
									if (m == '<') return ((L.tokenize = F(d + 1)), L.tokenize(S, L));
									if (m == '>')
										if (d == 1) {
											L.tokenize = B;
											break;
										} else return ((L.tokenize = F(d - 1)), L.tokenize(S, L));
								}
								return 'meta';
							};
						}
						...
						function Y(d, S) {
							for (var L; ; ) {
								if (
									!d.context ||
									((L = d.context.tagName),
									!b.contextGrabbers.hasOwnProperty(N(L)) ||
										!b.contextGrabbers[N(L)].hasOwnProperty(N(S)))
								)
									return;
								_(d);
							}
						...
						function ce(d, S, L) {
							return d == 'openTag' ? ((L.tagStart = S.column()), $) : d == 'closeTag' ? ee : ce;
						}
						function $(d, S, L) {
							return d == 'word'
								? ((L.tagName = S.current()), (w = 'tag'), q)
								: b.allowMissingTagName && d == 'endTag'
									? ((w = 'tag bracket'), q(d, S, L))
									: ((w = 'error'), $);
						}
						function ee(d, S, L) {
							if (d == 'word') {
								...
								return (
									L.context &&
										L.context.tagName != m &&
										b.implicitlyClosed.hasOwnProperty(N(L.context.tagName)) &&
										_(L),
									(L.context && L.context.tagName == m) || b.matchClosing === !1
										? ((w = 'tag'), Ae)
										: ((w = 'tag error'), se)
								);
							} else
								return b.allowMissingTagName && d == 'endTag'
									? ((w = 'tag bracket'), Ae(d, S, L))
									: ((w = 'error'), se);
						}
						function Ae(d, S, L) {
							return d != 'endTag' ? ((w = 'error'), Ae) : (_(L), ce);
						}
						function se(d, S, L) {
							return ((w = 'error'), Ae(d, S, L));
						}
						function q(d, S, L) {
							if (d == 'word') return ((w = 'attribute'), Fe);
							if (d == 'endTag' || d == 'selfcloseTag') {
								var m = L.tagName,
									x = L.tagStart;
								return (
									(L.tagName = L.tagStart = null),
									d == 'selfcloseTag' || b.autoSelfClosers.hasOwnProperty(N(m))
										? Y(L, m)
										: (Y(L, m), (L.context = new R(L, m, x == L.indented))),
									ce
								);
							}
							return ((w = 'error'), q);
						...
						function Fe(d, S, L) {
							return d == 'equals' ? M : (b.allowMissing || (w = 'error'), q(d, S, L));
						}
						function M(d, S, L) {
							return d == 'string'
								? G
						...
						return {
							...
							token: function (d, S) {
								if ((!S.tagName && d.sol() && (S.indented = d.indentation()), d.eatSpace()))
									return null;
								oe = null;
								var L = S.tokenize(d, S);
								return (
									(L || oe) &&
										L != 'comment' &&
										((w = null),
										(S.state = S.state(oe || L, d, S)),
										w && (L = w == 'error' ? L + ' error' : w)),
									L
								);
							},
							indent: function (d, S, L) {
								var m = d.context;
								if (d.tokenize.isInAttribute)
									return d.tagStart == d.indented ? d.stringStartCol + 1 : d.indented + le;
								if (m && m.noIndent) return C.Pass;
								if (d.tokenize != A && d.tokenize != B) return L ? L.match(/^(\s*)/)[0].length : 0;
								if (d.tagName)
									return b.multilineTagIndentPastTag !== !1
										? d.tagStart + d.tagName.length + 2
										: d.tagStart + le * (b.multilineTagIndentFactor || 1);
								...
								if (x && x[1])
									for (; m; )
										if (m.tagName == x[2]) {
											m = m.prev;
											break;
										} else if (b.implicitlyClosed.hasOwnProperty(N(m.tagName))) m = m.prev;
										else break;
								else if (x)
									for (; m; ) {
										var z = b.contextGrabbers[N(m.tagName)];
										if (z && z.hasOwnProperty(N(x[2]))) m = m.prev;
										else break;
									}
								for (; m && m.prev && !m.startOfLine; ) m = m.prev;
								return m ? m.indent + le : d.baseIndent || 0;
							},
							electricInput: /<\/[\s\w:]+>$/,
							blockCommentStart: '<!--',
							blockCommentEnd: '-->',
							...
							xmlCurrentContext: function (d) {
								for (var S = [], L = d.context; L; L = L.prev) S.push(L.tagName);
								return S.reverse();
							}
						};
					}),
		...
		ba ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					(C.defineMode('javascript', function (De, P) {
						var fe = De.indentUnit,
							Se = P.statementIndent,
							le = P.jsonld,
							b = P.json || le,
							W = P.trackScope !== !1,
							j = P.typescript,
							oe = P.wordCharacters || /[\w$\xa1-\uffff]/,
							w = (function () {
								function f(it) {
						...
						function K(f) {
							for (var g = !1, I, X = !1; (I = f.next()) != null; ) {
								if (!g) {
									if (I == '/' && !X) return;
									I == '[' ? (X = !0) : X && I == ']' && (X = !1);
								}
						...
						function R(f, g) {
							var I = f.next();
							if (I == '"' || I == "'") return ((g.tokenize = _(I)), g.tokenize(f, g));
							if (I == '.' && f.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/))
								return N('number', 'number');
							if (I == '.' && f.match('..')) return N('spread', 'meta');
							if (/[\[\]{}\(\),;\:\.]/.test(I)) return N(I);
							if (I == '=' && f.eat('>')) return N('=>', 'operator');
							if (I == '0' && f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))
								return N('number', 'number');
							if (/\d/.test(I))
								return (
							...
							if (I == '/')
								return f.eat('*')
									? ((g.tokenize = Y), Y(f, g))
									: f.eat('/')
										? (f.skipToEnd(), N('comment', 'comment'))
										: Ft(f, g, 1)
											? (K(f),
												f.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
												N('regexp', 'string-2'))
											: (f.eat('='), N('operator', 'operator', f.current()));
							if (I == '`') return ((g.tokenize = ce), ce(f, g));
							if (I == '#' && f.peek() == '!') return (f.skipToEnd(), N('meta', 'meta'));
							if (I == '#' && f.eatWhile(oe)) return N('variable', 'property');
							if (
								(I == '<' && f.match('!--')) ||
								(I == '-' && f.match('->') && !/\S/.test(f.string.slice(0, f.start)))
							)
								return (f.skipToEnd(), N('comment', 'comment'));
							if (B.test(I))
								return (
									(I != '>' || !g.lexical || g.lexical.type != '>') &&
										(f.eat('=')
											? (I == '!' || I == '=') && f.eat('=')
											: /[<>*+\-|&?]/.test(I) && (f.eat(I), I == '>' && f.eat(I))),
									I == '?' && f.eat('.') ? N('.') : N('operator', 'operator', f.current())
								);
							if (oe.test(I)) {
								f.eatWhile(oe);
								var X = f.current();
								if (g.lastType != '.') {
									if (w.propertyIsEnumerable(X)) {
										var D = w[X];
										return N(D.type, D.style, X);
									}
									if (X == 'async' && f.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1))
										return N('async', 'keyword', X);
								}
								return N('variable', 'variable', X);
							}
						}
						function _(f) {
							return function (g, I) {
								var X = !1,
									D;
								if (le && g.peek() == '@' && g.match(A))
									return ((I.tokenize = R), N('jsonld-keyword', 'meta'));
								for (; (D = g.next()) != null && !(D == f && !X); ) X = !X && D == '\\';
								return (X || (I.tokenize = R), N('string', 'string'));
							};
						}
						function Y(f, g) {
							for (var I = !1, X; (X = f.next()); ) {
								if (X == '/' && I) {
									g.tokenize = R;
									break;
								}
						...
						function ce(f, g) {
							...
							return N('quasi', 'string-2', f.current());
						}
						var $ = '([{}])';
						function ee(f, g) {
							g.fatArrowAt && (g.fatArrowAt = null);
							var I = f.string.indexOf('=>', f.start);
							if (!(I < 0)) {
								if (j) {
									var X = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
										f.string.slice(f.start, I)
									);
									X && (I = X.index);
								}
								for (var D = 0, re = !1, He = I - 1; He >= 0; --He) {
									var it = f.string.charAt(He),
										yt = $.indexOf(it);
									if (yt >= 0 && yt < 3) {
										if (!D) {
											++He;
									...
									else if (oe.test(it)) re = !0;
									else if (/["'\/`]/.test(it))
										for (; ; --He) {
											if (He == 0) return;
											var Hr = f.string.charAt(He - 1);
											if (Hr == it && f.string.charAt(He - 2) != '\\') {
												He--;
												break;
											}
										}
						...
						function q(f, g) {
							if (!W) return !1;
							for (var I = f.localVars; I; I = I.next) if (I.name == g) return !0;
							for (var X = f.context; X; X = X.prev)
								for (var I = X.vars; I; I = I.next) if (I.name == g) return !0;
						}
						function Fe(f, g, I, X, D) {
							var re = f.cc;
							for (
								M.state = f,
									M.stream = D,
								...
								var He = re.length ? re.pop() : b ? de : Ce;
								if (He(I, X)) {
									for (; re.length && re[re.length - 1].lex; ) re.pop()();
									return M.marked ? M.marked : I == 'variable' && q(f, X) ? 'variable-2' : g;
								}
							}
						}
						var M = { state: null, marked: null, cc: null };
						function G() {
							for (var f = arguments.length - 1; f >= 0; f--) M.cc.push(arguments[f]);
						}
						function d() {
							return (G.apply(null, arguments), !0);
						}
						function S(f, g) {
							for (var I = g; I; I = I.next) if (I.name == f) return !0;
							return !1;
						}
						function L(f) {
							var g = M.state;
							if (((M.marked = 'def'), !!W)) {
								...
								P.globalVars && !S(f, g.globalVars) && (g.globalVars = new ne(f, g.globalVars));
							}
						}
						function m(f, g) {
							if (g)
								if (g.block) {
									var I = m(f, g.prev);
									return I ? (I == g.prev ? g : new z(I, g.vars, !0)) : null;
								} else return S(f, g.vars) ? g : new z(g.prev, new ne(f, g.vars), !1);
							else return null;
						}
						function x(f) {
							return (
						...
						function z(f, g, I) {
							((this.prev = f), (this.vars = g), (this.block = I));
						}
						function ne(f, g) {
							((this.name = f), (this.next = g));
						}
						var p = new ne('this', new ne('arguments', null));
						function c() {
							((M.state.context = new z(M.state.context, M.state.localVars, !1)),
								(M.state.localVars = p));
						}
						function te() {
							((M.state.context = new z(M.state.context, M.state.localVars, !0)),
						...
						function J(f, g) {
							var I = function () {
								var X = M.state,
									D = X.indented;
								if (X.lexical.type == 'stat') D = X.lexical.indented;
								else
									for (var re = X.lexical; re && re.type == ')' && re.align; re = re.prev)
										D = re.indented;
								X.lexical = new se(D, M.stream.column(), f, null, X.lexical, g);
							};
							return ((I.lex = !0), I);
						}
						function pe() {
						...
						function Te(f) {
							function g(I) {
								return I == f ? d() : f == ';' || I == '}' || I == ')' || I == ']' ? G() : d(g);
							}
							return g;
						}
						function Ce(f, g) {
							return f == 'var'
								? d(J('vardef', g), Nr, Te(';'), pe)
								: f == 'keyword a'
									? d(J('form'), qe, Ce, pe)
									: f == 'keyword b'
										? d(J('form'), Ce, pe)
											...
											: f == 'debugger'
												...
												: f == '{'
													...
													: f == ';'
														? d()
														: f == 'if'
															? (M.state.lexical.info == 'else' &&
																	M.state.cc[M.state.cc.length - 1] == pe &&
																	M.state.cc.pop()(),
																d(J('form'), qe, Ce, pe, Or))
															: f == 'function'
																? d(zt)
																: f == 'for'
																	? d(J('form'), te, Wn, Ce, ke, pe)
																	: f == 'class' || (j && g == 'interface')
																		? ((M.marked = 'keyword'),
																			d(J('form', f == 'class' ? f : g), Pr, pe))
																		: f == 'variable'
																			? j && g == 'declare'
																				? ((M.marked = 'keyword'), d(Ce))
																				: j &&
																					...
																					? ((M.marked = 'keyword'),
																						g == 'enum'
																							? d(ge)
																							: g == 'type'
																								? d(Hn, Te('operator'), We, Te(';'))
																								: d(J('form'), xt, Te('{'), J('}'), Pt, pe, pe))
																					: j && g == 'namespace'
																						? ((M.marked = 'keyword'), d(J('form'), de, Ce, pe))
																						: j && g == 'abstract'
																							? ((M.marked = 'keyword'), d(Ce))
																							: d(J('stat'), ze)
																			: f == 'switch'
						...
						function qe(f) {
							return f != '(' ? G() : d(J(')'), ct, Te(')'), pe);
						}
						function Ve(f, g, I) {
							if (M.state.fatArrowAt == M.stream.start) {
								var X = I ? Ie : xe;
								if (f == '(') return d(c, J(')'), Ee(Ht, ')'), pe, Te('=>'), X, ke);
								if (f == 'variable') return G(c, xt, Te('=>'), X, ke);
							}
							var D = I ? Re : Pe;
							return Ae.hasOwnProperty(f)
								? d(D)
								: f == 'function'
									? d(zt, D)
									: f == 'class' || (j && g == 'interface')
										? ((M.marked = 'keyword'), d(J('form'), yi, pe))
										: f == 'keyword c' || f == 'async'
											? d(I ? Oe : de)
											: f == '('
												? d(J(')'), ct, Te(')'), pe, D)
						...
						function Re(f, g, I) {
							var X = I == !1 ? Pe : Re,
								D = I == !1 ? de : Oe;
							if (f == '=>') return d(c, I ? Ie : xe, ke);
							if (f == 'operator')
								return /\+\+|--/.test(g) || (j && g == '!')
									? d(X)
									: j && g == '<' && M.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
										? d(J('>'), Ee(We, '>'), pe, X)
										: g == '?'
											? d(de, Te(':'), D)
											: d(D);
							if (f == 'quasi') return G(Ue, X);
							if (f != ';') {
								if (f == '(') return Tt(Oe, ')', 'call', X);
								if (f == '.') return d(he, X);
								if (f == '[') return d(J(']'), ct, Te(']'), pe, X);
								if (j && g == 'as') return ((M.marked = 'keyword'), d(We, X));
								if (f == 'regexp')
									return (
						...
						function Ue(f, g) {
							return f != 'quasi' ? G() : g.slice(g.length - 2) != '${' ? d(Ue) : d(ct, et);
						}
						function et(f) {
							if (f == '}') return ((M.marked = 'string-2'), (M.state.tokenize = ce), d(Ue));
						}
						function xe(f) {
							return (ee(M.stream, M.state), G(f == '{' ? Ce : de));
						}
						function Ie(f) {
							return (ee(M.stream, M.state), G(f == '{' ? Ce : Oe));
						}
						function T(f) {
							return function (g) {
								return g == '.'
						...
						function U(f, g) {
							if (g == 'target') return ((M.marked = 'keyword'), d(Pe));
						}
						function O(f, g) {
							if (g == 'target') return ((M.marked = 'keyword'), d(Re));
						}
						function ze(f) {
							return f == ':' ? d(pe, Ce) : G(Pe, Te(';'), pe);
						}
						function he(f) {
							if (f == 'variable') return ((M.marked = 'property'), d());
						}
						function Le(f, g) {
							if (f == 'async') return ((M.marked = 'property'), d(Le));
							if (f == 'variable' || M.style == 'keyword') {
								if (((M.marked = 'property'), g == 'get' || g == 'set')) return d(ve);
								var I;
								return (
									j &&
										M.state.fatArrowAt == M.stream.start &&
										(I = M.stream.match(/^\s*:\s*/, !1)) &&
										(M.state.fatArrowAt = M.stream.pos + I[0].length),
									d(Be)
								);
							} else {
								if (f == 'number' || f == 'string')
									return ((M.marked = le ? 'property' : M.style + ' property'), d(Be));
								if (f == 'jsonld-keyword') return d(Be);
								if (j && x(g)) return ((M.marked = 'keyword'), d(Le));
								if (f == '[') return d(de, or, Te(']'), Be);
								if (f == 'spread') return d(Oe, Be);
								if (g == '*') return ((M.marked = 'keyword'), d(Le));
								if (f == ':') return G(Be);
							}
						}
						function ve(f) {
							return f != 'variable' ? G(Be) : ((M.marked = 'property'), d(zt));
						}
						function Be(f) {
							if (f == ':') return d(Oe);
							if (f == '(') return G(zt);
						...
						function Ee(f, g, I) {
							function X(D, re) {
								if (I ? I.indexOf(D) > -1 : D == ',') {
									var He = M.state.lexical;
									return (
										He.info == 'call' && (He.pos = (He.pos || 0) + 1),
										d(function (it, yt) {
											return it == g || yt == g ? G() : G(f);
										}, X)
									);
								}
								return D == g || re == g ? d() : I && I.indexOf(';') > -1 ? G(f) : d(Te(g));
							}
							return function (D, re) {
								return D == g || re == g ? d() : G(f, X);
							};
						}
						function Tt(f, g, I) {
							for (var X = 3; X < arguments.length; X++) M.cc.push(arguments[X]);
							return d(J(g, I), Ee(f, g), pe);
						}
						function Pt(f) {
							return f == '}' ? d() : G(Ce, Pt);
						}
						...
						function br(f, g) {
							if (j && (f == ':' || g == 'in')) return d(We);
						}
						function lr(f) {
							if (j && f == ':')
								return M.stream.match(/^\s*\w+\s+is\b/, !1) ? d(de, mi, We) : d(We);
						}
						function mi(f, g) {
							if (g == 'is') return ((M.marked = 'keyword'), d());
						}
						function We(f, g) {
							if (g == 'keyof' || g == 'typeof' || g == 'infer' || g == 'readonly')
								return ((M.marked = 'keyword'), d(g == 'typeof' ? Oe : We));
							if (f == 'variable' || g == 'void') return ((M.marked = 'type'), d(It));
							if (g == '|' || g == '&') return d(We);
							if (f == 'string' || f == 'number' || f == 'atom') return d(It);
							if (f == '[') return d(J(']'), Ee(We, ']', ','), pe, It);
							if (f == '{') return d(J('}'), ye, pe, It);
							if (f == '(') return d(Ee(Ze, ')'), Bn, It);
							if (f == '<') return d(Ee(We, '>'), We);
							if (f == 'quasi') return G(dt, It);
						}
						function Bn(f) {
							if (f == '=>') return d(We);
						}
						function ye(f) {
							return f.match(/[\}\)\]]/) ? d() : f == ',' || f == ';' ? d(ye) : G(Qt, ye);
						}
						function Qt(f, g) {
							if (f == 'variable' || M.style == 'keyword') return ((M.marked = 'property'), d(Qt));
						...
						function dt(f, g) {
							return f != 'quasi' ? G() : g.slice(g.length - 2) != '${' ? d(dt) : d(We, Ye);
						}
						function Ye(f) {
							if (f == '}') return ((M.marked = 'string-2'), (M.state.tokenize = ce), d(dt));
						}
						function Ze(f, g) {
							return (f == 'variable' && M.stream.match(/^\s*[?:]/, !1)) || g == '?'
								? d(Ze)
								: f == ':'
									? d(We)
									: f == 'spread'
						...
						function It(f, g) {
							if (g == '<') return d(J('>'), Ee(We, '>'), pe, It);
							if (g == '|' || f == '.' || g == '&') return d(We);
							if (f == '[') return d(We, Te(']'), It);
							if (g == 'extends' || g == 'implements') return ((M.marked = 'keyword'), d(We));
						...
						function Nr(f, g) {
							return g == 'enum' ? ((M.marked = 'keyword'), d(ge)) : G(xt, or, Wt, xi);
						}
						function xt(f, g) {
							if (j && x(g)) return ((M.marked = 'keyword'), d(xt));
							if (f == 'variable') return (L(g), d());
							if (f == 'spread') return d(xt);
							if (f == '[') return Tt(ln, ']');
							if (f == '{') return Tt(ar, '}');
						}
						function ar(f, g) {
							return f == 'variable' && !M.stream.match(/^\s*:/, !1)
								? (L(g), d(Wt))
								: (f == 'variable' && (M.marked = 'property'),
									f == 'spread'
										? d(xt)
										: f == '}'
											? G()
						...
						function Or(f, g) {
							if (f == 'keyword b' && g == 'else') return d(J('form', 'else'), Ce, pe);
						}
						function Wn(f, g) {
							if (g == 'await') return d(Wn);
							if (f == '(') return d(J(')'), an, pe);
						}
						function an(f) {
							return f == 'var' ? d(Nr, sr) : f == 'variable' ? d(sr) : G(sr);
						}
						function sr(f, g) {
							return f == ')'
								? d()
								: f == ';'
									? d(sr)
									: g == 'in' || g == 'of'
										? ((M.marked = 'keyword'), d(de, sr))
										: G(de, sr);
						}
						function zt(f, g) {
							if (g == '*') return ((M.marked = 'keyword'), d(zt));
							if (f == 'variable') return (L(g), d(zt));
							if (f == '(') return d(c, J(')'), Ee(Ht, ')'), pe, lr, Ce, ke);
							if (j && g == '<') return d(J('>'), Ee(Bt, '>'), pe, zt);
						}
						function ur(f, g) {
							if (g == '*') return ((M.marked = 'keyword'), d(ur));
							if (f == 'variable') return (L(g), d(ur));
							if (f == '(') return d(c, J(')'), Ee(Ht, ')'), pe, lr, ke);
							if (j && g == '<') return d(J('>'), Ee(Bt, '>'), pe, ur);
						}
						function Hn(f, g) {
							if (f == 'keyword' || f == 'variable') return ((M.marked = 'type'), d(Hn));
							if (g == '<') return d(J('>'), Ee(Bt, '>'), pe);
						}
						function Ht(f, g) {
							return (
								g == '@' && d(de, Ht),
						...
						function yi(f, g) {
							return f == 'variable' ? Pr(f, g) : _t(f, g);
						}
						function Pr(f, g) {
							if (f == 'variable') return (L(g), d(_t));
						}
						function _t(f, g) {
							if (g == '<') return d(J('>'), Ee(Bt, '>'), pe, _t);
							if (g == 'extends' || g == 'implements' || (j && f == ','))
								return (g == 'implements' && (M.marked = 'keyword'), d(j ? We : de, _t));
							if (f == '{') return d(J('}'), Rt, pe);
						}
						function Rt(f, g) {
							if (
								f == 'async' ||
								(f == 'variable' &&
									(g == 'static' || g == 'get' || g == 'set' || (j && x(g))) &&
									M.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
							)
								return ((M.marked = 'keyword'), d(Rt));
							if (f == 'variable' || M.style == 'keyword')
								return ((M.marked = 'property'), d(kr, Rt));
							if (f == 'number' || f == 'string') return d(kr, Rt);
							if (f == '[') return d(de, or, Te(']'), kr, Rt);
							if (g == '*') return ((M.marked = 'keyword'), d(Rt));
							if (j && f == '(') return G(ur, Rt);
							if (f == ';' || f == ',') return d(Rt);
							if (f == '}') return d();
							if (g == '@') return d(de, Rt);
						}
						function kr(f, g) {
							...
							if (f == ':') return d(We, Wt);
							if (g == '=') return d(Oe);
							var I = M.state.lexical.prev,
								X = I && I.info == 'interface';
							return G(X ? ur : zt);
						}
						function Ir(f, g) {
							return g == '*'
								? ((M.marked = 'keyword'), d(Wr, Te(';')))
								: g == 'default'
									? ((M.marked = 'keyword'), d(de, Te(';')))
									: f == '{'
										? d(Ee(zr, '}'), Wr, Te(';'))
										: G(Ce);
						}
						function zr(f, g) {
							if (g == 'as') return ((M.marked = 'keyword'), d(Te('variable')));
							if (f == 'variable') return G(Oe, zr);
						}
						function fr(f) {
							return f == 'string' ? d() : f == '(' ? G(de) : f == '.' ? G(Pe) : G(Br, Gt, Wr);
						}
						function Br(f, g) {
							return f == '{'
								? Tt(Br, '}')
								: (f == 'variable' && L(g), g == '*' && (M.marked = 'keyword'), d(sn));
						}
						function Gt(f) {
							if (f == ',') return d(Br, Gt);
						}
						function sn(f, g) {
							if (g == 'as') return ((M.marked = 'keyword'), d(Br));
						}
						function Wr(f, g) {
							if (g == 'from') return ((M.marked = 'keyword'), d(de));
						}
						function Je(f) {
							return f == ']' ? d() : G(Ee(Oe, ']'));
						}
						function ge() {
							return G(J('form'), xt, Te('{'), J('}'), Ee(Vt, '}'), pe, pe);
						}
						function Vt() {
							return G(xt, Wt);
						}
						...
						function Ft(f, g, I) {
							return (
								...
								(g.lastType == 'quasi' && /\{\s*$/.test(f.string.slice(0, f.pos - (I || 0))))
							);
						}
						return {
							startState: function (f) {
								var g = {
									...
									lastType: 'sof',
									cc: [],
									lexical: new se((f || 0) - fe, 0, 'block', !1),
									localVars: P.localVars,
									context: P.localVars && new z(null, null, !1),
									indented: f || 0
								};
								return (
									P.globalVars && typeof P.globalVars == 'object' && (g.globalVars = P.globalVars),
									g
								);
							},
							token: function (f, g) {
								if (
									(f.sol() &&
										...
										ee(f, g)),
									g.tokenize != Y && f.eatSpace())
								)
									return null;
								var I = g.tokenize(f, g);
								return ae == 'comment'
									? I
									: ((g.lastType = ae == 'operator' && (F == '++' || F == '--') ? 'incdec' : ae),
										Fe(g, I, ae, F, f));
							},
							indent: function (f, g) {
								if (f.tokenize == Y || f.tokenize == ce) return C.Pass;
								if (f.tokenize != R) return 0;
								var I = g && g.charAt(0),
									X = f.lexical,
									D;
								if (!/^\s*else\b/.test(g))
									for (var re = f.cc.length - 1; re >= 0; --re) {
										var He = f.cc[re];
										if (He == pe) X = X.prev;
										else if (He != Or && He != ke) break;
									}
								for (
									;
									(X.type == 'stat' || X.type == 'form') &&
									(I == '}' ||
										((D = f.cc[f.cc.length - 1]) &&
											(D == Pe || D == Re) &&
											!/^[,\.=+\-*:?[\(]/.test(g)));
								)
									X = X.prev;
								Se && X.type == ')' && X.prev.type == 'stat' && (X = X.prev);
								var it = X.type,
									yt = I == it;
								return it == 'vardef'
									? X.indented +
											(f.lastType == 'operator' || f.lastType == ',' ? X.info.length + 1 : 0)
									: it == 'form' && I == '{'
										? X.indented
										: it == 'form'
											? X.indented + fe
											: it == 'stat'
												? X.indented + (un(f, g) ? Se || fe : 0)
												: X.info == 'switch' && !yt && P.doubleIndentSwitch != !1
													? X.indented + (/^(?:case|default)\b/.test(g) ? fe : 2 * fe)
													: X.align
														? X.column + (yt ? 0 : 1)
														: X.indented + (yt ? 0 : fe);
							},
							...
							skipExpression: function (f) {
								Fe(f, 'atom', 'atom', 'true', new C.StringStream('', 2, null));
							}
						};
					}),
			...
			(function (At, Ot) {
				(function (C) {
					...
					function P(oe, w, B) {
						...
						return (
							K > -1
								? oe.backUp(A.length - K)
								: A.match(/<\/?$/) && (oe.backUp(A.length), oe.match(w, !1) || oe.match(A)),
							B
						);
					}
					var fe = {};
					function Se(oe) {
						var w = fe[oe];
						return w || (fe[oe] = new RegExp('\\s+' + oe + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
					}
					function le(oe, w) {
						var B = oe.match(Se(w));
					...
					function b(oe, w) {
						return new RegExp((w ? '^' : '') + '</\\s*' + oe + '\\s*>', 'i');
					}
					function W(oe, w) {
						for (var B in oe)
							for (var A = w[B] || (w[B] = []), K = oe[B], ae = K.length - 1; ae >= 0; ae--)
								A.unshift(K[ae]);
					}
					function j(oe, w) {
						for (var B = 0; B < oe.length; B++) {
							var A = oe[B];
							if (!A[0] || A[1].test(le(w, A[0]))) return A[2];
						}
					}
					(C.defineMode(
						'htmlmixed',
						function (oe, w) {
							var B = C.getMode(oe, {
								...
								K = w && w.tags,
								ae = w && w.scriptTypes;
							if ((W(De, A), K && W(K, A), ae))
								for (var F = ae.length - 1; F >= 0; F--)
									A.script.unshift(['type', ae[F].matches, ae[F].mode]);
							function N(R, _) {
								var Y = B.token(R, _.htmlState),
									ce = /\btag\b/.test(Y),
									$;
								if (
									ce &&
									!/[<>\s\/]/.test(R.current()) &&
									($ = _.htmlState.tagName && _.htmlState.tagName.toLowerCase()) &&
									A.hasOwnProperty($)
								)
									_.inTag = $ + ' ';
								else if (_.inTag && ce && />$/.test(R.current())) {
									var ee = /^([\S]+) (.*)/.exec(_.inTag);
									_.inTag = null;
									var Ae = R.current() == '>' && j(A[ee[1]], ee[2]),
										se = C.getMode(oe, Ae),
										q = b(ee[1], !0),
										Fe = b(ee[1], !1);
									((_.token = function (M, G) {
										return M.match(q, !1)
											? ((G.token = N), (G.localState = G.localMode = null), null)
											: P(M, Fe, G.localMode.token(M, G.localState));
									}),
										(_.localMode = se),
										(_.localState = C.startState(se, B.indent(_.htmlState, '', ''))));
								} else _.inTag && ((_.inTag += R.current()), R.eol() && (_.inTag += ' '));
								return Y;
							}
							return {
								startState: function () {
									var R = C.startState(B);
									return { token: N, inTag: null, localMode: null, localState: null, htmlState: R };
								},
								copyState: function (R) {
									var _;
									return (
										R.localState && (_ = C.copyState(R.localMode, R.localState)),
										{
											token: R.token,
											inTag: R.inTag,
											localMode: R.localMode,
											localState: _,
											htmlState: C.copyState(B, R.htmlState)
										}
									);
								},
								token: function (R, _) {
								...
								indent: function (R, _, Y) {
									return !R.localMode || /^\s*<\//.test(_)
										? B.indent(R.htmlState, _, Y)
										: R.localMode.indent
											? R.localMode.indent(R.localState, _, Y)
											: C.Pass;
								},
								innerMode: function (R) {
									return { state: R.localState || R.htmlState, mode: R.localMode || B };
								}
							};
						},
						'xml',
		...
		Sa ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					C.registerHelper('hintWords', 'python', fe.concat(Se).concat(['exec', 'print']));
					function le(W) {
						return W.scopes[W.scopes.length - 1];
					}
					(C.defineMode('python', function (W, j) {
						for (
							var oe = 'error',
								w = j.delimiters || j.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
								B = [
									j.singleOperators,
									j.doubleOperators,
									j.doubleDelimiters,
							...
							B[A] || B.splice(A--, 1);
						var K = j.hangingIndent || W.indentUnit,
							ae = fe,
							F = Se;
						(j.extra_keywords != null && (ae = ae.concat(j.extra_keywords)),
							j.extra_builtins != null && (F = F.concat(j.extra_builtins)));
						var N = !(j.version && Number(j.version) < 3);
						if (N) {
							var R = j.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
							((ae = ae.concat([
								'nonlocal',
								'None',
								'aiter',
								...
								(F = F.concat(['ascii', 'bytes', 'exec', 'print'])));
							var _ = new RegExp(`^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|"{3}|['"]))`, 'i');
						} else {
							var R = j.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
							((ae = ae.concat(['exec', 'print'])),
								(F = F.concat([
									'apply',
									'basestring',
									'buffer',
						...
						var Y = De(ae),
							ce = De(F);
						function $(S, L) {
							var m = S.sol() && L.lastToken != '\\';
							if ((m && (L.indent = S.indentation()), m && le(L).type == 'py')) {
								var x = le(L).offset;
								if (S.eatSpace()) {
									var z = S.indentation();
									return (
										z > x ? q(L) : z < x && M(S, L) && S.peek() != '#' && (L.errorToken = !0),
										null
									);
								} else {
									var ne = ee(S, L);
									return (x > 0 && M(S, L) && (ne += ' ' + oe), ne);
								}
							}
							return ee(S, L);
						}
						function ee(S, L, m) {
							...
							if (S.match(/^[0-9\.]/, !1)) {
								...
								var z = !1;
								if (
									(S.match(/^0x[0-9a-f_]+/i) && (z = !0),
									S.match(/^0b[01_]+/i) && (z = !0),
									S.match(/^0o[0-7_]+/i) && (z = !0),
									S.match(/^[1-9][\d_]*(e[\+\-]?[\d_]+)?/) && (S.eat(/J/i), (z = !0)),
									S.match(/^0(?![\dx])/i) && (z = !0),
									z)
								)
							...
							if (S.match(_)) {
								var ne = S.current().toLowerCase().indexOf('f') !== -1;
								return ne
									? ((L.tokenize = Ae(S.current(), L.tokenize)), L.tokenize(S, L))
									: ((L.tokenize = se(S.current(), L.tokenize)), L.tokenize(S, L));
							}
							for (var p = 0; p < B.length; p++) if (S.match(B[p])) return 'operator';
							return S.match(w)
								? 'punctuation'
								: L.lastToken == '.' && S.match(R)
									? 'property'
									: S.match(Y) || S.match(P)
										? 'keyword'
										: S.match(ce)
											...
											: S.match(/^(self|cls)\b/)
												? 'variable-2'
												: S.match(R)
													? L.lastToken == 'def' || L.lastToken == 'class'
														? 'def'
														: 'variable'
													: (S.next(), m ? null : oe);
						}
						function Ae(S, L) {
									...
									return (
										ke == 'punctuation' &&
											(c.current() == '{'
												? (te.tokenize = z(p + 1))
												: c.current() == '}' &&
													(p > 1 ? (te.tokenize = z(p - 1)) : (te.tokenize = ne))),
										ke
									);
								};
							}
							function ne(p, c) {
								for (; !p.eol(); )
									if ((p.eatWhile(/[^'"\{\}\\]/), p.eat('\\'))) {
										if ((p.next(), m && p.eol())) return x;
									} else {
										if (p.match(S)) return ((c.tokenize = L), x);
										if (p.match('{{')) return x;
										if (p.match('{', !1))
											return ((c.tokenize = z(0)), p.current() ? x : c.tokenize(p, c));
										if (p.match('}}')) return x;
										if (p.match('}')) return oe;
										p.eat(/['"]/);
									}
								if (m) {
									if (j.singleLineStringErrors) return oe;
									c.tokenize = L;
								}
								return x;
							}
							return ((ne.isString = !0), ne);
						}
						function se(S, L) {
							for (; 'rubf'.indexOf(S.charAt(0).toLowerCase()) >= 0; ) S = S.substr(1);
							var m = S.length == 1,
							...
							function z(ne, p) {
								for (; !ne.eol(); )
									if ((ne.eatWhile(/[^'"\\]/), ne.eat('\\'))) {
										if ((ne.next(), m && ne.eol())) return x;
									} else {
										if (ne.match(S)) return ((p.tokenize = L), x);
										ne.eat(/['"]/);
									}
								if (m) {
									if (j.singleLineStringErrors) return oe;
						...
						function q(S) {
							for (; le(S).type != 'py'; ) S.scopes.pop();
							S.scopes.push({ offset: le(S).offset + W.indentUnit, type: 'py', align: null });
						}
						function Fe(S, L, m) {
							var x = S.match(/^[\s\[\{\(]*(?:#|$)/, !1) ? null : S.column() + 1;
							L.scopes.push({ offset: L.indent + K, type: m, align: x });
						}
						function M(S, L) {
							for (var m = S.indentation(); L.scopes.length > 1 && le(L).offset > m; ) {
								if (le(L).type != 'py') return !0;
								L.scopes.pop();
							}
							return le(L).offset != m;
						}
						function G(S, L) {
							S.sol() && ((L.beginningOfLine = !0), (L.dedent = !1));
							var m = L.tokenize(S, L),
								x = S.current();
							if (L.beginningOfLine && x == '@')
								return S.match(R, !1) ? 'meta' : N ? 'operator' : oe;
							if (
								(/\S/.test(x) && (L.beginningOfLine = !1),
								(m == 'variable' || m == 'builtin') && L.lastToken == 'meta' && (m = 'meta'),
								(x == 'pass' || x == 'return') && (L.dedent = !0),
								x == 'lambda' && (L.lambda = !0),
								x == ':' && !L.lambda && le(L).type == 'py' && S.match(/^\s*(?:#|$)/, !1) && q(L),
								x.length == 1 && !/string|comment/.test(m))
							) {
								var z = '[({'.indexOf(x);
								if ((z != -1 && Fe(S, L, '])}'.slice(z, z + 1)), (z = '])}'.indexOf(x)), z != -1))
									if (le(L).type == x) L.indent = L.scopes.pop().offset - K;
									else return oe;
							}
							return (
								L.dedent && S.eol() && le(L).type == 'py' && L.scopes.length > 1 && L.scopes.pop(),
								m
							);
						}
						var d = {
							...
							token: function (S, L) {
								...
								return (
									x &&
										x != 'comment' &&
										(L.lastToken = x == 'keyword' || x == 'punctuation' ? S.current() : x),
									x == 'punctuation' && (x = null),
									S.eol() && L.lambda && (L.lambda = !1),
									m ? x + ' ' + oe : x
								);
							},
							indent: function (S, L) {
								if (S.tokenize != $) return S.tokenize.isString ? C.Pass : 0;
								var m = le(S),
									x =
										m.type == L.charAt(0) ||
										(m.type == 'py' && !S.dedent && /^(else:|elif |except |finally:)/.test(L));
								return m.align != null ? m.align - (x ? 1 : 0) : m.offset - (x ? K : 0);
							},
				...
				(function (C) {
					...
					function P(m, x, z, ne) {
						...
						return (
							...
							(m.context = new De(p, x, z, ne, null, m.context))
						);
					}
					function fe(m) {
						var x = m.context.type;
						return (
							(x == ')' || x == ']' || x == '}') && (m.indented = m.context.indented),
							(m.context = m.context.prev)
						);
					}
					function Se(m, x, z) {
						if (
							x.prevToken == 'variable' ||
							x.prevToken == 'type' ||
							/\S(?:[^- ]>|[*\]])\s*$|\*$/.test(m.string.slice(0, z)) ||
							(x.typeAtEndOfLine && m.column() == m.indentation())
						)
							return !0;
					}
					function le(m) {
					...
					C.defineMode('clike', function (m, x) {
						var z = m.indentUnit,
							ne = x.statementIndentUnit || z,
							p = x.dontAlignCalls,
							c = x.keywords || {},
							te = x.types || {},
							ke = x.builtin || {},
							...
							Te = x.atoms || {},
							Ce = x.hooks || {},
							we = x.multiLineStrings,
							de = x.indentStatements !== !1,
							Oe = x.indentSwitch !== !1,
							qe = x.namespaceSeparator,
							Ve = x.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
							ct = x.numberStart || /[\d\.]/,
							Pe =
								x.number ||
						...
						function T(he, Le) {
							...
							if (ve == '"' || ve == "'") return ((Le.tokenize = U(ve)), Le.tokenize(he, Le));
							if (ct.test(ve)) {
								if ((he.backUp(1), he.match(Pe))) return 'number';
								he.next();
							}
							if (Ve.test(ve)) return ((xe = ve), null);
							if (ve == '/') {
								if (he.eat('*')) return ((Le.tokenize = O), O(he, Le));
								if (he.eat('/')) return (he.skipToEnd(), 'comment');
							}
							if (Re.test(ve)) {
								for (; !he.match(/^\/[\/*]/, !1) && he.eat(Re); );
								return 'operator';
							}
							if ((he.eatWhile(Ue), qe)) for (; he.match(qe); ) he.eatWhile(Ue);
							var Ee = he.current();
							return W(c, Ee)
								? (W(J, Ee) && (xe = 'newstatement'), W(pe, Ee) && (Ie = !0), 'keyword')
								: W(te, Ee)
									? 'type'
									: W(ke, Ee) || (et && et(Ee))
										? (W(J, Ee) && (xe = 'newstatement'), 'builtin')
										: W(Te, Ee)
											? 'atom'
											: 'variable';
						}
						function U(he) {
							return function (Le, ve) {
								for (var Be = !1, Ee, Tt = !1; (Ee = Le.next()) != null; ) {
									if (Ee == he && !Be) {
										Tt = !0;
										break;
									}
								...
								return ((Tt || !(Be || we)) && (ve.tokenize = null), 'string');
							};
						}
						function O(he, Le) {
							for (var ve = !1, Be; (Be = he.next()); ) {
								if (Be == '/' && ve) {
									Le.tokenize = null;
									break;
								}
						...
						function ze(he, Le) {
							x.typeFirstDefinitions &&
								he.eol() &&
								le(Le.context) &&
								(Le.typeAtEndOfLine = Se(he, Le, he.pos));
						}
						return {
							startState: function (he) {
								return {
									tokenize: null,
									context: new De((he || 0) - z, 0, 'top', null, !1),
									indented: 0,
									startOfLine: !0,
									prevToken: null
								};
							},
							token: function (he, Le) {
								var ve = Le.context;
								if (
									(he.sol() &&
										(ve.align == null && (ve.align = !1),
										(Le.indented = he.indentation()),
										(Le.startOfLine = !0)),
									he.eatSpace())
								)
									return (ze(he, Le), null);
								xe = Ie = null;
								var Be = (Le.tokenize || T)(he, Le);
								if (Be == 'comment' || Be == 'meta') return Be;
								if (
									(ve.align == null && (ve.align = !0),
									xe == ';' || xe == ':' || (xe == ',' && he.match(/^\s*(?:\/\/.*)?$/, !1)))
								)
									for (; Le.context.type == 'statement'; ) fe(Le);
								else if (xe == '{') P(Le, he.column(), '}');
								else if (xe == '[') P(Le, he.column(), ']');
								else if (xe == '(') P(Le, he.column(), ')');
								else if (xe == '}') {
									for (; ve.type == 'statement'; ) ve = fe(Le);
									for (ve.type == '}' && (ve = fe(Le)); ve.type == 'statement'; ) ve = fe(Le);
								} else
									xe == ve.type
										? fe(Le)
										: de &&
											(((ve.type == '}' || ve.type == 'top') && xe != ';') ||
												(ve.type == 'statement' && xe == 'newstatement')) &&
											P(Le, he.column(), 'statement', he.current());
								if (
									(Be == 'variable' &&
										(Le.prevToken == 'def' ||
											(x.typeFirstDefinitions &&
									...
									var Ee = Ce.token(he, Le, Be);
									Ee !== void 0 && (Be = Ee);
								}
								return (
									Be == 'def' && x.styleDefs === !1 && (Be = 'variable'),
									(Le.startOfLine = !1),
									(Le.prevToken = Ie ? 'def' : Be || xe),
									ze(he, Le),
									Be
								);
							},
							indent: function (he, Le) {
								if (
									(he.tokenize != T && he.tokenize != null) ||
									(he.typeAtEndOfLine && le(he.context))
								)
									return C.Pass;
								var ve = he.context,
									Be = Le && Le.charAt(0),
									Ee = Be == ve.type;
								if ((ve.type == 'statement' && Be == '}' && (ve = ve.prev), x.dontIndentStatements))
									for (; ve.type == 'statement' && x.dontIndentStatements.test(ve.info); )
										ve = ve.prev;
								if (Ce.indent) {
									var Tt = Ce.indent(he, ve, Le, z);
									if (typeof Tt == 'number') return Tt;
								}
								var Pt = ve.prev && ve.prev.info == 'switch';
								if (x.allmanIndentation && /[{(]/.test(Be)) {
									for (; ve.type != 'top' && ve.type != '}'; ) ve = ve.prev;
									return ve.indented;
								}
								return ve.type == 'statement'
									? ve.indented + (Be == '{' ? 0 : ne)
									: ve.align && (!p || ve.type != ')')
										? ve.column + (Ee ? 0 : 1)
										: ve.type == ')' && !Ee
											...
											: ve.indented +
												(Ee ? 0 : z) +
												(!Ee && Pt && !/^(?:case|default)\b/.test(Le) ? z : 0);
							},
					...
					function b(m) {
						for (var x = {}, z = m.split(' '), ne = 0; ne < z.length; ++ne) x[z[ne]] = !0;
						return x;
					}
					function W(m, x) {
						return typeof m == 'function' ? m(x) : m.propertyIsEnumerable(x);
					}
					var j =
						...
						A = b('int long char short double float unsigned signed void bool'),
						K = b('SEL instancetype id Class Protocol BOOL');
					function ae(m) {
						return W(A, m) || /.+_t$/.test(m);
					}
					function F(m) {
						return ae(m) || W(K, m);
					}
					...
					function _(m, x) {
						...
						for (var z, ne = null; (z = m.peek()); ) {
							if (z == '\\' && m.match(/^.$/)) {
								ne = _;
								break;
							} else if (z == '/' && m.match(/^\/[\/\*]/, !1)) break;
							m.next();
						}
						return ((x.tokenize = ne), 'meta');
					}
					function Y(m, x) {
					...
					function ee(m, x) {
						if ((m.backUp(1), m.match(/^(?:R|u8R|uR|UR|LR)/))) {
							var z = m.match(/^"([^\s\\()]{0,16})\(/);
							return z ? ((x.cpp11RawStringDelim = z[1]), (x.tokenize = q), q(m, x)) : !1;
						}
					...
					function q(m, x) {
						var z = x.cpp11RawStringDelim.replace(/[^\w\s]/g, '\\$&'),
							ne = m.match(new RegExp('.*?\\)' + z + '"'));
						return (ne ? (x.tokenize = null) : m.skipToEnd(), 'string');
					}
					function Fe(m, x) {
						typeof m == 'string' && (m = [m]);
						var z = [];
						function ne(c) {
							if (c) for (var te in c) c.hasOwnProperty(te) && z.push(te);
						}
						(ne(x.keywords),
							ne(x.types),
							ne(x.builtin),
							ne(x.atoms),
							z.length && ((x.helperType = m[0]), C.registerHelper('hintWords', m[0], z)));
						for (var p = 0; p < m.length; ++p) C.defineMIME(m[p], x);
					}
					(Fe(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
						name: 'clike',
						keywords: b(j),
						types: ae,
						blockKeywords: b(N),
						...
						isReservedIdentifier: ce,
						hooks: { '#': _, '*': Y },
						modeProps: { fold: ['brace', 'include'] }
					}),
						Fe(['text/x-c++src', 'text/x-c++hdr'], {
							name: 'clike',
							keywords: b(j + ' ' + oe),
							types: ae,
							blockKeywords: b(N + ' class try catch'),
							defKeywords: b(R + ' class namespace'),
							typeFirstDefinitions: !0,
							...
							hooks: {
								...
								8: $,
								9: $,
								token: function (m, x, z) {
									if (
										z == 'variable' &&
										m.peek() == '(' &&
										(x.prevToken == ';' || x.prevToken == null || x.prevToken == '}') &&
										Ae(m.current())
									)
										return 'def';
								}
						...
						Fe('text/x-java', {
							...
							hooks: {
								...
								'"': function (m, x) {
									return m.match(/""$/) ? ((x.tokenize = M), x.tokenize(m, x)) : !1;
								}
							},
					...
					function G(m) {
						return function (x, z) {
							for (var ne; (ne = x.next()); )
								if (ne == '*' && x.eat('/'))
									if (m == 1) {
										z.tokenize = null;
										break;
									} else return ((z.tokenize = G(m - 1)), z.tokenize(x, z));
								else if (ne == '/' && x.eat('*'))
									return ((z.tokenize = G(m + 1)), z.tokenize(x, z));
							return 'comment';
						};
					}
					Fe('text/x-scala', {
						...
						hooks: {
							...
							'=': function (m, x) {
								var z = x.context;
								return z.type == '}' && z.align && m.eat('>')
									? ((x.context = new De(z.indented, z.column, z.type, z.info, null, z.prev)),
										'operator')
									: !1;
							},
							'/': function (m, x) {
								return m.eat('*') ? ((x.tokenize = G(1)), x.tokenize(m, x)) : !1;
							}
						},
					...
					function d(m) {
						return function (x, z) {
							for (var ne = !1, p, c = !1; !x.eol(); ) {
								...
								((p = x.next()),
									!ne && p == '$' && x.match('{') && x.skipTo('}'),
									(ne = !ne && p == '\\' && !m));
							}
							return ((c || !m) && (z.tokenize = null), 'string');
						};
					}
					(Fe('text/x-kotlin', {
						name: 'clike',
						...
						hooks: {
							...
							'"': function (m, x) {
								return ((x.tokenize = d(m.match('""'))), x.tokenize(m, x));
							},
							'/': function (m, x) {
								return m.eat('*') ? ((x.tokenize = G(1)), x.tokenize(m, x)) : !1;
							},
							indent: function (m, x, z, ne) {
								var p = z && z.charAt(0);
								if ((m.prevToken == '}' || m.prevToken == ')') && z == '') return m.indented;
								if (
									(m.prevToken == 'operator' && z != '}' && m.context.type != '}') ||
									(m.prevToken == 'variable' && p == '.') ||
									((m.prevToken == '}' || m.prevToken == ')') && p == '.')
								)
									return ne * 2 + x.indented;
								if (x.align && x.type == '}')
									return x.indented + (m.context.type == (z || '').charAt(0) ? 0 : ne);
							}
						},
						modeProps: { closeBrackets: { triples: '"' } }
					}),
						Fe(['x-shader/x-vertex', 'x-shader/x-fragment'], {
							name: 'clike',
							keywords: b(
						...
						Fe('text/x-objectivec', {
							name: 'clike',
							keywords: b(j + ' ' + w),
							types: F,
							builtin: b(B),
							blockKeywords: b(
								N + ' @synthesize @try @catch @finally @autoreleasepool @synchronized'
							),
							defKeywords: b(R + ' @interface @implementation @protocol @class'),
						...
						Fe('text/x-objectivec++', {
							...
							defKeywords: b(R + ' @interface @implementation @protocol @class class namespace'),
							dontIndentStatements: /^@.*$|^template$/,
							typeFirstDefinitions: !0,
							atoms: b('YES NO NULL Nil nil true false nullptr'),
							isReservedIdentifier: ce,
					...
					function L(m) {
						return function (x, z) {
							for (var ne = !1, p, c = !1; !x.eol(); ) {
								if (!ne && x.match('"') && (m == 'single' || x.match('""'))) {
									c = !0;
									break;
								}
								if (!ne && x.match('``')) {
								...
								((p = x.next()), (ne = m == 'single' && !ne && p == '\\'));
							}
							return (c && (z.tokenize = null), 'string');
						};
					}
					Fe('text/x-ceylon', {
						name: 'clike',
						...
						hooks: {
							...
							'"': function (m, x) {
								return ((x.tokenize = L(m.match('""') ? 'triple' : 'single')), x.tokenize(m, x));
							},
							'`': function (m, x) {
								return !S || !m.match('`') ? !1 : ((x.tokenize = S), (S = null), x.tokenize(m, x));
							},
							"'": function (m) {
								return (m.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom');
							},
							token: function (m, x, z) {
								if ((z == 'variable' || z == 'type') && x.prevToken == '.') return 'variable-2';
							}
						},
		...
		Ma ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					((C.findModeByMIME = function (fe) {
						fe = fe.toLowerCase();
						for (var Se = 0; Se < C.modeInfo.length; Se++) {
							var le = C.modeInfo[Se];
							if (le.mime == fe) return le;
							if (le.mimes) {
								for (var b = 0; b < le.mimes.length; b++) if (le.mimes[b] == fe) return le;
							}
						}
						if (/\+xml$/.test(fe)) return C.findModeByMIME('application/xml');
						if (/\+json$/.test(fe)) return C.findModeByMIME('application/json');
					}),
						(C.findModeByExtension = function (fe) {
							fe = fe.toLowerCase();
							for (var Se = 0; Se < C.modeInfo.length; Se++) {
								var le = C.modeInfo[Se];
								if (le.ext) {
									for (var b = 0; b < le.ext.length; b++) if (le.ext[b] == fe) return le;
								}
							}
						}),
						(C.findModeByFileName = function (fe) {
							for (var Se = 0; Se < C.modeInfo.length; Se++) {
								var le = C.modeInfo[Se];
								if (le.file && le.file.test(fe)) return le;
							}
							var b = fe.lastIndexOf('.'),
								W = b > -1 && fe.substring(b + 1, fe.length);
							if (W) return C.findModeByExtension(W);
						}),
						(C.findModeByName = function (fe) {
							fe = fe.toLowerCase();
							for (var Se = 0; Se < C.modeInfo.length; Se++) {
								var le = C.modeInfo[Se];
								if (le.name.toLowerCase() == fe) return le;
								if (le.alias) {
									for (var b = 0; b < le.alias.length; b++)
										if (le.alias[b].toLowerCase() == fe) return le;
								}
							}
						}));
				});
					...
					(C.defineMode(
						...
						function (De, P) {
							...
							function le(p) {
								...
								var te = C.getMode(De, p);
								return te.name == 'null' ? null : te;
							}
							...
							for (var W in b)
								b.hasOwnProperty(W) && P.tokenTypeOverrides[W] && (b[W] = P.tokenTypeOverrides[W]);
							var j = /^([*\-_])(?:\s*\1){2,}\s*$/,
								oe = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
								w = /^\[(x| )\](?=\s)/i,
								B = P.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/,
								A = /^ {0,3}(?:\={1,}|-{2,})\s*$/,
								K = /^[^#!\[\]*_\\<>` "'(~:]+/,
								ae = /^(~~~+|```+)[ \t]*([\w\/+#-]*)[^\n`]*$/,
								F = /^\s*\[[^\]]+?\]:.*$/,
								...
								R = '    ';
							function _(p, c, te) {
								return ((c.f = c.inline = te), te(p, c));
							}
							function Y(p, c, te) {
								return ((c.f = c.block = te), te(p, c));
							}
							function ce(p) {
							...
							function $(p) {
								if (
									...
									var c = Se;
									if (!c) {
										var te = C.innerMode(fe, p.htmlState);
										c =
											te.mode.name == 'xml' &&
											te.state.tagStart === null &&
											!te.state.context &&
											te.state.tokenize.isInText;
									}
									c && ((p.f = M), (p.block = ee), (p.htmlState = null));
								}
								return (
									(p.trailingSpace = 0),
							...
							function ee(p, c) {
								var te = p.column() === c.indentation,
									ke = ce(c.prevLine.stream),
									J = c.indentedCode,
									pe = c.prevLine.hr,
									Te = c.list !== !1,
									Ce = (c.listStack[c.listStack.length - 1] || 0) + 3;
								c.indentedCode = !1;
								var we = c.indentation;
								if (c.indentationDiff === null && ((c.indentationDiff = c.indentation), Te)) {
									for (c.list = null; we < c.listStack[c.listStack.length - 1]; )
										(c.listStack.pop(),
											c.listStack.length
												? (c.indentation = c.listStack[c.listStack.length - 1])
												: (c.list = !1));
									c.list !== !1 && (c.indentationDiff = we - c.listStack[c.listStack.length - 1]);
								}
								var de =
										!ke && !pe && !c.prevLine.header && (!Te || !J) && !c.prevLine.fencedCodeEnd,
									Oe = (c.list === !1 || pe || ke) && c.indentation <= Ce && p.match(j),
									qe = null;
								if (
									c.indentationDiff >= 4 &&
									(J || c.prevLine.fencedCodeEnd || c.prevLine.header || ke)
								)
									return (p.skipToEnd(), (c.indentedCode = !0), b.code);
								if (p.eatSpace()) return null;
								if (te && c.indentation <= Ce && (qe = p.match(B)) && qe[1].length <= 6)
									return (
										(c.quote = 0),
										(c.header = qe[1].length),
										(c.thisLine.header = !0),
										P.highlightFormatting && (c.formatting = 'header'),
										(c.f = c.inline),
										q(c)
									);
								if (c.indentation <= Ce && p.eat('>'))
									return (
										(c.quote = te ? 1 : c.quote + 1),
										P.highlightFormatting && (c.formatting = 'quote'),
										p.eatSpace(),
										q(c)
									);
								if (!Oe && !c.setext && te && c.indentation <= Ce && (qe = p.match(oe))) {
									var Ve = qe[1] ? 'ol' : 'ul';
									return (
										(c.indentation = we + p.current().length),
										(c.list = !0),
										(c.quote = 0),
										...
										(c.code = !1),
										(c.strikethrough = !1),
										P.taskLists && p.match(w, !1) && (c.taskList = !0),
										(c.f = c.inline),
										P.highlightFormatting && (c.formatting = ['list', 'list-' + Ve]),
										q(c)
									);
								} else {
									if (te && c.indentation <= Ce && (qe = p.match(ae, !0)))
										return (
											(c.quote = 0),
											(c.fencedEndRE = new RegExp(qe[1] + '+ *$')),
											(c.localMode =
												P.fencedCodeBlockHighlighting && le(qe[2] || P.fencedCodeBlockDefaultMode)),
											c.localMode && (c.localState = C.startState(c.localMode)),
											(c.f = c.block = se),
											P.highlightFormatting && (c.formatting = 'code-block'),
											(c.code = -1),
											q(c)
										);
									if (
									...
									if (Oe) return (p.skipToEnd(), (c.hr = !0), (c.thisLine.hr = !0), b.hr);
									if (p.peek() === '[') return _(p, c, m);
								}
								return _(p, c, c.inline);
							}
							function Ae(p, c) {
								var te = fe.token(p, c.htmlState);
								if (!Se) {
									var ke = C.innerMode(fe, c.htmlState);
									((ke.mode.name == 'xml' &&
										ke.state.tagStart === null &&
										!ke.state.context &&
										ke.state.tokenize.isInText) ||
										(c.md_inside && p.current().indexOf('>') > -1)) &&
										((c.f = M), (c.block = ee), (c.htmlState = null));
								}
								return te;
							}
							function se(p, c) {
								var te = c.listStack[c.listStack.length - 1] || 0,
									ke = c.indentation < te,
									J = te + 3;
								if (c.fencedEndRE && c.indentation <= J && (ke || p.match(c.fencedEndRE))) {
									P.highlightFormatting && (c.formatting = 'code-block');
									var pe;
									return (
										ke || (pe = q(c)),
							...
							function q(p) {
								...
								if (p.formatting) {
									...
									for (var te = 0; te < p.formatting.length; te++)
										(c.push(b.formatting + '-' + p.formatting[te]),
											p.formatting[te] === 'header' &&
												c.push(b.formatting + '-' + p.formatting[te] + '-' + p.header),
											p.formatting[te] === 'quote' &&
												(!P.maxBlockquoteDepth || P.maxBlockquoteDepth >= p.quote
													? c.push(b.formatting + '-' + p.formatting[te] + '-' + p.quote)
													: c.push('error')));
								}
								...
								if (
									...
									p.quote &&
										...
										!P.maxBlockquoteDepth || P.maxBlockquoteDepth >= p.quote
											...
											: c.push(b.quote + '-' + P.maxBlockquoteDepth)),
									p.list !== !1)
								) {
									var ke = (p.listStack.length - 1) % 3;
									ke ? (ke === 1 ? c.push(b.list2) : c.push(b.list3)) : c.push(b.list1);
								}
								return (
							...
							function Fe(p, c) {
								if (p.match(K, !0)) return q(c);
							}
							function M(p, c) {
								var te = c.text(p, c);
								if (typeof te < 'u') return te;
								if (c.list) return ((c.list = null), q(c));
								if (c.taskList) {
									var ke = p.match(w, !0)[1] === ' ';
									return (
										ke ? (c.taskOpen = !0) : (c.taskClosed = !0),
										P.highlightFormatting && (c.formatting = 'task'),
										(c.taskList = !1),
										q(c)
									);
								}
								if (((c.taskOpen = !1), (c.taskClosed = !1), c.header && p.match(/^#+$/, !0)))
									return (P.highlightFormatting && (c.formatting = 'header'), q(c));
								var J = p.next();
								if (c.linkTitle) {
									c.linkTitle = !1;
									var pe = J;
								...
								if (J === '`') {
									var Ce = c.formatting;
									(P.highlightFormatting && (c.formatting = 'code'), p.eatWhile('`'));
									var we = p.current().length;
									if (c.code == 0 && (!c.quote || we == 1)) return ((c.code = we), q(c));
									if (we == c.code) {
										var de = q(c);
										return ((c.code = 0), de);
									} else return ((c.formatting = Ce), q(c));
								} else if (c.code) return q(c);
								if (J === '\\' && (p.next(), P.highlightFormatting)) {
									var Oe = q(c),
								...
								if (J === '!' && p.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))
									return (
										(c.imageMarker = !0),
										(c.image = !0),
										P.highlightFormatting && (c.formatting = 'image'),
										q(c)
									);
								...
								if (J === ']' && c.imageAltText) {
									P.highlightFormatting && (c.formatting = 'image');
									var Oe = q(c);
									return ((c.imageAltText = !1), (c.image = !1), (c.inline = c.f = d), Oe);
								}
								if (J === '[' && !c.image)
									return (
										(c.linkText && p.match(/^.*?\]/)) ||
											((c.linkText = !0), P.highlightFormatting && (c.formatting = 'link')),
										q(c)
									);
								if (J === ']' && c.linkText) {
									P.highlightFormatting && (c.formatting = 'link');
									var Oe = q(c);
									return (
										(c.linkText = !1),
										(c.inline = c.f = p.match(/\(.*?\)| ?\[.*?\]/, !1) ? d : M),
										Oe
									);
								}
								if (J === '<' && p.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
									((c.f = c.inline = G), P.highlightFormatting && (c.formatting = 'link'));
									var Oe = q(c);
									return (Oe ? (Oe += ' ') : (Oe = ''), Oe + b.linkInline);
								}
								if (J === '<' && p.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/, !1)) {
									((c.f = c.inline = G), P.highlightFormatting && (c.formatting = 'link'));
									var Oe = q(c);
									return (Oe ? (Oe += ' ') : (Oe = ''), Oe + b.linkEmail);
								}
								if (
									P.xml &&
									J === '<' &&
									...
									return (p.backUp(1), (c.htmlState = C.startState(fe)), Y(p, c, Ae));
								}
								if (P.xml && J === '<' && p.match(/^\/\w*?>/)) return ((c.md_inside = !1), 'tag');
								if (J === '*' || J === '_') {
									for (
										var Pe = 1, Re = p.pos == 1 ? ' ' : p.string.charAt(p.pos - 2);
										Pe < 3 && p.eat(J);
									)
										Pe++;
									var Ue = p.peek() || ' ',
										et = !/\s/.test(Ue) && (!N.test(Ue) || /\s/.test(Re) || N.test(Re)),
										xe = !/\s/.test(Re) && (!N.test(Re) || /\s/.test(Ue) || N.test(Ue)),
										Ie = null,
										T = null;
									if (
										(Pe % 2 &&
											(!c.em && et && (J === '*' || !xe || N.test(Re))
												? (Ie = !0)
												: c.em == J && xe && (J === '*' || !et || N.test(Ue)) && (Ie = !1)),
										Pe > 1 &&
											(!c.strong && et && (J === '*' || !xe || N.test(Re))
												? (T = !0)
												: c.strong == J && xe && (J === '*' || !et || N.test(Ue)) && (T = !1)),
										T != null || Ie != null)
									) {
										(P.highlightFormatting &&
											(c.formatting = Ie == null ? 'strong' : T == null ? 'em' : 'strong em'),
											Ie === !0 && (c.em = J),
											T === !0 && (c.strong = J));
										var de = q(c);
										return (Ie === !1 && (c.em = !1), T === !1 && (c.strong = !1), de);
									}
								} else if (J === ' ' && (p.eat('*') || p.eat('_'))) {
									if (p.peek() === ' ') return q(c);
									p.backUp(1);
								}
								if (P.strikethrough) {
									if (J === '~' && p.eatWhile(J)) {
										if (c.strikethrough) {
											P.highlightFormatting && (c.formatting = 'strikethrough');
											var de = q(c);
											return ((c.strikethrough = !1), de);
										} else if (p.match(/^[^\s]/, !1))
											return (
												(c.strikethrough = !0),
												P.highlightFormatting && (c.formatting = 'strikethrough'),
								...
								if (
									...
									((c.emoji = !0), P.highlightFormatting && (c.formatting = 'emoji'));
									var U = q(c);
									return ((c.emoji = !1), U);
								}
								return (
							...
							function G(p, c) {
								var te = p.next();
								if (te === '>') {
									((c.f = c.inline = M), P.highlightFormatting && (c.formatting = 'link'));
									var ke = q(c);
									return (ke ? (ke += ' ') : (ke = ''), ke + b.linkInline);
								}
							...
							function d(p, c) {
								...
								return te === '(' || te === '['
									? ((c.f = c.inline = L(te === '(' ? ')' : ']')),
										P.highlightFormatting && (c.formatting = 'link-string'),
										(c.linkHref = !0),
										q(c))
									: 'error';
							}
							...
							function L(p) {
								return function (c, te) {
									...
									if (ke === p) {
										((te.f = te.inline = M),
											P.highlightFormatting && (te.formatting = 'link-string'));
										var J = q(te);
										return ((te.linkHref = !1), J);
									}
									return (c.match(S[p]), (te.linkHref = !0), q(te));
								};
							}
							function m(p, c) {
								return p.match(/^([^\]\\]|\\.)*\]:/, !1)
							...
							function x(p, c) {
								if (p.match(']:', !0)) {
									((c.f = c.inline = z), P.highlightFormatting && (c.formatting = 'link'));
									var te = q(c);
									return ((c.linkText = !1), te);
								}
							...
							var ne = {
								...
								copyState: function (p) {
									return {
										...
										thisLine: p.thisLine,
										block: p.block,
										htmlState: p.htmlState && C.copyState(fe, p.htmlState),
								...
								token: function (p, c) {
									if (((c.formatting = !1), p != c.thisLine.stream)) {
										if (((c.header = 0), (c.hr = !1), p.match(/^\s*$/, !0))) return ($(c), null);
										if (
											...
											!c.localState && ((c.f = c.block), c.f != Ae))
										) {
											var te = p.match(/^\s*/, !0)[0].replace(/\t/g, R).length;
											if (((c.indentation = te), (c.indentationDiff = null), te > 0)) return null;
										}
									}
									return c.f(p, c);
								},
								innerMode: function (p) {
									return p.block == Ae
										? { state: p.htmlState, mode: fe }
										: p.localState
											? { state: p.localState, mode: p.localMode }
											: { state: p, mode: ne };
								},
								indent: function (p, c, te) {
									return p.block == Ae && fe.indent
										? fe.indent(p.htmlState, c, te)
										: p.localState && p.localMode.indent
											? p.localMode.indent(p.localState, c, te)
											: C.Pass;
								},
								blankLine: $,
								getType: q,
		...
		Ea ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					C.defineOption('placeholder', '', function (W, j, oe) {
						var w = oe && oe != C.Init;
						if (j && !w)
							(W.on('blur', Se),
								W.on('change', le),
								...
								C.on(
									W.getInputField(),
									'compositionupdate',
									(W.state.placeholderCompose = function () {
										fe(W);
									})
								),
								le(W));
							...
							(W.off('blur', Se),
								W.off('change', le),
								W.off('swapDoc', le),
								C.off(W.getInputField(), 'compositionupdate', W.state.placeholderCompose),
								De(W));
							var B = W.getWrapperElement();
							B.className = B.className.replace(' CodeMirror-empty', '');
						}
						j && !W.hasFocus() && Se(W);
					});
					function De(W) {
						W.state.placeholder &&
							(W.state.placeholder.parentNode.removeChild(W.state.placeholder),
							(W.state.placeholder = null));
					}
					function P(W) {
						De(W);
						var j = (W.state.placeholder = document.createElement('pre'));
						((j.style.cssText = 'height: 0; overflow: visible'),
							(j.style.direction = W.getOption('direction')),
							(j.className = 'CodeMirror-placeholder CodeMirror-line-like'));
						var oe = W.getOption('placeholder');
						(typeof oe == 'string' && (oe = document.createTextNode(oe)),
							j.appendChild(oe),
							W.display.lineSpace.insertBefore(j, W.display.lineSpace.firstChild));
					}
					function fe(W) {
						setTimeout(function () {
							var j = !1;
							if (W.lineCount() == 1) {
								var oe = W.getInputField();
								j =
									oe.nodeName == 'TEXTAREA'
										? !W.getLine(0).length
										: !/[^\u200b]/.test(oe.querySelector('.CodeMirror-line').textContent);
							}
							j ? P(W) : De(W);
						}, 20);
					}
					...
					function le(W) {
						var j = W.getWrapperElement(),
							oe = b(W);
						((j.className =
							j.className.replace(' CodeMirror-empty', '') + (oe ? ' CodeMirror-empty' : '')),
							oe ? P(W) : De(W));
					}
					function b(W) {
		...
		Oa ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					((C.defineSimpleMode = function (w, B) {
						C.defineMode(w, function (A) {
							return C.simpleMode(A, B);
						});
					}),
						(C.simpleMode = function (w, B) {
							De(B, 'start');
							var A = {},
								K = B.meta || {},
								ae = !1;
							for (var F in B)
								if (F != K && B.hasOwnProperty(F))
									for (var N = (A[F] = []), R = B[F], _ = 0; _ < R.length; _++) {
										var Y = R[_];
										(N.push(new Se(Y, B)), (Y.indent || Y.dedent) && (ae = !0));
									}
							var ce = {
								startState: function () {
									return {
								...
								copyState: function (ee) {
									var Ae = {
										state: ee.state,
										pending: ee.pending,
										local: ee.local,
										localState: null,
										indent: ee.indent && ee.indent.slice(0)
									};
									(ee.localState && (Ae.localState = C.copyState(ee.local.mode, ee.localState)),
										ee.stack && (Ae.stack = ee.stack.slice(0)));
									for (var se = ee.persistentStates; se; se = se.next)
										Ae.persistentStates = {
											mode: se.mode,
											spec: se.spec,
											state:
												se.state == ee.localState ? Ae.localState : C.copyState(se.mode, se.state),
											next: Ae.persistentStates
										};
									return Ae;
								},
								token: le(A, w),
								innerMode: function (ee) {
									return ee.local && { mode: ee.local.mode, state: ee.localState };
								},
								indent: oe(A, K)
							};
							if (K) for (var $ in K) K.hasOwnProperty($) && (ce[$] = K[$]);
							return ce;
						}));
					function De(w, B) {
						if (!w.hasOwnProperty(B)) throw new Error('Undefined state ' + B + ' in simple mode');
					}
					function P(w, B) {
						if (!w) return /(?:)/;
						var A = '';
						return (
							w instanceof RegExp
								? (w.ignoreCase && (A = 'i'), w.unicode && (A += 'u'), (w = w.source))
								: (w = String(w)),
							new RegExp((B === !1 ? '' : '^') + '(?:' + w + ')', A)
						);
					}
					function fe(w) {
						...
						for (var B = [], A = 0; A < w.length; A++) B.push(w[A] && w[A].replace(/\./g, ' '));
						return B;
					}
					function Se(w, B) {
						((w.next || w.push) && De(B, w.next || w.push),
							(this.regex = P(w.regex)),
							(this.token = fe(w.token)),
							(this.data = w));
					}
					function le(w, B) {
						return function (A, K) {
							if (K.pending) {
								var ae = K.pending.shift();
								return (
									K.pending.length == 0 && (K.pending = null),
									(A.pos += ae.text.length),
									ae.token
								);
							}
							if (K.local)
								if (K.local.end && A.match(K.local.end)) {
									var F = K.local.endToken || null;
									return ((K.local = K.localState = null), F);
								} else {
									var F = K.local.mode.token(A, K.localState),
										N;
									return (
										K.local.endScan &&
											(N = K.local.endScan.exec(A.current())) &&
											(A.pos = A.start + N.index),
										F
									);
								}
							for (var R = w[K.state], _ = 0; _ < R.length; _++) {
								var Y = R[_],
									ce = (!Y.data.sol || A.sol()) && A.match(Y.regex);
								if (ce) {
									(Y.data.next
										? (K.state = Y.data.next)
										: Y.data.push
											? ((K.stack || (K.stack = [])).push(K.state), (K.state = Y.data.push))
											: Y.data.pop && K.stack && K.stack.length && (K.state = K.stack.pop()),
										Y.data.mode && W(B, K, Y.data.mode, Y.token),
										Y.data.indent && K.indent.push(A.indentation() + B.indentUnit),
										Y.data.dedent && K.indent.pop());
									var $ = Y.token;
									if (
										($ && $.apply && ($ = $(ce)),
										ce.length > 2 && Y.token && typeof Y.token != 'string')
									) {
										for (var ee = 2; ee < ce.length; ee++)
											ce[ee] &&
												(K.pending || (K.pending = [])).push({
													text: ce[ee],
													token: Y.token[ee - 1]
												});
										return (A.backUp(ce[0].length - (ce[1] ? ce[1].length : 0)), $[0]);
									} else return $ && $.join ? $[0] : $;
								}
							}
							return (A.next(), null);
					...
					function b(w, B) {
						if (w === B) return !0;
						if (!w || typeof w != 'object' || !B || typeof B != 'object') return !1;
						var A = 0;
						for (var K in w)
							if (w.hasOwnProperty(K)) {
								if (!B.hasOwnProperty(K) || !b(w[K], B[K])) return !1;
								A++;
							}
						for (var K in B) B.hasOwnProperty(K) && A--;
						return A == 0;
					}
					function W(w, B, A, K) {
						var ae;
						if (A.persistent)
							for (var F = B.persistentStates; F && !ae; F = F.next)
								(A.spec ? b(A.spec, F.spec) : A.mode == F.mode) && (ae = F);
						var N = ae ? ae.mode : A.mode || C.getMode(w, A.spec),
							R = ae ? ae.state : C.startState(N);
						(A.persistent &&
							!ae &&
							(B.persistentStates = { mode: N, spec: A.spec, state: R, next: B.persistentStates }),
							(B.localState = R),
							(B.local = {
								mode: N,
								end: A.end && P(A.end),
								endScan: A.end && A.forceEnd !== !1 && P(A.end, !1),
					...
					function oe(w, B) {
						return function (A, K, ae) {
							if (A.local && A.local.mode.indent) return A.local.mode.indent(A.localState, K, ae);
							if (
								A.indent == null ||
								A.local ||
								(B.dontIndentStates && j(A.state, B.dontIndentStates) > -1)
							)
								return C.Pass;
							var F = A.indent.length - 1,
								N = w[A.state];
							e: for (;;) {
								for (var R = 0; R < N.length; R++) {
									var _ = N[R];
									if (_.data.dedent && _.data.dedentIfLineStart !== !1) {
										var Y = _.regex.exec(K);
										if (Y && Y[0]) {
											(F--,
												(_.next || _.push) && (N = w[_.next || _.push]),
												(K = K.slice(Y[0].length)));
											continue e;
										}
									}
								}
		...
		Ia ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					function le(w, B, A) {
						var K = w.getLineHandle(B.line),
							ae = B.ch - 1,
							F = A && A.afterCursor;
						F == null && (F = /(^| )cm-fat-cursor($| )/.test(w.getWrapperElement().className));
						var N = Se(A),
							R =
								(!F && ae >= 0 && N.test(K.text.charAt(ae)) && fe[K.text.charAt(ae)]) ||
								(N.test(K.text.charAt(ae + 1)) && fe[K.text.charAt(++ae)]);
						if (!R) return null;
						var _ = R.charAt(1) == '>' ? 1 : -1;
						if (A && A.strict && _ > 0 != (ae == B.ch)) return null;
						var Y = w.getTokenTypeAt(P(B.line, ae + 1)),
							ce = b(w, P(B.line, ae + (_ > 0 ? 1 : 0)), _, Y, A);
						return ce == null
							? null
							: {
									from: P(B.line, ae),
									to: ce && ce.pos,
									match: ce && ce.ch == R.charAt(0),
									forward: _ > 0
								};
					}
					function b(w, B, A, K, ae) {
						for (
							var F = (ae && ae.maxScanLineLength) || 1e4,
								N = (ae && ae.maxScanLines) || 1e3,
								R = [],
								_ = Se(ae),
								Y =
									A > 0
										? Math.min(B.line + N, w.lastLine() + 1)
										: Math.max(w.firstLine() - 1, B.line - N),
								ce = B.line;
							ce != Y;
							ce += A
						) {
							var $ = w.getLine(ce);
							if ($) {
								var ee = A > 0 ? 0 : $.length - 1,
									Ae = A > 0 ? $.length : -1;
								if (!($.length > F))
									for (ce == B.line && (ee = B.ch - (A < 0 ? 1 : 0)); ee != Ae; ee += A) {
										var se = $.charAt(ee);
										if (
											_.test(se) &&
											(K === void 0 || (w.getTokenTypeAt(P(ce, ee + 1)) || '') == (K || ''))
										) {
											var q = fe[se];
											if (q && (q.charAt(1) == '>') == A > 0) R.push(se);
											else if (R.length) R.pop();
											else return { pos: P(ce, ee), ch: se };
										}
									}
							}
						}
						return ce - A == (A > 0 ? w.lastLine() : w.firstLine()) ? !1 : null;
					}
					function W(w, B, A) {
						for (
							var K = w.state.matchBrackets.maxHighlightLineLength || 1e3,
								ae = A && A.highlightNonMatching,
								F = [],
								N = w.listSelections(),
								R = 0;
							R < N.length;
							...
							var _ = N[R].empty() && le(w, N[R].head, A);
							if (_ && (_.match || ae !== !1) && w.getLine(_.from.line).length <= K) {
								var Y = _.match ? 'CodeMirror-matchingbracket' : 'CodeMirror-nonmatchingbracket';
								(F.push(w.markText(_.from, P(_.from.line, _.from.ch + 1), { className: Y })),
									_.to &&
										w.getLine(_.to.line).length <= K &&
										F.push(w.markText(_.to, P(_.to.line, _.to.ch + 1), { className: Y })));
							}
						}
						if (F.length) {
							De && w.state.focused && w.focus();
							var ce = function () {
								w.operation(function () {
									for (var $ = 0; $ < F.length; $++) F[$].clear();
								});
							};
							if (B) setTimeout(ce, 800);
							else return ce;
						}
					}
					function j(w) {
						w.operation(function () {
							(w.state.matchBrackets.currentlyHighlighted &&
								(w.state.matchBrackets.currentlyHighlighted(),
								(w.state.matchBrackets.currentlyHighlighted = null)),
								(w.state.matchBrackets.currentlyHighlighted = W(w, !1, w.state.matchBrackets)));
						});
					}
					function oe(w) {
						w.state.matchBrackets &&
							w.state.matchBrackets.currentlyHighlighted &&
							(w.state.matchBrackets.currentlyHighlighted(),
							(w.state.matchBrackets.currentlyHighlighted = null));
					}
					(C.defineOption('matchBrackets', !1, function (w, B, A) {
						(A &&
							A != C.Init &&
							(w.off('cursorActivity', j), w.off('focus', j), w.off('blur', oe), oe(w)),
							B &&
								((w.state.matchBrackets = typeof B == 'object' ? B : {}),
								w.on('cursorActivity', j),
								w.on('focus', j),
								w.on('blur', oe)));
					}),
						...
						C.defineExtension('findMatchingBracket', function (w, B, A) {
							return (
								(A || typeof B == 'boolean') &&
									(A ? ((A.strict = B), (B = A)) : (B = B ? { strict: !0 } : null)),
								le(this, w, B)
							);
						}),
						C.defineExtension('scanForBracket', function (w, B, A, K) {
							return b(this, w, B, A, K);
						}));
				});
			})()),
		Pa.exports
		...
		Ba ||
			...
			(function (At, Ot) {
				(function (C) {
					...
					var De = { pairs: `()[]{}''""`, closeBefore: `)]}'":;>`, triples: '', explode: '[]{}' },
						P = C.Pos;
					C.defineOption('autoCloseBrackets', !1, function (F, N, R) {
						(R && R != C.Init && (F.removeKeyMap(Se), (F.state.closeBrackets = null)),
							N && (le(fe(N, 'pairs')), (F.state.closeBrackets = N), F.addKeyMap(Se)));
					});
					function fe(F, N) {
						return N == 'pairs' && typeof F == 'string'
							? F
							: typeof F == 'object' && F[N] != null
								? F[N]
								: De[N];
					}
					var Se = { Backspace: j, Enter: oe };
					function le(F) {
					...
					function W(F) {
						var N = F.state.closeBrackets;
						if (!N || N.override) return N;
						var R = F.getModeAt(F.getCursor());
						return R.closeBrackets || N;
					}
					function j(F) {
						var N = W(F);
						if (!N || F.getOption('disableInput')) return C.Pass;
						for (var R = fe(N, 'pairs'), _ = F.listSelections(), Y = 0; Y < _.length; Y++) {
							if (!_[Y].empty()) return C.Pass;
							var ce = K(F, _[Y].head);
							if (!ce || R.indexOf(ce) % 2 != 0) return C.Pass;
						}
						for (var Y = _.length - 1; Y >= 0; Y--) {
							var $ = _[Y].head;
							F.replaceRange('', P($.line, $.ch - 1), P($.line, $.ch + 1), '+delete');
						}
					}
					function oe(F) {
						var N = W(F),
							R = N && fe(N, 'explode');
						if (!R || F.getOption('disableInput')) return C.Pass;
						for (var _ = F.listSelections(), Y = 0; Y < _.length; Y++) {
							if (!_[Y].empty()) return C.Pass;
							var ce = K(F, _[Y].head);
							if (!ce || R.indexOf(ce) % 2 != 0) return C.Pass;
						}
						F.operation(function () {
							var $ =
								...
								`
`;
							(F.replaceSelection($ + $, null), w(F, -1), (_ = F.listSelections()));
							for (var ee = 0; ee < _.length; ee++) {
								var Ae = _[ee].head.line;
								(F.indentLine(Ae, null, !0), F.indentLine(Ae + 1, null, !0));
							}
						});
					}
					function w(F, N) {
						for (var R = [], _ = F.listSelections(), Y = 0, ce = 0; ce < _.length; ce++) {
							var $ = _[ce];
							$.head == F.getCursor() && (Y = ce);
							var ee =
								$.head.ch || N > 0
									? { line: $.head.line, ch: $.head.ch + N }
									: { line: $.head.line - 1 };
							R.push({ anchor: ee, head: ee });
						}
						F.setSelections(R, Y);
					}
					function B(F) {
						var N = C.cmpPos(F.anchor, F.head) > 0;
						return {
							anchor: new P(F.anchor.line, F.anchor.ch + (N ? -1 : 1)),
							head: new P(F.head.line, F.head.ch + (N ? 1 : -1))
						};
					}
					function A(F, N) {
						var R = W(F);
						...
						var _ = fe(R, 'pairs'),
							Y = _.indexOf(N);
						if (Y == -1) return C.Pass;
						for (
							var ce = fe(R, 'closeBefore'),
								$ = fe(R, 'triples'),
								ee = _.charAt(Y + 1) == N,
								Ae = F.listSelections(),
								se = Y % 2 == 0,
							...
							var M = Ae[Fe],
								G = M.head,
								d,
								S = F.getRange(G, P(G.line, G.ch + 1));
							if (se && !M.empty()) d = 'surround';
							else if ((ee || !se) && S == N)
								ee && ae(F, G)
									? (d = 'both')
									: $.indexOf(N) >= 0 && F.getRange(G, P(G.line, G.ch + 3)) == N + N + N
										? (d = 'skipThree')
										: (d = 'skip');
							else if (
								ee &&
								G.ch > 1 &&
								$.indexOf(N) >= 0 &&
								F.getRange(P(G.line, G.ch - 2), G) == N + N
							) {
								if (G.ch > 2 && /\bstring/.test(F.getTokenTypeAt(P(G.line, G.ch - 2))))
									return C.Pass;
								d = 'addFour';
							} else if (ee) {
								var L = G.ch == 0 ? ' ' : F.getRange(P(G.line, G.ch - 1), G);
								if (!C.isWordChar(S) && L != N && !C.isWordChar(L)) d = 'both';
								else return C.Pass;
							} else if (se && (S.length === 0 || /\s/.test(S) || ce.indexOf(S) > -1)) d = 'both';
							else return C.Pass;
							if (!q) q = d;
							else if (q != d) return C.Pass;
						}
						var m = Y % 2 ? _.charAt(Y - 1) : N,
							x = Y % 2 ? N : _.charAt(Y + 1);
						F.operation(function () {
							if (q == 'skip') w(F, 1);
							else if (q == 'skipThree') w(F, 3);
							else if (q == 'surround') {
								for (var z = F.getSelections(), ne = 0; ne < z.length; ne++) z[ne] = m + z[ne] + x;
								(F.replaceSelections(z, 'around'), (z = F.listSelections().slice()));
								for (var ne = 0; ne < z.length; ne++) z[ne] = B(z[ne]);
								F.setSelections(z);
							} else
								q == 'both'
									? (F.replaceSelection(m + x, null), F.triggerElectric(m + x), w(F, -1))
									: q == 'addFour' && (F.replaceSelection(m + m + m + m, 'before'), w(F, 1));
						});
					}
					function K(F, N) {
						var R = F.getRange(P(N.line, N.ch - 1), P(N.line, N.ch + 1));
						return R.length == 2 ? R : null;
					}
					function ae(F, N) {
						var R = F.getTokenAt(P(N.line, N.ch + 1));
						return (
							/\bstring/.test(R.type) &&
							R.start == N.ch &&
							(N.ch == 0 || !/\bstring/.test(F.getTokenTypeAt(N)))
						);
					}
				});
			})()),
